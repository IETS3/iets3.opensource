...
### Added
- Variability: A check has been added for duplicate names of configurations in the same container.
- Variability: Configurations might become inconsistent due to errors during manual conflict merges. A couple of model checks have been added to detect this. Additionally, there are quickfixes to fix such errors. 
