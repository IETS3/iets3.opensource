...
public class ExprToplevelInterpreter_extension extends Extension.Default<IInterpreter> {
  public ExprToplevelInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprToplevelInterpreter();
  }
}
