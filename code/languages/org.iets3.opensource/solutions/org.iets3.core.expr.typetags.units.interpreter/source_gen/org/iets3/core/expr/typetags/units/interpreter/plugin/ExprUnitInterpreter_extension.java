...
public class ExprUnitInterpreter_extension extends Extension.Default<IInterpreter> {
  public ExprUnitInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprUnitInterpreter();
  }
}
