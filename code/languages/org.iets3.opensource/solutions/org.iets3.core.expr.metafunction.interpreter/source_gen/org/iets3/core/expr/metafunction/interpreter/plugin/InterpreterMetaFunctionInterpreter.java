  ...
  protected void populateEvaluators(List<? extends IEvaluator> evaluators) {
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.MetaFunction$9W, "r:bd9fb079-27cf-425c-8944-a655ffd4b313(org.iets3.core.expr.metafunction.interpreter.plugin)/5994308065078499708", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("MetaFunction", "http://127.0.0.1:63320/node?ref=47bd0b80-27dd-46aa-8df2-66bff5df2059%2Fi%3A10000001%28org.iets3.core.expr.metafunction.interpreter%40transient38%2Forg.iets3.core.expr.metafunction.interpreter.plugin%400%29%2F5994308065078499708");
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.MetaFunArgRef$LL, "r:bd9fb079-27cf-425c-8944-a655ffd4b313(org.iets3.core.expr.metafunction.interpreter.plugin)/5994308065078500080", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("MetaFunArgRef", "http://127.0.0.1:63320/node?ref=47bd0b80-27dd-46aa-8df2-66bff5df2059%2Fi%3A10000001%28org.iets3.core.expr.metafunction.interpreter%40transient38%2Forg.iets3.core.expr.metafunction.interpreter.plugin%400%29%2F5994308065078500080");
      }
