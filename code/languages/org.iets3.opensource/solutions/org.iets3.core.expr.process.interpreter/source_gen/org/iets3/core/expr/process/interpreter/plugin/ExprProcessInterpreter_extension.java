...
public class ExprProcessInterpreter_extension extends Extension.Default<IInterpreter> {
  public ExprProcessInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprProcessInterpreter();
  }
}
