...
public class NatLangInterpreter_extension extends Extension.Default<IInterpreter> {
  public NatLangInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterNatLangInterpreter();
  }
}
