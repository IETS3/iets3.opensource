...
public class ExprPathInterpreterPCollections_extension extends Extension.Default<IInterpreter> {
  public ExprPathInterpreterPCollections_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprPathInterpreterPCollections();
  }
}
