  ...
  protected void populateEvaluators(List<? extends IEvaluator> evaluators) {
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.LookupTableRef$J, "r:a13c86fe-c40a-4a06-b1a1-208e5bed665c(org.iets3.core.expr.lookup.interpreter.plugin)/5860825012169154230", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("LookupTableRef", "http://127.0.0.1:63320/node?ref=a1a296ec-51ce-42b2-b503-ebe170cb449e%2Fi%3A10000001%28org.iets3.core.expr.lookup.interpreter%40transient124%2Forg.iets3.core.expr.lookup.interpreter.plugin%400%29%2F5860825012169154230");
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.LookupTable$$Y, "r:a13c86fe-c40a-4a06-b1a1-208e5bed665c(org.iets3.core.expr.lookup.interpreter.plugin)/5860825012169163834", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("LookupTable", "http://127.0.0.1:63320/node?ref=a1a296ec-51ce-42b2-b503-ebe170cb449e%2Fi%3A10000001%28org.iets3.core.expr.lookup.interpreter%40transient124%2Forg.iets3.core.expr.lookup.interpreter.plugin%400%29%2F5860825012169163834");
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.LookupTarget$Rp, "r:a13c86fe-c40a-4a06-b1a1-208e5bed665c(org.iets3.core.expr.lookup.interpreter.plugin)/5860825012169343420", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("LookupTarget", "http://127.0.0.1:63320/node?ref=a1a296ec-51ce-42b2-b503-ebe170cb449e%2Fi%3A10000001%28org.iets3.core.expr.lookup.interpreter%40transient124%2Forg.iets3.core.expr.lookup.interpreter.plugin%400%29%2F5860825012169343420");
      }
