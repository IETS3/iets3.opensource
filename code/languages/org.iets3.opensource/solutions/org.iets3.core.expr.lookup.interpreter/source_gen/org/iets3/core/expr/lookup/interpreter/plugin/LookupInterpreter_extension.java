...
public class LookupInterpreter_extension extends Extension.Default<IInterpreter> {
  public LookupInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterLookupInterpreter();
  }
}
