...
<model ref="r:1dc6d8f2-b3ef-4125-b7b4-93454f09555c(libReexport@tests)">
  ...
  <imports>
    <import index="2s2o" ref="r:8306fa45-311f-4fca-b74d-7650d321387f(org.iets3.opensource.general.tests.input)" />
  </imports>
  <registry>
