  ...
  protected void populateEvaluators(List<? extends IEvaluator> evaluators) {
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.ValidateStringResultErrorsOp$qV, "r:b29e6a20-a50b-4843-bdbb-248824424c2b(org.iets3.core.expr.stringvalidation.interpreter.plugin)/3709229751379692954", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("ValidateStringResultErrorsOp", "http://127.0.0.1:63320/node?ref=e6b385c8-ff71-4f87-8a35-1f447d929da2%2Fi%3A10000001%28org.iets3.core.expr.stringvalidation.interpreter%40transient67%2Forg.iets3.core.expr.stringvalidation.interpreter.plugin%400%29%2F3709229751379692954");
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.ValidateStringResultOkOp$uD, "r:b29e6a20-a50b-4843-bdbb-248824424c2b(org.iets3.core.expr.stringvalidation.interpreter.plugin)/3709229751379660369", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("ValidateStringResultOkOp", "http://127.0.0.1:63320/node?ref=e6b385c8-ff71-4f87-8a35-1f447d929da2%2Fi%3A10000001%28org.iets3.core.expr.stringvalidation.interpreter%40transient67%2Forg.iets3.core.expr.stringvalidation.interpreter.plugin%400%29%2F3709229751379660369");
      }
    ...
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.ValidateStringExpr$xB, "r:b29e6a20-a50b-4843-bdbb-248824424c2b(org.iets3.core.expr.stringvalidation.interpreter.plugin)/5001505504945040316", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("ValidateStringExpr", "http://127.0.0.1:63320/node?ref=e6b385c8-ff71-4f87-8a35-1f447d929da2%2Fi%3A10000001%28org.iets3.core.expr.stringvalidation.interpreter%40transient67%2Forg.iets3.core.expr.stringvalidation.interpreter.plugin%400%29%2F5001505504945040316");
      }
