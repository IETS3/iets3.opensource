...
public class StringValidationInterpreter_extension extends Extension.Default<IInterpreter> {
  public StringValidationInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterStringValidationInterpreter();
  }
}
