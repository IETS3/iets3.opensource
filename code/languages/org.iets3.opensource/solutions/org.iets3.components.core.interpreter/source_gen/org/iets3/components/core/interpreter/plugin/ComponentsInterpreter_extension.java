...
public class ComponentsInterpreter_extension extends Extension.Default<IInterpreter> {
  public ComponentsInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterComponentsInterpreter();
  }
}
