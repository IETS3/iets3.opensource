  ...
  protected void populateEvaluators(List<? extends IEvaluator> evaluators) {
    ListSequence.fromList(((List<IEvaluator>) evaluators)).addElement(new ConceptEvaluatorBase(CONCEPTS.ParamRef$Pq, "r:3cecc670-c5e6-4794-af17-a5638180af01(org.iets3.components.core.interpreter.plugin)/5228096169281078964", true) {
      ...
      public EvaluatorInfo getInfo() {
        return new EvaluatorInfo("ParamRef", "http://127.0.0.1:63320/node?ref=6d6e7cc4-68de-44c4-bd1f-14d0ed41b5c0%2Fi%3A10000001%28org.iets3.components.core.interpreter%40transient140%2Forg.iets3.components.core.interpreter.plugin%400%29%2F5228096169281078964");
      }
