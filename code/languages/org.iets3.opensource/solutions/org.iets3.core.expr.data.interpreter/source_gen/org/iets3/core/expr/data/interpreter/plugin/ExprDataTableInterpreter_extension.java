...
public class ExprDataTableInterpreter_extension extends Extension.Default<IInterpreter> {
  public ExprDataTableInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprDataTableInterpreter();
  }
}
