...
public class ExprMutateInterpreter_extension extends Extension.Default<IInterpreter> {
  public ExprMutateInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprMutateInterpreter();
  }
}
