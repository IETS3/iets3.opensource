...
public class TestModelExecutor {
  ...
  public Iterable<ITestNodeWrapper> getTestableNodes() {
    Iterable<ITestNodeWrapper> wrappedTestNodes = SetSequence.fromSet(getTestItemContainers(repo)).select(new _FunctionTypes._return_P1_E0<ITestNodeWrapper, SNode>() {
      public ITestNodeWrapper invoke(final SNode it) {
