...
public class ExprUtilInterpreter_extension extends Extension.Default<IInterpreter> {
  public ExprUtilInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprUtilInterpreter();
  }
}
