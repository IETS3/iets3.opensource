...
public class Generated_utils_dectab_ranges_1_Test {
  ...
  public static Number calculateFare(BuLand state, Boolean club) {
    ...
    if (column_a0n == BuLand.BW) {
      return new BigDecimal("1.00").setScale(2, RoundingMode.DOWN);
    } else if (((column_a0n == BuLand.BY) && (column_b0n == false))) {
      return new BigDecimal("1.10").setScale(2, RoundingMode.DOWN);
    } else if (((column_a0n == BuLand.BY) && (column_b0n == true))) {
      return new BigDecimal("0.90").setScale(2, RoundingMode.DOWN);
    } else {
      return new BigDecimal("1.20").setScale(2, RoundingMode.DOWN);
    }
  }
  ...
  public static Number grundsteuer(art art, Number einwohner) {
    ...
    if (AH.isLess(einwohner, new BigInteger("100000"))) {
      if (art == art.Wohnhaus) {
        return new BigDecimal("0.24").setScale(2, RoundingMode.DOWN);
      } else if (art == art.Doppelhaus) {
        return new BigDecimal("0.24").setScale(2, RoundingMode.DOWN);
      } else if (art == art.Industriegebaeude) {
        return new BigDecimal("0.23").setScale(2, RoundingMode.DOWN);
      ...
      if (art == art.Wohnhaus) {
        return new BigDecimal("0.31").setScale(2, RoundingMode.DOWN);
      } else if (art == art.Doppelhaus) {
        return new BigDecimal("0.31").setScale(2, RoundingMode.DOWN);
      } else if (art == art.Industriegebaeude) {
        return new BigDecimal("0.31").setScale(2, RoundingMode.DOWN);
      } else if (art == art.Kirche) {
        return new BigDecimal("0.20").setScale(2, RoundingMode.DOWN);
      } else {
        throw new AlternativesException("The proposed alternative does not exist.");
      }
    } else if (!(AH.isLess(einwohner, new BigInteger("200001")))) {
      if (art == art.Wohnhaus) {
        return new BigDecimal("0.1").setScale(1, RoundingMode.DOWN);
      } else if (art == art.Doppelhaus) {
        return new BigDecimal("0.1").setScale(1, RoundingMode.DOWN);
      } else if (art == art.Industriegebaeude) {
        return new BigDecimal("0.2").setScale(1, RoundingMode.DOWN);
      } else if (art == art.Kirche) {
        return new BigDecimal("0.4").setScale(1, RoundingMode.DOWN);
      } else {
        throw new AlternativesException("The proposed alternative does not exist.");
      }
    } else {
