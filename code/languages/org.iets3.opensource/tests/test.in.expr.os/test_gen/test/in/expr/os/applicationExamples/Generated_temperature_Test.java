...
/* 
   ...
   */
    public static final TempFromUI someDataFromUI_ = new TempFromUI(new BigDecimal("100.0").setScale(1, RoundingMode.DOWN), uiTempUnit.fahrenheit);
/* 
  ...
  public static final Number validTempInF_ = new BigDecimal("100.0").setScale(1, RoundingMode.DOWN);
  @Test
  public void TempConversion_item0_6527211908667126376() throws Throwable {
    Assert.assertTrue("Expected: " + new BigDecimal("37.7").setScale(1, RoundingMode.DOWN) + ", but was: " + Generated_temperature_Test.FtoC(new BigDecimal("100.0").setScale(1, RoundingMode.DOWN)), EqualsTestOp.matches(new BigDecimal("37.7").setScale(1, RoundingMode.DOWN), Generated_temperature_Test.FtoC(new BigDecimal("100.0").setScale(1, RoundingMode.DOWN))));
  }
  @Test
  public void TempConversion_item2_6527211908667503678() throws Throwable {
    Assert.assertTrue("Expected: " + new BigDecimal("37.7").setScale(1, RoundingMode.DOWN) + ", but was: " + toC.toC(Generated_temperature_Test.someDataFromUI_), EqualsTestOp.matches(new BigDecimal("37.7").setScale(1, RoundingMode.DOWN), toC.toC(Generated_temperature_Test.someDataFromUI_)));
  }
