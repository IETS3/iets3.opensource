...
/* 
  ...
  public void TestAges_item8_6095949300274974243() throws Throwable {
    Assert.assertEquals("Expected: " + "p1" + ", but was: " + (String) ((Supplier<InlineRecordType>) () -> {
    ...
    }).get().members.get("name").value, "p1", (String) ((Supplier<InlineRecordType>) () -> {
      PVector<InlineRecordType> listResult = TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_));
      return (listResult.isEmpty() ? null : listResult.get(0));
    }).get().members.get("name").value);
  }
  @Test
  ...
  public void TestAges_item11_5989109240576104939() throws Throwable {
    Assert.assertTrue("Expected: " + new BigInteger("1") + ", but was: " + BigInteger.valueOf(HashTreePSet.from(((Supplier<PVector<InlineRecordType>>) () -> {
      PVector<InlineRecordType> result = TreePVector.empty();
      ...
      return result;
    }).get()).size()), EqualsTestOp.matches(new BigInteger("1"), BigInteger.valueOf(HashTreePSet.from(((Supplier<PVector<InlineRecordType>>) () -> {
      PVector<InlineRecordType> result = TreePVector.empty();
      for (Person it : ListSequence.fromList(TreePVector.<Person>empty().plus(Generated_contracts_Test.p2_).plus(Generated_contracts_Test.p3_))) {
        InlineRecordType irt = new InlineRecordType();
        irt.members.put("name", new InlineRecordTypeMember("name", it.getname()));
  ...
  public void TestAges_item14_8380233918275550393() throws Throwable {
    Assert.assertTrue("Expected: " + new BigInteger("1") + ", but was: " + BigInteger.valueOf(((Supplier<PVector<InlineRecordType>>) () -> {
    ...
    }).get().size()), EqualsTestOp.matches(new BigInteger("1"), BigInteger.valueOf(((Supplier<PVector<InlineRecordType>>) () -> {
      PVector<InlineRecordType> origList = TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_));
      int noOfElements = new BigInteger("1").intValue();
      if (origList.size() <= noOfElements) {
        return origList;
  ...
  public void TestAges_item16_8380233918277211835() throws Throwable {
    Assert.assertTrue("Expected: " + new BigInteger("1") + ", but was: " + BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_)).stream().allMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
      return Objects.equals((String) it.members.get("name").value, "p2");
    }).apply(new ParameterSetWrapper(o)))).stream().filter((Boolean p0) -> p0 != null).collect(Collectors.toList())).size()), EqualsTestOp.matches(new BigInteger("1"), BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_)).stream().allMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
      return Objects.equals((String) it.members.get("name").value, "p2");
    }).apply(new ParameterSetWrapper(o)))).stream().filter((Boolean p0) -> p0 != null).collect(Collectors.toList())).size())));
  }
  ...
  public void TestAges_item18_2815449023149657736() throws Throwable {
    Assert.assertTrue("Expected: " + new BigInteger("1") + ", but was: " + BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_)).stream().anyMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
      return Objects.equals((String) it.members.get("name").value, "p2");
    }).apply(new ParameterSetWrapper(o)))).stream().filter((Boolean p0) -> p0 != null).collect(Collectors.toList())).size()), EqualsTestOp.matches(new BigInteger("1"), BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_)).stream().anyMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
  ...
  public void TestAges_item21_2815449023156696641() throws Throwable {
    Assert.assertEquals("Expected: " + TreePVector.<Number>empty().plus(new BigInteger("30")).plus(new BigInteger("30")) + ", but was: " + TreePVector.<Number>from(TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_)).stream().map((InlineRecordType param) -> {
    ...
    }).collect(Collectors.<Number>toList())), TreePVector.<Number>empty().plus(new BigInteger("30")).plus(new BigInteger("30")), TreePVector.<Number>from(TreePVector.from(Generated_contracts_Test.brotherAges4(Generated_contracts_Test.p1_)).stream().map((InlineRecordType param) -> {
      return new Function<ParameterSetWrapper, Number>() {
        public Number apply(ParameterSetWrapper param) {
          InlineRecordType it = (InlineRecordType) param.parameters.get(0);
          return (Number) it.members.get("age").value;
  ...
  public static final PCollection<InlineRecordType> c_ = ((Supplier<PVector<InlineRecordType>>) () -> {
    PVector<InlineRecordType> result = TreePVector.empty();
  ...
  public void TestAges_constant_item6_8267117108455804085() throws Throwable {
    Assert.assertTrue("Expected: " + new BigInteger("1") + ", but was: " + BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.c_).stream().allMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
      return Objects.equals((String) it.members.get("name").value, "p2");
    }).apply(new ParameterSetWrapper(o)))).stream().filter((Boolean p0) -> p0 != null).collect(Collectors.toList())).size()), EqualsTestOp.matches(new BigInteger("1"), BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.c_).stream().allMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
      return Objects.equals((String) it.members.get("name").value, "p2");
    }).apply(new ParameterSetWrapper(o)))).stream().filter((Boolean p0) -> p0 != null).collect(Collectors.toList())).size())));
  }
  ...
  public void TestAges_constant_item8_8267117108456174710() throws Throwable {
    Assert.assertTrue("Expected: " + new BigInteger("1") + ", but was: " + BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.c_).stream().anyMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
      return Objects.equals((String) it.members.get("name").value, "p2");
    }).apply(new ParameterSetWrapper(o)))).stream().filter((Boolean p0) -> p0 != null).collect(Collectors.toList())).size()), EqualsTestOp.matches(new BigInteger("1"), BigInteger.valueOf(TreePVector.<Boolean>from(TreePVector.<Boolean>singleton(TreePVector.from(Generated_contracts_Test.c_).stream().anyMatch((InlineRecordType o) -> ((Function<ParameterSetWrapper, Boolean>) (ParameterSetWrapper param) -> {
      InlineRecordType it = (InlineRecordType) param.parameters.get(0);
      return Objects.equals((String) it.members.get("name").value, "p2");
    }).apply(new ParameterSetWrapper(o)))).stream().filter((Boolean p0) -> p0 != null).collect(Collectors.toList())).size())));
  }
  ...
  public void TestAges_constant_item11_8267117108466345290() throws Throwable {
    Assert.assertEquals("Expected: " + TreePVector.<Number>empty().plus(new BigInteger("30")).plus(new BigInteger("30")) + ", but was: " + TreePVector.<Number>from(TreePVector.from(Generated_contracts_Test.c_).stream().map((InlineRecordType param) -> {
      return new Function<ParameterSetWrapper, Number>() {
        public Number apply(ParameterSetWrapper param) {
          InlineRecordType it = (InlineRecordType) param.parameters.get(0);
          return (Number) it.members.get("age").value;
    ...
    }).collect(Collectors.<Number>toList())), TreePVector.<Number>empty().plus(new BigInteger("30")).plus(new BigInteger("30")), TreePVector.<Number>from(TreePVector.from(Generated_contracts_Test.c_).stream().map((InlineRecordType param) -> {
      return new Function<ParameterSetWrapper, Number>() {
        public Number apply(ParameterSetWrapper param) {
          InlineRecordType it = (InlineRecordType) param.parameters.get(0);
          return (Number) it.members.get("age").value;
