...
public class Generated_alt_Test {
  ...
  public void alt_item1_3611639268124042428() throws Throwable {
    Assert.assertEquals("Expected: " + "true" + ", but was: " + ((Supplier<String>) () -> {
  ...
  public void alt_withBlockExpression_item0_8086792206069713103() throws Throwable {
    Assert.assertEquals("Expected: " + true + ", but was: " + (AH.isEqual(new BigInteger("1"), new BigInteger("1")) ? ((Supplier<Boolean>) () -> {
      Number v1 = AH.mul(new BigInteger("5"), new BigInteger("2"));
      return AH.isEqual(v1, new BigInteger("10"));
    }).get() : false), (Object) true, (AH.isEqual(new BigInteger("1"), new BigInteger("1")) ? ((Supplier<Boolean>) () -> {
      Number v1 = AH.mul(new BigInteger("5"), new BigInteger("2"));
      return AH.isEqual(v1, new BigInteger("10"));
    }).get() : false));
  }
  ...
  public void alt_withBlockExpression_item1_4862176901443507804() throws Throwable {
    Assert.assertEquals("Expected: " + false + ", but was: " + (AH.isEqual(new BigInteger("1"), new BigInteger("2")) ? true : ((Supplier<Boolean>) () -> {
      Number v1 = AH.mul(new BigInteger("5"), new BigInteger("2"));
      return AH.isEqual(v1, new BigInteger("11"));
    }).get()), (Object) false, (AH.isEqual(new BigInteger("1"), new BigInteger("2")) ? true : ((Supplier<Boolean>) () -> {
      Number v1 = AH.mul(new BigInteger("5"), new BigInteger("2"));
      return AH.isEqual(v1, new BigInteger("11"));
    }).get()));
  }
