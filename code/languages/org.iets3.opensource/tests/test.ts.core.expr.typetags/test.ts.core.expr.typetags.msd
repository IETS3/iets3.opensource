...
<solution name="test.ts.core.expr.typetags" uuid="b05fe52b-7532-405d-ad84-21f05816e3e8" moduleVersion="0" pluginKind="PLUGIN_CORE" compileInMPS="true">
  <models>
  ...
  <dependencyVersions>
    ...
    <module reference="b05fe52b-7532-405d-ad84-21f05816e3e8(test.ts.core.expr.typetags)" version="0" />
  </dependencyVersions>
</solution>
