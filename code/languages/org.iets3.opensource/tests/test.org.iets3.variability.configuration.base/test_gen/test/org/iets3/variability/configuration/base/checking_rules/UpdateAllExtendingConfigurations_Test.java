...
import org.iets3.variability.configuration.base.behavior.UpdateAllExtendingConfigs;
...
@MPSLaunch
public class UpdateAllExtendingConfigurations_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(UpdateAllExtendingConfigurations_Test.class).projectPath(null).modelRef("r:b52df216-430b-486e-bf75-226dacbbed72(test.org.iets3.variability.configuration.base.checking_rules@tests)").reopenProject(false).build());

  public UpdateAllExtendingConfigurations_Test() {
    super(ourParametersCacheExtension.getParametersCache());
  }

  @Test
  public void test_UpdateAllExtendingConfigurations() throws Throwable {
