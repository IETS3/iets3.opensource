...
public final class YearRangeType__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x289fb12b7f534ef7L, 0xbc2e1ed2c6a7c998L, 0x35ec8ca87af734bbL, "org.iets3.core.expr.datetime.structure.YearRangeType");
  ...
  /*package*/ static SNode createDefaultVarExpr_id60Qa1k_nI2O(@NotNull SNode __thisNode__) {
    return createYearRangeLiteral_lriezv_a0a0();
  }

  /*package*/ YearRangeType__BehaviorDescriptor() {
  }
  ...
  private static SNode createYearRangeLiteral_lriezv_a0a0() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.YearRangeLiteral$si);
    {
      SNodeBuilder n1 = n0.forChild(LINKS.expr$CW3E).init(CONCEPTS.NumberLiteral$wE);
      n1.setProperty(PROPS.value$iWTK, "1970");
    }
    return n0.getResult();
  }
