...
public final class DateDeltaLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x289fb12b7f534ef7L, 0xbc2e1ed2c6a7c998L, 0x72b77efdaa097d21L, "org.iets3.core.expr.datetime.structure.DateDeltaLiteral");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$CW3E)) + " " + SConceptOperations.conceptAlias(SNodeOperations.getConcept(__thisNode__));
  }

  /*package*/ DateDeltaLiteral__BehaviorDescriptor() {
  }
