...
public final class ValidateStringExpr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf003a0fec14041d7L, 0xa145ea42368e581cL, 0x4568eac1f468bb42L, "org.iets3.core.expr.stringvalidation.structure.ValidateStringExpr");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SConceptOperations.conceptAlias(SNodeOperations.getConcept(__thisNode__)) + " " + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$CW3E)) + "[" + IterableUtils.join(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.clauses$VM32)).select((it) -> (String) BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(it)), "\n") + "]";
  }

  /*package*/ ValidateStringExpr__BehaviorDescriptor() {
  }
