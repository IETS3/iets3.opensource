...
public final class BusPortType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String defaultPortName_idcJpacq4Df4(@NotNull SNode __thisNode__) {
    return (String) AbstractBusType__BehaviorDescriptor.getName_id4lFnCmbF7lD.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.busType$HmsX));
  }
  /*package*/ static SNode createConnectorType_id4KDeVD8s9TJ(@NotNull SNode __thisNode__) {
    return createBusConnectorType_6xi97v_a0a2();
  }
  ...
  private static SNode createBusConnectorType_6xi97v_a0a2() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.BusConnectorType$oo);
    return n0.getResult();
  }
