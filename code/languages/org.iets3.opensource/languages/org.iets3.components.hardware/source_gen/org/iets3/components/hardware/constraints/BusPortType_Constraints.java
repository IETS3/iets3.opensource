...
public class BusPortType_Constraints extends BaseConstraintsDescriptor {
  public BusPortType_Constraints() {
    super(CONCEPTS.BusPortType$60);
  }
  ...
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.busType_old$TIk, this, true, false) {
      @Nullable
      @Override
