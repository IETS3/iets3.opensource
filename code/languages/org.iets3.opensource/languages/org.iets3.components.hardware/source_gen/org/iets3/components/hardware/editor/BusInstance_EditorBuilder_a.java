...
/*package*/ class BusInstance_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new busTypeSingleRoleHandler_zfhx4r_a0c0a(myNode, LINKS.busType$2oCT, getEditorContext());
    return provider.createCell();
  }
  private static class busTypeSingleRoleHandler_zfhx4r_a0c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public busTypeSingleRoleHandler_zfhx4r_a0c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            ...
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.BusInstance$mP, LINKS.optionalName$AhFr), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String descriptiontext = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.BusInstance$mP, LINKS.optionalName$AhFr), node, originalText, editorContext);
  ...
  private EditorCell createRefNodeList_0() {
    ...
    editorCell.setFoldedCell(createCustomFactory_19());
