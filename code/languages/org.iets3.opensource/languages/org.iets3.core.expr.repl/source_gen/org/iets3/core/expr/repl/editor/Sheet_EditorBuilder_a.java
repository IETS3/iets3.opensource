...
/*package*/ class Sheet_EditorBuilder_a extends AbstractEditorBuilder {
            ...
            public void postprocess(ITableGrid grid, SNode node, EditorContext editorContext, SubstituteInfoFactory substituteInfoFactory) {
              for (int x = 0; x < grid.getSizeX(); x++) {
                for (int y = 0; y < grid.getSizeY(); y++) {
                  EditorCellGridLeaf element = as_dlrz2w_a0a0a0a0a0a0d0a0p0a0c0a0a0c0z(grid.getCell(x, y), EditorCellGridLeaf.class);
                  if (element == null) {
                    continue;
                  }
                  RowEndCell endCell = as_dlrz2w_a0a2a0a0a0a0d0a0p0a0c0a0a0c0z(element.getEditorCell(), RowEndCell.class);
                  if (endCell == null) {
                    continue;
                  }
  ...
  private static <T> T as_dlrz2w_a0a0a0a0a0a0d0a0p0a0c0a0a0c0z(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_dlrz2w_a0a2a0a0a0a0d0a0p0a0c0a0a0c0z(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
