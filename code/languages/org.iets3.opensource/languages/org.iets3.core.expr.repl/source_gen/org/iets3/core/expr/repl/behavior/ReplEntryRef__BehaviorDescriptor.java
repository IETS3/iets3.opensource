...
public final class ReplEntryRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x18001c9433a74f68L, 0xa7c1ffddc4b39be1L, 0x2b59af57f926d3e1L, "org.iets3.core.expr.repl.structure.ReplEntryRef");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "$" + SNodeOperations.getIndexInParent(SLinkOperations.getTarget(__thisNode__, LINKS.entry$nN95)) + "$";
  }
  /*package*/ static SNode target_id6rGLT0TevFd(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.entry$nN95);
  }

  /*package*/ ReplEntryRef__BehaviorDescriptor() {
  }
