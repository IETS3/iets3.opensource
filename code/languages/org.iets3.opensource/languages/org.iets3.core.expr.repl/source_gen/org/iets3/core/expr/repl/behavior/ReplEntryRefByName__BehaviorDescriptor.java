...
public final class ReplEntryRefByName__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x18001c9433a74f68L, 0xa7c1ffddc4b39be1L, 0x55ea8b52f267d38fL, "org.iets3.core.expr.repl.structure.ReplEntryRefByName");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "$" + SNodeOperations.getIndexInParent(SLinkOperations.getTarget(__thisNode__, LINKS.entry$xvrm)) + "$";
  }
  /*package*/ static SNode target_id6rGLT0TevFd(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.entry$xvrm);
  }

  /*package*/ ReplEntryRefByName__BehaviorDescriptor() {
  }
