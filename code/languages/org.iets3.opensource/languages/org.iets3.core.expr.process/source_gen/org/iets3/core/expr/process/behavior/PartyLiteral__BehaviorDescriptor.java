...
public final class PartyLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x50b470e714ad46c3L, 0xb5404586f56d2e9cL, 0xfc43d48233b0f23L, "org.iets3.core.expr.process.structure.PartyLiteral");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SConceptOperations.conceptAlias(SNodeOperations.getConcept(__thisNode__)) + "[" + SPropertyOperations.getString(__thisNode__, PROPS.id$Sl6d) + "]";
  }

  /*package*/ PartyLiteral__BehaviorDescriptor() {
  }
