...
/*package*/ class Component_tooltipHint_evdz91_a0a1a3a0_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_fqevwx_a0a(editorContext, node);
  ...
  private static class QueryListHandler_fqevwx_a0a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_fqevwx_a0a(EditorContext context, SNode ownerNode) {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist4313159207483160051")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
