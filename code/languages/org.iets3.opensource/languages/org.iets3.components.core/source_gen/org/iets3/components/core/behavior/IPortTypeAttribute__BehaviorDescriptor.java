...
public final class IPortTypeAttribute__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0xf0fd486f857743e9L, 0xb6713d118449c6e7L, 0x3ce7d48974432dfbL, "org.iets3.components.core.structure.IPortTypeAttribute");
  ...
  /*package*/ static Iterable<SAbstractConcept> canBeUsedUnder_id1WCh2th1Boz(@NotNull SAbstractConcept __thisConcept__) {
    return Sequence.<SAbstractConcept>singleton(CONCEPTS.IPortType$DL);
  }

  /*package*/ IPortTypeAttribute__BehaviorDescriptor() {
  }
