...
/*package*/ class PortsTarget_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PortsTarget_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_h1leok_a0");
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> cell).invoke();
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_IDotTarget_cellMenu_h1leok_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_IDotTarget_cellMenu_h1leok_a0a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_IDotTarget_cellMenu_h1leok_a0a0a0() {
    }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_h1leok_a1a0();
  ...
  private boolean nodeCondition_h1leok_a1a0() {
  ...
  private EditorCell createCollection_1() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_h1leok_a0a1a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_h1leok_a0a0b0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new portTypeSingleRoleHandler_h1leok_b0a0b0a(myNode, LINKS.portType$f3GS, getEditorContext());
    return provider.createCell();
  }
  private static class portTypeSingleRoleHandler_h1leok_b0a0b0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public portTypeSingleRoleHandler_h1leok_b0a0b0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_h1leok_c0a0b0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for PortsTarget.portType") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_h1leok_a1a0");
    return editorCell;
  }
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.PortsTarget$9G), LINKS.portType$f3GS, null);
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.PortsTarget$9G, LINKS.portType$f3GS), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.PortsTarget$9G, LINKS.portType$f3GS), node, originalText, editorContext);
