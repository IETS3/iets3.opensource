...
public final class ImportConnector__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0fd486f857743e9L, 0xb6713d118449c6e7L, 0x32f64a31a05d2c1L, "org.iets3.components.core.structure.ImportConnector");
  ...
  /*package*/ static Tuples._2<SNode, SNode> getPorts_idmIQkxg5ZT6(@NotNull SNode __thisNode__) {
    return MultiTuple.<SNode,SNode>from(SLinkOperations.getTarget(__thisNode__, LINKS.targetPort$ZxZ9), SLinkOperations.getTarget(__thisNode__, LINKS.outerPort$3H4p));
  }
  /*package*/ static String treeViewLabel_id7Atos1ybm9U(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.outerPort$3H4p), PROPS.name$MnvL) + " -> " + SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.targetInstance$ZsmL), LINKS.ref$H$FL), PROPS.name$MnvL) + "." + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.targetPort$ZxZ9), PROPS.name$MnvL);
  }
  /*package*/ static SNode getOuterPort_id7nsgDAXALqd(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.outerPort$3H4p);
  }
  /*package*/ static SNode getInstanceForPort_id4VHfdEqkeO4(@NotNull SNode __thisNode__, SNode port) {
    return ((Objects.equals(SLinkOperations.getTarget(__thisNode__, LINKS.targetPort$ZxZ9), port)) ? SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.targetInstance$ZsmL), LINKS.ref$H$FL) : null);
  }

  /*package*/ ImportConnector__BehaviorDescriptor() {
  }
