...
/*package*/ class IPortTypeAttributes_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IPortTypeAttributes_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_px8b6l_a(editorContext, node);
      ...
      editorCell.setCellId("QueryList_px8b6l_a");
      return editorCell;
    });
  ...
  private static class QueryListHandler_px8b6l_a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_px8b6l_a(EditorContext context, SNode ownerNode) {
