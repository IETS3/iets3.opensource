...
/*package*/ class Component_tooltipHint_evdz91_e0a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Component_tooltipHint_evdz91_e0a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_vjzwbo_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.components.core.editor.GeneratedHints.tooltipHint_evdz91_e0a0"});
      if (nodeCondition_vjzwbo_a0a()) {
  ...
  private EditorCell createCustom_0() {
    ...
    editorCell.setCellId("Custom_vjzwbo_a0a0");
    return editorCell;
  }
