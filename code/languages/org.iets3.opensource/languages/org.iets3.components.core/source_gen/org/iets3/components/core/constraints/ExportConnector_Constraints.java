...
public class ExportConnector_Constraints extends BaseConstraintsDescriptor {
  public ExportConnector_Constraints() {
    super(CONCEPTS.ExportConnector$hw);
  }
  ...
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.sourcePort$fgej, this, true, true) {
      @Override
    ...
    BaseReferenceConstraintsDescriptor d1 = new BaseReferenceConstraintsDescriptor(LINKS.outerPort$ffZi, this, true, true) {
      @Override
      public boolean validate(final SNode referenceNode, final SNode oldReferentNode, final SNode newReferentNode) {
        return true;
      }
