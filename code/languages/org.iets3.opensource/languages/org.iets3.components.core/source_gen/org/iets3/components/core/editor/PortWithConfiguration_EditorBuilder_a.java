...
/*package*/ class PortWithConfiguration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new wrappedSingleRoleHandler_3ohydq_a0a0(myNode, LINKS.wrapped$gKEw, getEditorContext());
    return provider.createCell();
  }
  private static class wrappedSingleRoleHandler_3ohydq_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public wrappedSingleRoleHandler_3ohydq_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
