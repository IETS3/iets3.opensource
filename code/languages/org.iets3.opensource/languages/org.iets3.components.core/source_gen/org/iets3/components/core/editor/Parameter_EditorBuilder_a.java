...
/*package*/ class Parameter_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_2k1i0x_b0b0a(editorContext, node);
  ...
  private static class QueryListHandler_2k1i0x_b0b0a extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_2k1i0x_b0b0a(EditorContext context, SNode ownerNode) {
