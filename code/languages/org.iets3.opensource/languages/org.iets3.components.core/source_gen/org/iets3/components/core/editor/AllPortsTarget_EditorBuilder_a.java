      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            ...
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AllPortsTarget$EF, LINKS.portType$f3GS), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AllPortsTarget$EF, LINKS.portType$f3GS), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add a port type for the target");
          }
        });
      }
      return result;
