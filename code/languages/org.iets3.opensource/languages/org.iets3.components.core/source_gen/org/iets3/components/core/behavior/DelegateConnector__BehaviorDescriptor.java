...
public final class DelegateConnector__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Tuples._2<SNode, SNode> getPorts_idmIQkxg5ZT6(@NotNull SNode __thisNode__) {
    return MultiTuple.<SNode,SNode>from(SLinkOperations.getTarget(__thisNode__, LINKS.sourcePort$lhQu), SLinkOperations.getTarget(__thisNode__, LINKS.outerPort$lnWS));
  }
  /*package*/ static String treeViewLabel_id7Atos1ybm9U(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.sourceInstance$lh9r), LINKS.ref$H$FL), PROPS.name$MnvL) + "." + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.sourcePort$lhQu), PROPS.name$MnvL) + " -> " + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.outerPort$lnWS), PROPS.name$MnvL);
  }
  /*package*/ static SNode getInstanceForPort_id4VHfdEqkeO4(@NotNull SNode __thisNode__, SNode port) {
    return ((Objects.equals(SLinkOperations.getTarget(__thisNode__, LINKS.sourcePort$lhQu), port)) ? SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.sourceInstance$lh9r), LINKS.ref$H$FL) : null);
  }
