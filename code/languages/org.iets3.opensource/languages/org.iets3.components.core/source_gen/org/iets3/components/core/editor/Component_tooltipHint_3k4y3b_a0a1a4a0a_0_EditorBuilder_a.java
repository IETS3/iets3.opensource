...
/*package*/ class Component_tooltipHint_3k4y3b_a0a1a4a0a_0_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    QueryListHandler handler = new QueryListHandler_37yvsb_a0a(editorContext, node, true);
  ...
  private static class QueryListHandler_37yvsb_a0a extends QueryListHandler {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist8649951428784405540")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
