...
public final class ParamRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf0fd486f857743e9L, 0xb6713d118449c6e7L, 0x3ce7d4897415d6b2L, "org.iets3.components.core.structure.ParamRef");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getPresentation_idhEwIMiw, target_id6rGLT0TevFd, renderReadable_id4Y0vh0cfqjE, target_id4fgA7QrEdeJ);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.param$OsyV), PROPS.name$MnvL);
  }
  /*package*/ static SNode target_id6rGLT0TevFd(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.param$OsyV);
  }
  ...
  /*package*/ ParamRef__BehaviorDescriptor() {
  }
