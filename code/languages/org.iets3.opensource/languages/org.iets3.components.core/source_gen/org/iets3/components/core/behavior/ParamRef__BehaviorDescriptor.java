...
public final class ParamRef__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getPresentation_idhEwIMiw, target_id6rGLT0TevFd, renderReadable_id4Y0vh0cfqjE, target_id4fgA7QrEdeJ);
