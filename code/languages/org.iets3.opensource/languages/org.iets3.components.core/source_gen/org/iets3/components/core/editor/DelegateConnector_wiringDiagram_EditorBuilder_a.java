...
/*package*/ class DelegateConnector_wiringDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DelegateConnector_wiringDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node, null) {
        ...
        private IConnectionEndpointReference endpointFrom = EndpointUtil.createEndpointReferenceForPortSafe(EndpointUtil.createEndpointReferenceForNodeSafe(SLinkOperations.getTarget(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.sourceInstance$lh9r), LINKS.ref$H$FL)), SPropertyOperations.getString(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.sourcePort$lhQu), PROPS.name$MnvL));
        private IConnectionEndpointReference endpointTo = (SNodeOperations.isInstanceOf(ListSequence.fromList(DiagramContext.getAllDiagramNodes()).last(), CONCEPTS.AbstractComponentInstanceBase$QW) ? EndpointUtil.createEndpointReferenceForPortSafe(EndpointUtil.createEndpointReferenceForNodeSafe(ListSequence.fromList(DiagramContext.getAllDiagramNodes()).last()), SPropertyOperations.getString(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.outerPort$lnWS), PROPS.name$MnvL)) : EndpointUtil.createEndpointReferenceForIdSafe("port_" + SPropertyOperations.getString(SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.outerPort$lnWS), PROPS.name$MnvL) + SLinkOperations.getTarget(((SNode) _variablesContext.getValue("thisNode")), LINKS.outerPort$lnWS).getNodeId()));

        {
          ...
          if (reverse) {
            ...
            {
              Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_cyc1z9_b0b0i0a0a1a2a3a01 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
              endpointFrom = _tmp_cyc1z9_b0b0i0a0a1a2a3a01._0();
              endpointTo = _tmp_cyc1z9_b0b0i0a0a1a2a3a01._1();
            }
            {
              Tuples._2<EditorCell, EditorCell> _tmp_cyc1z9_c0b0i0a0a1a2a3a01 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
              startRoleCell = _tmp_cyc1z9_c0b0i0a0a1a2a3a01._0();
              endRoleCell = _tmp_cyc1z9_c0b0i0a0a1a2a3a01._1();
            }
            {
              Tuples._2<IShape, IShape> _tmp_cyc1z9_d0b0i0a0a1a2a3a01 = MultiTuple.<IShape,IShape>from(endShape, startShape);
              startShape = _tmp_cyc1z9_d0b0i0a0a1a2a3a01._0();
              endShape = _tmp_cyc1z9_d0b0i0a0a1a2a3a01._1();
            }
          }
        }
      ...
      EditorCell label = DiagramUtil.getCellIfNotEmpty(new Inline_Builder_466gkp_a0a(editorContext, node).createCell());

      EditorCell editorCell = label;
      MyGraph rootGraph = DiagramCreationContext.getRootGraph();
      if (editorCell != null && rootGraph != null) {
        Style style = new StyleImpl();
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-color"), getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_466gkp_a0a0()));
        style.set(StyleAttributes.getInstance().<Float>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-width"), _StyleParameter_QueryFunction_466gkp_a1a0());
        style.set(StyleAttributes.getInstance().<LineStyle>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-style"), _StyleParameter_QueryFunction_466gkp_a2a0());
      ...
      editorCell.setCellId("DiagramConnector_466gkp_a0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-color"), getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_466gkp_a0a0()));
      style.set(StyleAttributes.getInstance().<Float>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-width"), _StyleParameter_QueryFunction_466gkp_a1a0());
      style.set(StyleAttributes.getInstance().<LineStyle>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-style"), _StyleParameter_QueryFunction_466gkp_a2a0());
  ...
  private Color _StyleParameter_QueryFunction_466gkp_a0a0() {
  ...
  private Float _StyleParameter_QueryFunction_466gkp_a1a0() {
    return 2.5f;
  }
  private LineStyle _StyleParameter_QueryFunction_466gkp_a2a0() {
    return LineStyle.DASHED;
  }
  /*package*/ static class Inline_Builder_466gkp_a0a extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_466gkp_a0a(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
