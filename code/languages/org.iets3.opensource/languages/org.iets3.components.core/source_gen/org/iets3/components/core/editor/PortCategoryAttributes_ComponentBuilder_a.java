...
/*package*/ class PortCategoryAttributes_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_5xydvf_a(getEditorContext(), getNode(), false);
  ...
  private static class QueryListHandler_5xydvf_a extends QueryListHandler {
     ...
     */
    private SNode myNode;
    public QueryListHandler_5xydvf_a(EditorContext context, SNode ownerNode, boolean readOnly) {
