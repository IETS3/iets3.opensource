...
/*package*/ class Component_tooltipHint_3k4y3b_a0a1a4a0a_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Component_tooltipHint_3k4y3b_a0a1a4a0a_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_jsywr8_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.components.core.editor.GeneratedHints.tooltipHint_3k4y3b_a0a1a4a0a"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_jsywr8_a0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_jsywr8_a0a");
  ...
  private static class QueryListHandler_jsywr8_a0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_jsywr8_a0a(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist5721768351632269345")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
