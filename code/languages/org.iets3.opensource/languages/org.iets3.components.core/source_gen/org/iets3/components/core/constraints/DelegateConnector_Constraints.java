...
public class DelegateConnector_Constraints extends BaseConstraintsDescriptor {
  /*package*/ DelegateConnector_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.DelegateConnector$uB, initContext);
    record(new RD1(this));
    record(new RD2(this));
  }
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.sourcePort$lhQu, container, true, true);
    }
    @Override
  ...
  /*package*/ static final class RD2 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD2(ConstraintsDescriptor container) {
      super(LINKS.outerPort$lnWS, container, true, true);
    }
    @Override
    public boolean validate(final SNode referenceNode, final SNode oldReferentNode, final SNode newReferentNode) {
      return true;
