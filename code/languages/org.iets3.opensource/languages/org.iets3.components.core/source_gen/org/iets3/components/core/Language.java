package org.iets3.components.core;
...
import org.iets3.components.core.actions.ActionAspectDescriptorImpl;
import jetbrains.mps.smodel.runtime.BehaviorAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConstraintsAspectDescriptor;
import jetbrains.mps.openapi.editor.descriptor.EditorAspectDescriptor;
import org.iets3.components.core.editor.EditorAspectDescriptorImpl;
import jetbrains.mps.openapi.intentions.IntentionAspectDescriptor;
import org.iets3.components.core.intentions.IntentionsDescriptor;
import jetbrains.mps.lang.migration.runtime.base.MigrationAspectDescriptor;
import org.iets3.components.core.migration.MigrationDescriptor;
import jetbrains.mps.lang.typesystem.runtime.IHelginsDescriptor;
import org.iets3.components.core.typesystem.TypesystemDescriptor;
import jetbrains.mps.smodel.runtime.StructureAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConceptPresentationAspect;
import org.iets3.components.core.structure.ConceptPresentationAspectImpl;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("f0fd486f-8577-43e9-b671-3d118449c6e7");
  }

  @Override
  public String getNamespace() {
    return "org.iets3.components.core";
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == BehaviorAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.components.core.behavior.BehaviorAspectDescriptor());
    }
    if (aspectClass == ConstraintsAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.components.core.constraints.ConstraintsAspectDescriptor());
    }
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.components.core.structure.StructureAspectDescriptor());
    }
  ...
  protected void contribute(@NotNull LanguageExtensions extensions) {
    ...
    extensions.recordContribution("org.iets3.core.attributes", "583939be-ded0-4735-a055-a74f8477fc34", EditorAspectDescriptor.class);
  }
}
