...
/*package*/ class Port_tooltipHint_nejer9_a0a1a1a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Port_tooltipHint_nejer9_a0a1a1a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_y69l31_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.components.core.editor.GeneratedHints.tooltipHint_nejer9_a0a1a1a0"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_y69l31_a0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_y69l31_a0a");
  ...
  private static class QueryListHandler_y69l31_a0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_y69l31_a0a(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist6226936552129191361")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
