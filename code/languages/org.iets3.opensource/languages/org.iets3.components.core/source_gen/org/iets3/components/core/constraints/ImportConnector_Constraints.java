...
public class ImportConnector_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ImportConnector_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ImportConnector$8o, initContext);
    record(new RD1(this));
    record(new RD2(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.outerPort$3H4p, container, true, true);
    }
    @Override
  ...
  /*package*/ static final class RD2 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD2(ConstraintsDescriptor container) {
      super(LINKS.targetPort$ZxZ9, container, true, true);
    }
    @Override
    public boolean validate(final SNode referenceNode, final SNode oldReferentNode, final SNode newReferentNode) {
      return true;
