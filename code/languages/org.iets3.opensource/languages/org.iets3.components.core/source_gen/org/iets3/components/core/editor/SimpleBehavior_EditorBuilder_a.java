...
/*package*/ class SimpleBehavior_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new triggerSingleRoleHandler_9398fo_a0a0a(myNode, LINKS.trigger$nkOV, getEditorContext());
    return provider.createCell();
  }
  private static class triggerSingleRoleHandler_9398fo_a0a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public triggerSingleRoleHandler_9398fo_a0a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
