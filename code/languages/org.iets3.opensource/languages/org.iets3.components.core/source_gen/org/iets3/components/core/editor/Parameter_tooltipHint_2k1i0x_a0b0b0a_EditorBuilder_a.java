...
/*package*/ class Parameter_tooltipHint_2k1i0x_a0b0b0a_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_a7gk20_a0(editorContext, node);
  ...
  private static class QueryListHandler_a7gk20_a0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_a7gk20_a0(EditorContext context, SNode ownerNode) {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist4313159207483159219")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
