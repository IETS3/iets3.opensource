...
public class NatLangFunctionArgRef_SmartReference extends SubstituteMenuBase {
  public NatLangFunctionArgRef_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "NatLangFunctionArgRef_SmartReference", new SNodePointer("r:8a68dc0a-09ac-4a20-bd08-c5ca350aacc6(org.iets3.core.expr.natlang.editor)", "8297803270193781332")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_a78sou_a(), CONCEPTS.NatLangFunctionArgRef$$6));
    return result;
  }

  public class SMP_ReferenceScope_a78sou_a extends ReferenceScopeSubstituteMenuPart {

    public SMP_ReferenceScope_a78sou_a() {
      super(CONCEPTS.NatLangFunctionArgRef$$6, LINKS.param$yxRU, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:8a68dc0a-09ac-4a20-bd08-c5ca350aacc6(org.iets3.core.expr.natlang.editor)", "8297803270193781330")));
    }
