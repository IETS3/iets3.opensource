...
<model ref="r:4b988d2a-3602-4076-b500-46a147495999(org.iets3.components.toplevel.adapter.actions)">
  ...
  <node concept="1hljLi" id="22Kx9pTvMT$">
    <property role="TrG5h" value="wrapTopLevelContent" />
    <node concept="1hlzdc" id="22Kx9pTvMUI" role="1hl$rw">
      <ref role="1hmvP4" to="yv47:2uR5X5ayM7T" resolve="IToplevelExprContent" />
      <ref role="1hszAz" to="w9y2:6LfBX8Yivpj" resolve="IComponentsChunkContent" />
      <node concept="1ht64k" id="22Kx9pTvMUJ" role="1hsNre">
        <node concept="3clFbS" id="22Kx9pTvMUK" role="2VODD2">
          <node concept="3clFbF" id="22Kx9pTvN67" role="3cqZAp">
            <node concept="2pJPEk" id="22Kx9pTvN65" role="3clFbG">
              <node concept="2pJPED" id="22Kx9pTvNfC" role="2pJPEn">
                <ref role="2pJxaS" to="vwlt:1r45fM17GRh" resolve="TopLevelAdapter" />
                <node concept="2pIpSj" id="22Kx9pTvNoc" role="2pJxcM">
                  <ref role="2pIpSl" to="vwlt:1r45fM1jE9l" resolve="adapted" />
                  <node concept="36biLy" id="22Kx9pTvNwO" role="28nt2d">
                    <node concept="1ht04C" id="22Kx9pTvNDw" role="36biLW" />
                  </node>
                </node>
              </node>
            </node>
