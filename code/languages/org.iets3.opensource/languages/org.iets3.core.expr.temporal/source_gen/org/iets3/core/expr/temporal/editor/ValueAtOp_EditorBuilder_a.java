...
/*package*/ class ValueAtOp_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class timeSingleRoleHandler_yc9tn7_a0d0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public timeSingleRoleHandler_yc9tn7_a0d0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
