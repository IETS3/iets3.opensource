...
/*package*/ class BeforeOp_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BeforeOp_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_mu821y_a0");
    editorCell.addEditorCell(createCustomFactory_1());
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createSideTransformationSectionCell_0());
    if (nodeCondition_mu821y_a3a0()) {
      editorCell.addEditorCell(createCustomFactory_5());
    }
    if (nodeCondition_mu821y_a4a0()) {
      editorCell.addEditorCell(createCustomFactory_9());
    }
    editorCell.addEditorCell(createConstant_1());
    return editorCell;
  }
  private boolean nodeCondition_mu821y_a3a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.time$NH4n)).isNotEmpty();
  }
  private boolean nodeCondition_mu821y_a4a0() {
    return (SLinkOperations.getTarget(myNode, LINKS.time$NH4n) == null);
  }
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> cell).invoke();
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_IDotTarget_cellMenu_mu821y_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_IDotTarget_cellMenu_mu821y_a0a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_IDotTarget_cellMenu_mu821y_a0a0a0() {
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_mu821y_b0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for BeforeOp.time") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new TMP_Group_mu821y_a0c0a());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_mu821y_c0a");
    return editorCell;
  }
  public class TMP_Group_mu821y_a0c0a extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    private SContainmentLink link;
    public TMP_Group_mu821y_a0c0a() {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new GenericMenuPart_a0a2a0_1(), new TMP_Action_mu821y_b0a2a0());
    }
    private class GenericMenuPart_a0a2a0_1 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class TMP_Action_mu821y_b0a2a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          caretPosition.save();
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.time$NH4n));
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new timeSingleRoleHandler_mu821y_a0d0a(myNode, LINKS.time$NH4n, getEditorContext());
    return provider.createCell();
  }
  private static class timeSingleRoleHandler_mu821y_a0d0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public timeSingleRoleHandler_mu821y_a0d0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.time$NH4n, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.time$NH4n, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.time$NH4n);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.time$NH4n));
      try {
  ...
  private EditorCell createCustomFactory_8(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          SLinkOperations.setTarget(node, LINKS.time$NH4n, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xcfaa4966b7d54b69L, 0xb66a309a6e1a7290L, 0x670d5e92f854a047L, "org.iets3.core.expr.base.structure.Expression")));
        }
      });
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
  ...
  private EditorCell createReadOnlyModelAccessor_1() {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_mu821y_a0e0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_mu821y_f0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
