              ...
              if (wasOption) {
                {
                  ...
                  typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "7638810057883496968", true), (SNode) createOptionType_euyag4_a1a0c0a0a0n0b0a1a0a1a0b0a0c(SNodeOperations.as(operationType, CONCEPTS.Type$WK)), _info_12389875345);
                }
              } else if (wasTemporal) {
                {
                  SNode _nodeToCheck_1029348928467 = binaryLogicalExpression;
                  ...
                  typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "7638810057883496992", true), (SNode) createTemporalType_euyag4_a1a0c0a0a0a31a1a0b0a0b0a1a0a2(SNodeOperations.as(operationType, CONCEPTS.Type$WK)), _info_12389875345);
                }
              } else {
                {
                  SNode _nodeToCheck_1029348928467 = binaryLogicalExpression;
