...
public final class MapSlicesOp__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x4621d3e3b8a34bbeL, 0xb7ac234b6e2d1d68L, 0x6a0281468755b8caL, "org.iets3.core.expr.temporal.structure.MapSlicesOp");
  ...
  /*package*/ static SNode requiredType_id6zmBjqUm7MF(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(IDotTarget__BehaviorDescriptor.contextExpression_id6zmBjqUivyF.invoke(__thisNode__)), CONCEPTS.TemporalType$oH), LINKS.baseType$ZN4a);
  }

  /*package*/ MapSlicesOp__BehaviorDescriptor() {
  }
