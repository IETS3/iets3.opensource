...
public class typeof_BinaryComparisonExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public boolean overrides(final SNode bce, IsApplicableStatus status) {
    return true;
  }
  public void applyRule(final SNode bce, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      final SNode leftType = typeCheckingContext.typeOf(SLinkOperations.getTarget(bce, LINKS.left$zxUa), "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474755", true);
      typeCheckingContext.whenConcrete(leftType, () -> {
        {
          final SNode rightType = typeCheckingContext.typeOf(SLinkOperations.getTarget(bce, LINKS.right$zBjx), "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474751", true);
          typeCheckingContext.whenConcrete(rightType, () -> {
            ...
            operationType = typeCheckingContext.getOverloadedOperationType(bce, lt, rt, (modelId, ruleId) -> typeCheckingContext.reportWarning(bce, "conflicting rules for overloaded operation type", modelId, ruleId, null, new NodeMessageTarget()));
            if (operationType != null) {
              if (wasOption) {
                {
                  SNode _nodeToCheck_1029348928467 = bce;
                  EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474712", 0, null);
                  typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474722", true), (SNode) createOptionType_5v0o3_a1a0c0a0a0n0b0a1a0a1a0b0a0c(SNodeOperations.cast(operationType, CONCEPTS.Type$WK)), _info_12389875345);
                }
              } else if (wasTemporal) {
                {
                  SNode _nodeToCheck_1029348928467 = bce;
                  EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474736", 0, null);
                  typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474746", true), (SNode) createTemporalType_5v0o3_a1a0c0a0a0a31a1a0b0a0b0a1a0a2(SNodeOperations.cast(operationType, CONCEPTS.Type$WK)), _info_12389875345);
                }
              } else {
                {
                  SNode _nodeToCheck_1029348928467 = bce;
                  EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474727", 0, null);
                  typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474731", true), (SNode) operationType, _info_12389875345);
                }
              }
            } else {
              {
                final MessageTarget errorTarget = new NodeMessageTarget();
                IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(bce, ErrorCheckingUtil.cannotBeAppliedToTypesMessage(SConceptOperations.conceptAlias(SNodeOperations.getConcept(bce)), typeCheckingContext.getExpandedNode(leftType), typeCheckingContext.getExpandedNode(rightType)), "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474693", null, errorTarget);
              }
              {
                SNode _nodeToCheck_1029348928467 = bce;
                EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474702", 0, null);
                typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474707", true), (SNode) createRuntimeErrorType_5v0o3_a1a0c0b0a31a1a0b0a0b0a1a0a2(), _info_12389875345);
              }
            }
          }, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474585", false, false);
        }
      }, "r:782cab7d-c30f-4797-991c-cb17d0274086(org.iets3.core.expr.temporal.typesystem)", "5528978585118474581", false, false);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.BinaryComparisonExpression$7z;
  }
  public IsApplicableStatus isApplicableAndPattern(SNode argument) {
    return new IsApplicableStatus(argument.getConcept().isSubConceptOf(getApplicableConcept()), null);
  }
  private static SNode createRuntimeErrorType_5v0o3_a1a0c0b0a31a1a0b0a0b0a1a0a2() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.RuntimeErrorType$3c);
    return n0.getResult();
  }
  private static SNode createOptionType_5v0o3_a1a0c0a0a0n0b0a1a0a1a0b0a0c(SNode p0) {
  ...
  private static SNode createTemporalType_5v0o3_a1a0c0a0a0a31a1a0b0a0b0a1a0a2(SNode p0) {
