...
public final class QueryTransform__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x10e056b249fd40caL, 0x8b64de69c81163acL, 0x5da9d77c646917f1L, "org.iets3.core.expr.query.structure.QueryTransform");
  ...
  /*package*/ static SNode createMetaFunction_id5cK3QOc9qti(@NotNull SNode __thisNode__) {
    SNode mf = IMetaFunctionContext__BehaviorDescriptor.createNew_id6dpaV_AQiiy.invoke(__thisNode__, null, "filter");
    MetaFunction__BehaviorDescriptor.addArg_id6dpaV_AQ5Xf.invoke(mf, "element", SNodeOperations.copyNode(SLinkOperations.getTarget(SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(AbstractQueryComponent__BehaviorDescriptor.query_id5QDPRL$oZHJ.invoke(__thisNode__), LINKS.source$IlS6)), CONCEPTS.CollectionType$kS), LINKS.baseType$5NOJ)));
    return mf;
  }

  /*package*/ QueryTransform__BehaviorDescriptor() {
  }
