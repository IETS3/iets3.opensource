...
/*package*/ class ConsumesPortCategory_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ConsumesPortCategory_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_wxg2iz_a0");
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createCustomFactory_1());
    return editorCell;
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "consumes");
    editorCell.setCellId("Constant_wxg2iz_a0a");
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_wxg2iz_a0b0a();
  ...
  private boolean nodeCondition_wxg2iz_a0b0a() {
    IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.optional$LW1h);
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_wxg2iz_a0b0a");
    return editorCell;
  }
      ...
      final boolean isApplicable = new Object() {
        public boolean query() {
          ...
          applicable &= new Object() {
            public boolean query() {
              return EditorCustomizationConfigHelper.getConfig().isFlagCellSideTransformationActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.ConsumesPortCategory$CD, PROPS.optional$LW1h), subconcept, node, editorContext);
            }
          }.query();
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public String getShortDescriptionText(String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String descriptiontext = EditorCustomizationConfigHelper.getConfig().getFlagCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.ConsumesPortCategory$CD, PROPS.optional$LW1h), originalText, editorContext);
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.ConsumesPortCategory$CD);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.optional$LW1h);
          ...
          public SAbstractConcept getOutputConcept() {
            return CONCEPTS.ConsumesPortCategory$CD;
          }
        };
