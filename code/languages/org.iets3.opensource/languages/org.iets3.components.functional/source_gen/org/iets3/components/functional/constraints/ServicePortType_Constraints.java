...
public class ServicePortType_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ServicePortType_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ServicePortType$Rm, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.service$D09C, container, true, false);
    }
    @Nullable
    @Override
