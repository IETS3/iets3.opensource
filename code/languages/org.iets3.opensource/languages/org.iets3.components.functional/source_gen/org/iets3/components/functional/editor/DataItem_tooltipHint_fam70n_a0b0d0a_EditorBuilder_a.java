...
/*package*/ class DataItem_tooltipHint_fam70n_a0b0d0a_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    QueryListHandler handler = new QueryListHandler_9ulae4_a0(editorContext, node, true);
  ...
  private static class QueryListHandler_9ulae4_a0 extends QueryListHandler {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist8292968687748304730")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
