...
/*package*/ class SimpleState_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SimpleState_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_cx143a_a0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_cx143a_a0a0");
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_cx143a_a0a0a0a();
  ...
  private boolean nodeCondition_cx143a_a0a0a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_cx143a_a0a0a0a");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.SimpleState$GX);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.initial$PcPI);
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_cx143a_b0a0a");
    Style style = new StyleImpl();
    new componentsKeywordStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createTooltip_0() {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(getEditorContext(), myNode, "org.iets3.components.functional.editor.GeneratedHints.tooltipHint_cx143a_c0a0a", true);
    ...
    editorCell.setCellId("Tooltip_cx143a_c0a0a");
    return editorCell;
  }
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_cx143a_d0a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_cx143a_b0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentsListHandler_cx143a_b1a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_contents");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class contentsListHandler_cx143a_b1a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public contentsListHandler_cx143a_b1a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentsListHandler_cx143a_b1a0.this.getNode(), LINKS.contents$Xv1y));
      try {
    ...
    private EditorCell createConstant_3() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_cx143a_a1b0a");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_cx143a_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
