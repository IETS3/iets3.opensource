...
/*package*/ class DataItemConstructor_tooltipHint_m27nl3_a0b0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DataItemConstructor_tooltipHint_m27nl3_a0b0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ua6xl1_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.components.functional.editor.GeneratedHints.tooltipHint_m27nl3_a0b0"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_ua6xl1_a0(getEditorContext(), getNode(), true);
    EditorCell_QueryList editorCell = handler.createCells(new CellLayout_Horizontal());
    editorCell.setTargeConcept(CONCEPTS.DataItem$8n);
    editorCell.setOwner(SNodeOperations.getConcept(getNode()));
    editorCell.setCellId("QueryList_ua6xl1_a0");
  ...
  private static class QueryListHandler_ua6xl1_a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_ua6xl1_a0(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist5380113973800500882")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
