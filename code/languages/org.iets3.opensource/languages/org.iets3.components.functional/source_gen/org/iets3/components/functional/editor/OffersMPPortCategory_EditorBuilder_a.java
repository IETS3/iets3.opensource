...
/*package*/ class OffersMPPortCategory_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public OffersMPPortCategory_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "offers");
    editorCell.setCellId("Constant_2hxy8p_a0a");
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for OffersMPPortCategory.cardinality") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new TMP_Group_2hxy8p_a0b0a());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_2hxy8p_b0a");
    return editorCell;
  }
  public class TMP_Group_2hxy8p_a0b0a extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    private SContainmentLink link;
    public TMP_Group_2hxy8p_a0b0a() {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new GenericMenuPart_a0a1a0_1(), new TMP_Action_2hxy8p_b0a1a0());
    }
    ...
    private class TMP_Action_2hxy8p_b0a1a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          caretPosition.save();
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.cardinality$$N8P));
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new cardinalitySingleRoleHandler_2hxy8p_a0c0a(myNode, LINKS.cardinality$$N8P, getEditorContext());
    return provider.createCell();
  }
  private static class cardinalitySingleRoleHandler_2hxy8p_a0c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public cardinalitySingleRoleHandler_2hxy8p_a0c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.cardinality$$N8P, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.cardinality$$N8P, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.cardinality$$N8P);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.cardinality$$N8P));
      try {
