...
/*package*/ class OffersMPPortCategory_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public class TMP_Group_2hxy8p_a0b0a extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new GenericMenuPart_a0a1a0_4(), new TMP_Action_2hxy8p_b0a1a0());
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new cardinalitySingleRoleHandler_2hxy8p_a2a0(myNode, LINKS.cardinality$$N8P, getEditorContext());
    return provider.createCell();
  }
  private static class cardinalitySingleRoleHandler_2hxy8p_a2a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public cardinalitySingleRoleHandler_2hxy8p_a2a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
