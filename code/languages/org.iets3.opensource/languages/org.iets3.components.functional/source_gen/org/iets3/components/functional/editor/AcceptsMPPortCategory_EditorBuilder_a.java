...
/*package*/ class AcceptsMPPortCategory_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AcceptsMPPortCategory_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "accepts");
    editorCell.setCellId("Constant_jzv0jz_a0a");
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for AcceptsMPPortCategory.cardinality") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new TMP_Group_jzv0jz_a0b0a());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_jzv0jz_b0a");
    return editorCell;
  }
  public class TMP_Group_jzv0jz_a0b0a extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    private SContainmentLink link;
    public TMP_Group_jzv0jz_a0b0a() {
    ...
    private class TMP_Action_jzv0jz_b0a1a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
