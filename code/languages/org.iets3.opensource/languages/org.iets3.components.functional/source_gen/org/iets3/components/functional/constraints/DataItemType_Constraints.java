...
public class DataItemType_Constraints extends BaseConstraintsDescriptor {
  public DataItemType_Constraints() {
    super(CONCEPTS.DataItemType$Gg);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.item$4$yw, this, true, false) {
      @Nullable
      @Override
