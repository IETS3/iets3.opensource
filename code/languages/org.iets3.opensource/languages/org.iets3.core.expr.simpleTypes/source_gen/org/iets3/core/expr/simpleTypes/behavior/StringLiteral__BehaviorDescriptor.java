...
public final class StringLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isEmpty_id7fOaqhhYzIQ = new SMethodBuilder<>(Boolean.TYPE).name("isEmpty").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8355348994405841846L).languageId(0xa2091919bd737f50L, 0x6b277d9ad52d416fL).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id4Y0vh0cfqjE, isSameAs_id7GwCuf2r4g6, isEmpty_id7fOaqhhYzIQ, getStringValue_id2q1ydqQjSPO);
