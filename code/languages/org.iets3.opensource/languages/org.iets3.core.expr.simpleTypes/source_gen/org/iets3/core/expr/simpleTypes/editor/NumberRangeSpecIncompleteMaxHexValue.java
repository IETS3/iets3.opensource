...
public class NumberRangeSpecIncompleteMaxHexValue extends TransformationMenuBase {
  public NumberRangeSpecIncompleteMaxHexValue() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "NumberRangeSpecIncompleteMaxHexValue", new SNodePointer("r:6d94c93d-1ff8-4e1f-8fca-b92e9d42f070(org.iets3.core.expr.simpleTypes.editor)", "7324964097855662817")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
