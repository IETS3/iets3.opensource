...
public class NumberRangeSpecIncompleteMinHexValue extends TransformationMenuBase {
  public NumberRangeSpecIncompleteMinHexValue() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "NumberRangeSpecIncompleteMinHexValue", new SNodePointer("r:6d94c93d-1ff8-4e1f-8fca-b92e9d42f070(org.iets3.core.expr.simpleTypes.editor)", "6624864447955107946")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new TMP_WrapSM_u6zyct_a0());
    }
    return result;
  }

  public class TMP_WrapSM_u6zyct_a0 extends WrapSubstituteMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap substitute menu " + "default substitute menu for " + "NumberLiteral", new SNodePointer("r:6d94c93d-1ff8-4e1f-8fca-b92e9d42f070(org.iets3.core.expr.simpleTypes.editor)", "7324964097855009688")));
      try {
    ...
    private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SubstituteCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        ...
        SPropertyOperations.assign(spec, PROPS.min$7OOG, SPropertyOperations.getString(createdNode, PROPS.value$iWTK));
        ISupportHexValues__BehaviorDescriptor.copyHexValue_id6mBw0A_sUtS.invoke(createdNode, PROPS.value$iWTK, PROPS.min$7OOG, spec);
      }
