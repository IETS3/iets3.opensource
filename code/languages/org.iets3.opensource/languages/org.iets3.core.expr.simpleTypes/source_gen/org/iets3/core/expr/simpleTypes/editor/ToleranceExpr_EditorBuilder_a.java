...
/*package*/ class ToleranceExpr_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_mgce45_a0a0(myNode, LINKS.value$i_DL, getEditorContext());
    return provider.createCell();
  }
  private static class valueSingleRoleHandler_mgce45_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public valueSingleRoleHandler_mgce45_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
