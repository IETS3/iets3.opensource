...
public final class StringStartsWithTarget__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x6b277d9ad52d416fL, 0xa2091919bd737f50L, 0x519b08aaf4cccee9L, "org.iets3.core.expr.simpleTypes.structure.StringStartsWithTarget");
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return "startsWith(" + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$CW3E)) + ")";
  }

  /*package*/ StringStartsWithTarget__BehaviorDescriptor() {
  }
