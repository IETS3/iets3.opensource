...
public final class StringEndsWithTarget__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x6b277d9ad52d416fL, 0xa2091919bd737f50L, 0x52dfb362974f2c33L, "org.iets3.core.expr.simpleTypes.structure.StringEndsWithTarget");
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return "endsWith(" + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$CW3E)) + ")";
  }

  /*package*/ StringEndsWithTarget__BehaviorDescriptor() {
  }
