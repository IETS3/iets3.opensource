...
/*package*/ class AbsExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createMathBase_0(EditorContext editorContext, SNode node) {
    ...
    final List<IMathSymbol> symbols = ListSequence.fromList(new ArrayList<IMathSymbol>());
    {
      ...
      symbol = new AbstractMathSymbol() {
        ...
        protected void paint(Graphics2D g, Rectangle2D bounds) {
          ...
          g.draw(new Line2D.Double(bounds.getCenterX(), bounds.getMinY() + 2, bounds.getCenterX(), bounds.getMaxY() - 2));
        }
    ...
    editorCell.setCellId("MathBase_vounap_a");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_vounap_a0a(myNode, LINKS.expr$CW3E, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_vounap_a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_vounap_a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
