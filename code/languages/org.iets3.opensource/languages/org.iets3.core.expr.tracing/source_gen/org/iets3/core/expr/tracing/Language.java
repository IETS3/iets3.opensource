package org.iets3.core.expr.tracing;
...
import org.iets3.core.expr.tracing.editor.EditorAspectDescriptorImpl;
import jetbrains.mps.smodel.runtime.StructureAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConceptPresentationAspect;
import org.iets3.core.expr.tracing.structure.ConceptPresentationAspectImpl;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("63c1aad1-e2db-439c-a30a-02b5e0bc80f3");
  }

  @Override
  public String getNamespace() {
    return "org.iets3.core.expr.tracing";
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.core.expr.tracing.structure.StructureAspectDescriptor());
    }
