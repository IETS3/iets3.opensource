...
public final class AlgebraicArgAccess__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x5fe6cb132fbd4e21L, 0x9842785bdd6fc5b1L, 0x52a5783d22d83db1L, "org.iets3.core.expr.adt.structure.AlgebraicArgAccess");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$CW3E)) + "[" + SPropertyOperations.getInteger(__thisNode__, PROPS.index$vCa5) + "]";
  }
  /*package*/ static int priority_id4rZeNQ6Nh_5(@NotNull SAbstractConcept __thisConcept__) {
    return 20000;
  }

  /*package*/ AlgebraicArgAccess__BehaviorDescriptor() {
  }
