...
public final class TraversalTopDown__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x5fe6cb132fbd4e21L, 0x9842785bdd6fc5b1L, 0x52a5783d23551292L, "org.iets3.core.expr.adt.structure.TraversalTopDown");
  ...
  /*package*/ static PVector perform_id5a_u3Ozn4SP(@NotNull SNode __thisNode__, AlgebraicValue root) {
    ...
    res = res.plus(root);
    for (AlgebraicValue c : Sequence.fromIterable(root.children())) {
      res = res.plusAll((Collection) TraversalStrategy__BehaviorDescriptor.perform_id5a_u3Ozn4SP.invoke(__thisNode__, c));
    }
    return res;
  }

  /*package*/ TraversalTopDown__BehaviorDescriptor() {
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((PVector) perform_id5a_u3Ozn4SP(node, (AlgebraicValue) parameters[0]));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
