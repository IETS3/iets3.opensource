...
public final class InterpreterCoverageAssResult__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xd441fba0f46b43cdL, 0xb723dad7b65da615L, 0x3969aca372b2dd91L, "org.iets3.core.expr.tests.structure.InterpreterCoverageAssResult");
  ...
  /*package*/ static SNode groupNode_id26F1SwiacwF(@NotNull SNode __thisNode__) {
    return ListSequence.fromList(SModelOperations.roots(SNodeOperations.getModel(SLinkOperations.getTarget(__thisNode__, LINKS.concept$EaN1)), null)).first();
  }
  /*package*/ static String groupLabel_id26F1Swi9trp(@NotNull SNode __thisNode__) {
    if (SLinkOperations.getTarget(__thisNode__, LINKS.concept$EaN1) == null) {
      return null;
    }
    String n = SPropertyOperations.getString(SModelOperations.getModuleStub(SNodeOperations.getModel(SLinkOperations.getTarget(__thisNode__, LINKS.concept$EaN1))), PROPS.name$MnvL);
    if (SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.concept$EaN1), PROPS.virtualPackage$EkXl) != null) {
      return n + " / " + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.concept$EaN1), PROPS.virtualPackage$EkXl);
    } else {
      return n;
    }
  }

  /*package*/ InterpreterCoverageAssResult__BehaviorDescriptor() {
  }
