...
public class typeof_OptExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  public typeof_OptExpression_InferenceRule() {
  }
  public void applyRule(final SNode optExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      final SNode et = typeCheckingContext.typeOf(SLinkOperations.getTarget(optExpression, LINKS.expr$CW3E), "r:8b1d85a0-933d-4f71-99e8-5435698868f9(org.iets3.core.expr.tests.typesystem)", "1801842150043104504", true);
  ...
  private static SNode createOptionType_iq1h5l_a1a0c0a0b0a1a0a1(SNode p0) {
