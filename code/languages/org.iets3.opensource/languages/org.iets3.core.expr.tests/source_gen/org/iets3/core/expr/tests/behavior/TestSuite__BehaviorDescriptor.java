...
public final class TestSuite__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> nonEmptyItems_id59WscmUTju7 = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("nonEmptyItems").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5943749602768664455L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
  public static final SMethod<Void> evaluateAll_id3_DFadMJ62m = new SMethodBuilder<>(Void.TYPE).name("evaluateAll").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4137027550721106070L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
  public static final SMethod<Boolean> evaluateAllAndReport_ideCXD91qMCZ = new SMethodBuilder<>(Boolean.TYPE).name("evaluateAllAndReport").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(263731686224374335L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
  ...
  public static final SMethod<String> getTestBodyName_idhOw0ICJ = new SMethodBuilder<>(String.class).name("getTestBodyName").modifiers(9, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1224602741295L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
  public static final SMethod<SNode> overrideType_idkxHAhaMTEW = new SMethodBuilder<>(SNode.class).name("overrideType").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(369777186288933564L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2(SMethodBuilder.createJavaParameter(SNode.class, "type"));
  ...
  public static final SMethod<String> getSimpleClassNameForGenerator_id6VjyfUYe5Ll = new SMethodBuilder<>(String.class).name("getSimpleClassNameForGenerator").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7985877191952456789L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
  public static final SMethod<String> getSimpleClassNameForInterpreter_id6VjyfUYebfH = new SMethodBuilder<>(String.class).name("getSimpleClassNameForInterpreter").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7985877191952479213L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
  ...
  public static final SMethod<String> getClassNameInterpreter_idljKHDcI6Wc = new SMethodBuilder<>(String.class).name("getClassNameInterpreter").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(383864636102438668L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
