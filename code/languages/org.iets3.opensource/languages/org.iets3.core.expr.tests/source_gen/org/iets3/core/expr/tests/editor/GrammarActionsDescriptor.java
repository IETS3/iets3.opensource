...
public class GrammarActionsDescriptor extends AbstractGrammarActionDescriptor implements IGrammarActionsDescriptor {
  ...
  public List<SubstituteMenuItem> getActions(final SubstituteMenuContext _context, final SAbstractConcept expectedOutputConceptExactly) {
    ...
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("org.iets3.core.expr.tests.editor.GrammarActionsDescriptor.getActions", null));
    try {
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "AndMatcher", new SNodePointer("r:ec4fadfa-b752-42e1-9d44-ff41929cb381(org.iets3.core.expr.tests.editor)", "1925389232535425916")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.AndMatcher$FE)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.AbstractValueMatcher$uv;
              for (final SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.AndMatcher$FE, _context.getModel(), AndMatcher_Editor.class, _context.getEditorContext()))) {
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  final SContainmentLink aggregation = LINKS.left$lODp;
                  ...
                  if (isApplicable) {
                    ...
                    List<SubstituteMenuItem> actions = _context.withLink(LINKS.left$lODp).createItems(new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(_context.getEditorContext().getRepository()), wrappedConcept));
                      ...
                      public Boolean invoke(SubstituteMenuItem it) {
                        ...
                        isApplicable &= new Object() {
                          public boolean query(SAbstractConcept expectedConcept) {
                            return EditorCustomizationConfigHelper.getConfig().isWrapperCellSubstitutionActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.left$lODp), expectedConcept, wrappedConcept, editorContext);
                          }
                    ...
                    wrappedActions = ListSequence.fromList(wrappedActions).select((final SubstituteMenuItem it) -> {
                      ...
                      SubstituteMenuItem wrapper = new SubstituteMenuItemWrapper(it) {
                        ...
                        public SNode createNode(@NotNull String pattern) {
                          ...
                          SLinkOperations.setTarget(wrapper, LINKS.left$lODp, SNodeOperations.cast(nodeToWrap, CONCEPTS.AbstractValueMatcher$uv));
                          ...
                          new Object() {
                            public void postprocess(SNode node, EditorContext editorContext, SNode parentNode) {
                              EditorCustomizationConfigHelper.getConfig().wrapperCellSubstitutionPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.left$lODp), node, editorContext);
                            }
                        ...
                        public String getDescriptionText(@NotNull final String pattern) {
                          ...
                          String descriptiontext = EditorCustomizationConfigHelper.getConfig().getWrapperCellSubstitutionDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.left$lODp), wrappedNode, wrappedConcept, subconcept, originalText, editorContext);
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "AndMatcher", new SNodePointer("r:ec4fadfa-b752-42e1-9d44-ff41929cb381(org.iets3.core.expr.tests.editor)", "6965353666330308361")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.AndMatcher$FE)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.AbstractValueMatcher$uv;
              for (final SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.AndMatcher$FE, _context.getModel(), AndMatcher_Editor.class, _context.getEditorContext()))) {
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  final SContainmentLink aggregation = LINKS.right$lP7r;
                  ...
                  if (isApplicable) {
                    // get all available actions
                    List<SubstituteMenuItem> actions = _context.withLink(LINKS.right$lP7r).createItems(new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(_context.getEditorContext().getRepository()), wrappedConcept));
                    // Filter based on grammar.rule conditions
                    List<SubstituteMenuItem> wrappedActions = ListSequence.fromList(actions).where(new _FunctionTypes._return_P1_E0<Boolean, SubstituteMenuItem>() {
                      public Boolean invoke(SubstituteMenuItem it) {
                        // Need to check constraints again for concrete type
                        ...
                        isApplicable &= new Object() {
                          public boolean query(SAbstractConcept expectedConcept) {
                            return EditorCustomizationConfigHelper.getConfig().isWrapperCellSubstitutionActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.right$lP7r), expectedConcept, wrappedConcept, editorContext);
                          }
                        }.query(expectedOutputConcept);
                        return isApplicable;
                      }
                    ...
                    wrappedActions = ListSequence.fromList(wrappedActions).select((final SubstituteMenuItem it) -> {
                      ...
                      SubstituteMenuItem wrapper = new SubstituteMenuItemWrapper(it) {
                        ...
                        public SNode createNode(@NotNull String pattern) {
                          ...
                          // use setupNode after setting wrapped element to allow access to the wrapped element in node factories
                          SNode wrapper = SConceptOperations.createNewNode(SNodeOperations.asInstanceConcept(outputConcept));
                          SLinkOperations.setTarget(wrapper, LINKS.right$lP7r, SNodeOperations.cast(nodeToWrap, CONCEPTS.AbstractValueMatcher$uv));
                          NodeFactoryManager.setupNode(outputConcept, wrapper, _context.getCurrentTargetNode(), _context.getParentNode(), _context.getModel());

                          new Object() {
                            public void postprocess(SNode node, EditorContext editorContext, SNode parentNode) {
                              EditorCustomizationConfigHelper.getConfig().wrapperCellSubstitutionPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.right$lP7r), node, editorContext);
                            }
                          }.postprocess(wrapper, _context.getEditorContext(), _context.getParentNode());
                          return wrapper;
                        }
                        ...
                        public String getDescriptionText(@NotNull final String pattern) {
                          ...
                          SAbstractConcept wrappedConcept = super.getOutputConcept();
                          EditorContext editorContext = _context.getEditorContext();
                          String descriptiontext = EditorCustomizationConfigHelper.getConfig().getWrapperCellSubstitutionDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.right$lP7r), wrappedNode, wrappedConcept, subconcept, originalText, editorContext);
                          return ((descriptiontext != null && descriptiontext.length() > 0) ? descriptiontext : originalText);
                        }
                        @Override
                        public SAbstractConcept getOutputConcept() {
  ...
  protected List<TransformationMenuItem> doGetSideTransformActions(final TransformationMenuContext _context) {
    ...
    _context.getEditorMenuTrace().pushTraceInfo();
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("org.iets3.core.expr.tests.editor.GrammarActionsDescriptor.doGetSideTransformActions", null));
    try {
      {
        final EditorContext editorContext = _context.getEditorContext();
        ...
        ListSequence.fromList(redirectedBefore).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from(new Object() {
          public TransformationMenuContext redirect() {
            ...
            SNode parentNode = new Parser(_context.getModel()).isEndOf(sourceNode, _context.getMenuLocation() == MenuLocations.LEFT_SIDE_TRANSFORM, CONCEPTS.ConstraintFailedTestItem$8Z, LINKS.actual$HavJ);
            if (parentNode != null) {
              return _context.withNode(parentNode);
            }

            // There might be no grammar for some concepts. Try a single level check.
            if (SNodeOperations.isInstanceOf(sourceNode, CONCEPTS.Expression$D_) && SNodeOperations.isInstanceOf(SNodeOperations.getParent(sourceNode), CONCEPTS.ConstraintFailedTestItem$8Z) && Objects.equals(sourceNode.getContainmentLink(), LINKS.actual$HavJ) && (_context.getMenuLocation() == MenuLocations.RIGHT_SIDE_TRANSFORM) == true) {
        ...
        ListSequence.fromList(redirectedBefore).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from((SNodeOperations.isInstanceOf(((SNode) _context.getNode()), CONCEPTS.ConstraintFailedTestItem$8Z) ? _context : null), ((_FunctionTypes._return_P1_E0<Boolean, TransformationMenuContext>) (TransformationMenuContext parentContext) -> {
          final SNode sourceNode = parentContext.getNode();
          return true;
        })));
        ...
        ListSequence.fromList(redirectedAfter).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from((SNodeOperations.isInstanceOf(((SNode) _context.getNode()), CONCEPTS.ConstraintFailedTestItem$8Z) ? _context : null), ((_FunctionTypes._return_P1_E0<Boolean, TransformationMenuContext>) (TransformationMenuContext parentContext) -> {
          ...
          return new Object() {
            public boolean renderingCondition(SNode node) {
              return node.getProperty(PROPS.errmsg$RJqM) != null;
            }
        ...
        ListSequence.fromList(redirectedAfter).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from((SNodeOperations.isInstanceOf(((SNode) _context.getNode()), CONCEPTS.ConstraintFailedTestItem$8Z) ? _context : null), ((_FunctionTypes._return_P1_E0<Boolean, TransformationMenuContext>) (TransformationMenuContext parentContext) -> {
          ...
          return new Object() {
            public boolean renderingCondition(SNode node) {
              return SPropertyOperations.getBoolean(SNodeOperations.getNodeAncestor(node, CONCEPTS.TestSuite$it, false, false), PROPS.showTypes$Hb9J);
            }
          }.renderingCondition(sourceNode);
        })));
        ListSequence.fromList(redirectedAfter).addElement(null);
        new Object() {
          public void withRedirectedContext(final TransformationMenuContext _context) {
            ...
            final SNode sourceNode = _context.getNode();
            EditorContext editorContext = _context.getEditorContext();
            if (SNodeOperations.isInstanceOf(sourceNode, CONCEPTS.ConstraintFailedTestItem$8Z)) {
                  ...
                  return new Object() {
                    public Iterable<String> query(SNode node) {
                      return new StringOrSequenceQuery() {
                        public Object queryStringOrSequence() {
                          String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellTransformationText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.ConstraintFailedTestItem$8Z, PROPS.errmsg$RJqM), node, editorContext);
                          return ((description != null && description.length() > 0) ? description : "with");
                        }
                      }.query();
                    }
              ...
              final boolean isApplicable = new Object() {
                public boolean query() {
                  return _context.getNode().getProperty(PROPS.errmsg$RJqM) == null;
                }
              }.query();
              ...
              if (isApplicable && Sequence.fromIterable(matchingTexts).isNotEmpty()) {
                ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, _context) {
                  ...
                  public SNode doSubstitute(@NotNull String pattern) {
                    SProperty property = PROPS.errmsg$RJqM;
                    ...
                    new Object() {
                      public void postprocess(SNode node) {
                        EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.ConstraintFailedTestItem$8Z, PROPS.errmsg$RJqM), node, editorContext);
                      }
                  ...
                  public String getShortDescriptionText(@NotNull String pattern) {
                    ...
                    EditorContext editorContext = _context.getEditorContext();
                    String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.ConstraintFailedTestItem$8Z, PROPS.errmsg$RJqM), node, originalText, editorContext);
                    return ((description != null && description.length() > 0) ? description : "add an error message for the constraint failed test item");
                  }
          ...
          public void withRedirectedContext(List<Tuples._2<TransformationMenuContext, _FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>> beforeContexts, List<Tuples._2<TransformationMenuContext, _FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>> afterContexts) {
            ...
            for (int validIndex = 0; validIndex < ListSequence.fromList(contexts).count(); validIndex++) {
              ...
              if (!(EditorHierachyCache.getInstance().isActiveEditor(ConstraintFailedTestItem_Editor.class, redirectedContext.getNode().getConcept(), GrammarCellsUtil.getSelectionHints(_context.getEditorContext())))) {
                continue;
              }
      ...
      }
      {
        ...
        ListSequence.fromList(redirectedBefore).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from(new Object() {
          public TransformationMenuContext redirect() {
            ...
            // Use the grammar rules for a deep search
            SNode parentNode = new Parser(_context.getModel()).isEndOf(sourceNode, _context.getMenuLocation() == MenuLocations.LEFT_SIDE_TRANSFORM, CONCEPTS.InvalidValueTestItem$XR, LINKS.actual$kjlt);
            if (parentNode != null) {
              return _context.withNode(parentNode);
            }

            // There might be no grammar for some concepts. Try a single level check.
            if (SNodeOperations.isInstanceOf(sourceNode, CONCEPTS.Expression$D_) && SNodeOperations.isInstanceOf(SNodeOperations.getParent(sourceNode), CONCEPTS.InvalidValueTestItem$XR) && Objects.equals(sourceNode.getContainmentLink(), LINKS.actual$kjlt) && (_context.getMenuLocation() == MenuLocations.RIGHT_SIDE_TRANSFORM) == true) {
              TransformationMenuContext parentContext = _context.withNode(_context.getNode().getParent());
              return parentContext;
            }
        ...
        ListSequence.fromList(redirectedBefore).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from((SNodeOperations.isInstanceOf(((SNode) _context.getNode()), CONCEPTS.InvalidValueTestItem$XR) ? _context : null), ((_FunctionTypes._return_P1_E0<Boolean, TransformationMenuContext>) (TransformationMenuContext parentContext) -> {
          final SNode sourceNode = parentContext.getNode();
          return true;
        })));
        ...
        ListSequence.fromList(redirectedAfter).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from((SNodeOperations.isInstanceOf(((SNode) _context.getNode()), CONCEPTS.InvalidValueTestItem$XR) ? _context : null), ((_FunctionTypes._return_P1_E0<Boolean, TransformationMenuContext>) (TransformationMenuContext parentContext) -> {
          ...
          return new Object() {
            public boolean renderingCondition(SNode node) {
              return node.getProperty(PROPS.errmsg$HvfE) != null;
            }
          }.renderingCondition(sourceNode);
        })));
        ListSequence.fromList(redirectedAfter).addElement(MultiTuple.<TransformationMenuContext,_FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>from((SNodeOperations.isInstanceOf(((SNode) _context.getNode()), CONCEPTS.InvalidValueTestItem$XR) ? _context : null), ((_FunctionTypes._return_P1_E0<Boolean, TransformationMenuContext>) (TransformationMenuContext parentContext) -> {
        ...
        new Object() {
          public void withRedirectedContext(final TransformationMenuContext _context) {
            ...
            final SNode sourceNode = _context.getNode();
            EditorContext editorContext = _context.getEditorContext();
            if (SNodeOperations.isInstanceOf(sourceNode, CONCEPTS.InvalidValueTestItem$XR)) {
              final Iterable<String> matchingTexts = new StringOrSequenceQuery() {
                public Object queryStringOrSequence() {
                  EditorContext editorContext = _context.getEditorContext();
                  return new Object() {
                    public Iterable<String> query(SNode node) {
                      return new StringOrSequenceQuery() {
                        public Object queryStringOrSequence() {
                          String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellTransformationText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.InvalidValueTestItem$XR, PROPS.errmsg$HvfE), node, editorContext);
                          return ((description != null && description.length() > 0) ? description : "with");
                        }
                      }.query();
                    }
              ...
              final boolean isApplicable = new Object() {
                public boolean query() {
                  return _context.getNode().getProperty(PROPS.errmsg$HvfE) == null;
                }
              }.query();
              ...
              if (isApplicable && Sequence.fromIterable(matchingTexts).isNotEmpty()) {
                ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, _context) {
                  ...
                  public SNode doSubstitute(@NotNull String pattern) {
                    SProperty property = PROPS.errmsg$HvfE;
                    _context.getNode().setProperty(property, "");
                    SelectionUtil.selectCell(editorContext, _context.getNode(), "*" + CellIdManager.createPropertyId(property.getName()));
                    new Object() {
                      public void postprocess(SNode node) {
                        EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.InvalidValueTestItem$XR, PROPS.errmsg$HvfE), node, editorContext);
                      }
                    }.postprocess(_context.getNode());
                    return _context.getNode();
                  }
                  ...
                  public String getShortDescriptionText(@NotNull String pattern) {
                    ...
                    SNode node = _context.getNode();
                    EditorContext editorContext = _context.getEditorContext();
                    String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.InvalidValueTestItem$XR, PROPS.errmsg$HvfE), node, originalText, editorContext);
                    return ((description != null && description.length() > 0) ? description : "add an error message for the invalid value test item");
                  }

                  @Override
                  public SAbstractConcept getOutputConcept() {
                    return CONCEPTS.InvalidValueTestItem$XR;
                  }
                });
              }
            }
          ...
          public void withRedirectedContext(List<Tuples._2<TransformationMenuContext, _FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>> beforeContexts, List<Tuples._2<TransformationMenuContext, _FunctionTypes._return_P1_E0<? extends Boolean, ? super TransformationMenuContext>>> afterContexts) {
            ...
            for (int validIndex = 0; validIndex < ListSequence.fromList(contexts).count(); validIndex++) {
              ...
              if (!(EditorHierachyCache.getInstance().isActiveEditor(InvalidValueTestItem_Editor.class, redirectedContext.getNode().getConcept(), GrammarCellsUtil.getSelectionHints(_context.getEditorContext())))) {
                continue;
              }
            ...
            public Iterable<TransformationMenuItem> query(final TransformationMenuContext _context) {
              ...
              try {
                if (_context.getMenuLocation() == MenuLocations.RIGHT_SIDE_TRANSFORM) {
                  final SNode sourceNode = new Parser(_context.getModel()).isEndOf(_context.getNode(), _context.getMenuLocation() == MenuLocations.LEFT_SIDE_TRANSFORM, CONCEPTS.AbstractValueMatcher$uv, null);
                  final EditorContext editorContext = _context.getEditorContext();
                  ...
                  if (sourceNode != null) {
                    ...
                    for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.AndMatcher$FE, _context.getModel(), AndMatcher_Editor.class, _context.getEditorContext())) {
                      ...
                      if (wrapperAllowed) {
                        final Iterable<String> matchingText = Sequence.<String>singleton("and");
                        if (Sequence.fromIterable(matchingText).isNotEmpty()) {
                          ...
                          sideTransformationEnabled &= new Object() {
                            public boolean enabled(SNode wrappedNode) {
                              return EditorCustomizationConfigHelper.getConfig().isWrapperCellSideTransformationActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.left$lODp), wrappedNode, subconcept, editorContext);
                            }
                          }.enabled(SNodeOperations.cast(sourceNode, CONCEPTS.AbstractValueMatcher$uv));
                          if (sideTransformationEnabled) {
                            ListSequence.fromList(result).addSequence(Sequence.fromIterable(new MultiTextActionItem(matchingText, _context) {
                              ...
                              protected SNode doSubstitute(@Nullable EditorContext editorContext, String pattern) {
                                ...
                                SNode wrapper = SNodeOperations.cast(SNodeFactoryOperations.createNewNode(subconcept, null), CONCEPTS.AndMatcher$FE);
                                SNodeOperations.replaceWithAnother(sourceNode, wrapper);
                                SLinkOperations.setTarget(wrapper, LINKS.left$lODp, SNodeOperations.cast(sourceNode, CONCEPTS.AbstractValueMatcher$uv));

                                new Object() {
                                  public void postprocess(SNode node) {
                                    EditorCustomizationConfigHelper.getConfig().wrapperCellSideTransformationPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.left$lODp), node, editorContext);
                                  }
                                }.postprocess(wrapper);
                    ...
                    for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.AndMatcher$FE, _context.getModel(), AndMatcher_Editor.class, _context.getEditorContext())) {
                      ...
                      if (wrapperAllowed) {
                        ...
                        if (Sequence.fromIterable(matchingText).isNotEmpty()) {
                          ...
                          sideTransformationEnabled &= new Object() {
                            public boolean enabled(SNode wrappedNode) {
                              return EditorCustomizationConfigHelper.getConfig().isWrapperCellSideTransformationActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.right$lP7r), wrappedNode, subconcept, editorContext);
                            }
                          }.enabled(SNodeOperations.cast(sourceNode, CONCEPTS.AbstractValueMatcher$uv));
                          if (sideTransformationEnabled) {
                            ListSequence.fromList(result).addSequence(Sequence.fromIterable(new MultiTextActionItem(matchingText, _context) {
                              ...
                              protected SNode doSubstitute(@Nullable EditorContext editorContext, String pattern) {
                                ...
                                SNode wrapper = SNodeOperations.cast(SNodeFactoryOperations.createNewNode(subconcept, null), CONCEPTS.AndMatcher$FE);
                                SNodeOperations.replaceWithAnother(sourceNode, wrapper);
                                SLinkOperations.setTarget(wrapper, LINKS.right$lP7r, SNodeOperations.cast(sourceNode, CONCEPTS.AbstractValueMatcher$uv));

                                new Object() {
                                  public void postprocess(SNode node) {
                                    EditorCustomizationConfigHelper.getConfig().wrapperCellSideTransformationPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.AndMatcher$FE, LINKS.right$lP7r), node, editorContext);
                                  }
                                }.postprocess(wrapper);
