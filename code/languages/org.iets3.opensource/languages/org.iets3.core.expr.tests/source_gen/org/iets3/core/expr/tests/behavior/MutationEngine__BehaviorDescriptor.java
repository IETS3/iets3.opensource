...
public final class MutationEngine__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> mutate_id3_xsRJ4oOrE = new SMethodBuilder<>(SNode.class).name("mutate").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4134712908315838186L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(SNode.class, "adapter"));
  public static final SMethod<Void> optionallyDelete_id1qjbRymONRy = new SMethodBuilder<>(Void.TYPE).name("optionallyDelete").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1626696085383888354L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(SModel.class, "m"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "delete"));
  public static final SMethod<SNode> findAdapterByInternalID_id3_xsRJ4LDk5 = new SMethodBuilder<>(SNode.class).name("findAdapterByInternalID").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4134712908322346245L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(SModel.class, "m"), SMethodBuilder.createJavaParameter(String.class, "internalID"));
  public static final SMethod<Mutator> findRandomMutator_id7WSgHRL8UlQ = new SMethodBuilder<>(Mutator.class).name("findRandomMutator").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9167150562513495414L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter((Class<List<Mutator>>) ((Class) Object.class), "muts"), SMethodBuilder.createJavaParameter(Random.class, "rand"));
  public static final SMethod<SNode> findRandomNode_id7WSgHRL9pFP = new SMethodBuilder<>(SNode.class).name("findRandomNode").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9167150562513623797L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), "nodes"), SMethodBuilder.createJavaParameter(Random.class, "rand"));
  public static final SMethod<Void> makeChange_id3_xsRJ4wolt = new SMethodBuilder<>(Void.TYPE).name("makeChange").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4134712908317820253L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(SNode.class, "adapter"), SMethodBuilder.createJavaParameter(SNode.class, "node"), SMethodBuilder.createJavaParameter((Class<Set<String>>) ((Class) Object.class), "mutatedNodes"), SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), "newChanges"), SMethodBuilder.createJavaParameter(Random.class, "rand"));
  public static final SMethod<SNode> replaceWith_id1qjbRymQQWe = new SMethodBuilder<>(SNode.class).name("replaceWith").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1626696085384425230L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(SNode.class, "oldNode"), SMethodBuilder.createJavaParameter(SNode.class, "newNode"), SMethodBuilder.createJavaParameter((Class<Set<String>>) ((Class) Object.class), "mutatedNodes"));
  public static final SMethod<Void> deleteAllMutationModels_id1qjbRymWTp$ = new SMethodBuilder<>(Void.TYPE).name("deleteAllMutationModels").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1626696085386008164L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2();
  /*package*/ static final SMethod<EditableSModel> createModelWithAdjustments_id7ah6lNITZbV = new SMethodBuilder<>(EditableSModel.class).name("createModelWithAdjustments").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(8255407478882693883L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(String.class, "name"), SMethodBuilder.createJavaParameter(ModelRoot.class, "root"));
  /*package*/ static final SMethod<EditableSModel> createClonedModel_id3_xsRJ4wgFT = new SMethodBuilder<>(EditableSModel.class).name("createClonedModel").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4134712908317788921L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(SNode.class, "adapter"), SMethodBuilder.createJavaParameter(String.class, "name"));
  public static final SMethod<String> nodeIdentifier_id1qjbRynmQXx = new SMethodBuilder<>(String.class).name("nodeIdentifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1626696085392813921L).languageId(0xb723dad7b65da615L, 0xd441fba0f46b43cdL).build2(SMethodBuilder.createJavaParameter(SNode.class, "n"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(mutate_id3_xsRJ4oOrE, optionallyDelete_id1qjbRymONRy, findAdapterByInternalID_id3_xsRJ4LDk5, findRandomMutator_id7WSgHRL8UlQ, findRandomNode_id7WSgHRL9pFP, makeChange_id3_xsRJ4wolt, replaceWith_id1qjbRymQQWe, deleteAllMutationModels_id1qjbRymWTp$, createModelWithAdjustments_id7ah6lNITZbV, createClonedModel_id3_xsRJ4wgFT, nodeIdentifier_id1qjbRynmQXx);
