...
/*package*/ class TaggedType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new baseTypeSingleRoleHandler_cmlawz_a0a0(myNode, LINKS.baseType$z6Mz, getEditorContext());
    return provider.createCell();
  }
  private static class baseTypeSingleRoleHandler_cmlawz_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public baseTypeSingleRoleHandler_cmlawz_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
