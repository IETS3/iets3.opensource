...
/*package*/ class AtMostTag_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new tagSingleRoleHandler_i5ub1w_a0a0(myNode, LINKS.tag$bwWW, getEditorContext());
    return provider.createCell();
  }
  private static class tagSingleRoleHandler_i5ub1w_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public tagSingleRoleHandler_i5ub1w_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
