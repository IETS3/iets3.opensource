...
public final class InportRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcee4aa62aca94f26L, 0x960275129cd457c9L, 0x4f91a4533f716cc3L, "org.iets3.core.expr.dataflow.structure.InportRef");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.port$_Q9r), PROPS.name$MnvL);
  }

  /*package*/ InportRef__BehaviorDescriptor() {
  }
