...
/*package*/ class MessageDefinition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new kindSingleRoleHandler_fc1f1l_a0c0a(myNode, LINKS.kind$Zhxq, getEditorContext());
    return provider.createCell();
  }
  private static class kindSingleRoleHandler_fc1f1l_a0c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public kindSingleRoleHandler_fc1f1l_a0c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      ...
      if (isApplicable && Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(items).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public SNode doSubstitute(@NotNull String pattern) {
            ...
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.MessageDefinition$yx, LINKS.args$ez70), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.MessageDefinition$yx, LINKS.args$ez70), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add arguments for the message definition");
          }
  ...
  private EditorCell createCustomFactory_8(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      EditorCell_Collection collection = as_1my5tx_a0a0a0a0a0e0bb(cell, EditorCell_Collection.class);
      if (collection != null) {
  ...
  private static <T> T as_1my5tx_a0a0a0a0a0e0bb(Object o, Class<T> type) {
