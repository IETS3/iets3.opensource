...
/*package*/ class IAttributed_tooltipHint_k5k6oj_a0b0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IAttributed_tooltipHint_k5k6oj_a0b0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_n2yw81_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.core.attributes.editor.GeneratedHints.tooltipHint_k5k6oj_a0b0"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_n2yw81_a0(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_n2yw81_a0");
  ...
  private static class QueryListHandler_n2yw81_a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_n2yw81_a0(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist5298733714215258350")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
