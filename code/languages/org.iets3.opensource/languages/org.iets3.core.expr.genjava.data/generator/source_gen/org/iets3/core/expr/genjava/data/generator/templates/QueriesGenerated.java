...
public class QueriesGenerated extends QueryProviderBase {
  ...
  {
    rtqMethods.put("7503962471791180565", new RTQ(0, "Dummy.Table"));
    rtqMethods.put("7503962471791194416", new RTQ(1, "x"));
    rtqMethods.put("7503962471791432614", new RTQ(2, "x"));
    rtqMethods.put("7503962471791770143", new RTQ(3, "Dummy.Table"));
    rtqMethods.put("7503962471791790455", new RTQ(4, "lookup"));
    rtqMethods.put("7503962471792212991", new RTQ(5, "Dummy.Table"));
    rtqMethods.put("7503962471792214580", new RTQ(6, "row1"));
    rtqMethods.put("7503962471791273449", new RTQ(7, "Dummy.Table"));
  }
  @NotNull
  @Override
