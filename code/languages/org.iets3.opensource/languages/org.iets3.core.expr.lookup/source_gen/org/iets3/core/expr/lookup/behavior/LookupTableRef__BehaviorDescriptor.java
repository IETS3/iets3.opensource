...
public final class LookupTableRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x406e4b3cffd4d16L, 0x85336bc50680ab3bL, 0x5155d54bed09e6cbL, "org.iets3.core.expr.lookup.structure.LookupTableRef");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.table$PWmI), PROPS.name$MnvL);
  }

  /*package*/ LookupTableRef__BehaviorDescriptor() {
  }
