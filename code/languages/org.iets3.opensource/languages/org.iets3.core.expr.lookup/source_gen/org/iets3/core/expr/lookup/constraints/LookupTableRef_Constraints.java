...
public class LookupTableRef_Constraints extends BaseConstraintsDescriptor {
  public LookupTableRef_Constraints() {
    super(CONCEPTS.LookupTableRef$J);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.table$PWmI, this, true, false) {
      @Nullable
      @Override
