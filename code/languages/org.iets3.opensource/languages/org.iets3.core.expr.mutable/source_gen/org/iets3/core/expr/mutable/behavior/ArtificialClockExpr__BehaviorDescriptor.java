...
public final class ArtificialClockExpr__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfbba51185fc649ffL, 0x9c3b0b4469830440L, 0x34aae0bbdcabe63cL, "org.iets3.core.expr.mutable.structure.ArtificialClockExpr");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "artificialclock(" + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.expr$CW3E)) + ")";
  }
  ...
  /*package*/ ArtificialClockExpr__BehaviorDescriptor() {
  }
