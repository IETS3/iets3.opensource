...
public final class InteractorValueTarget__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfbba51185fc649ffL, 0x9c3b0b4469830440L, 0xfc43d48231b3c65L, "org.iets3.core.expr.mutable.structure.InteractorValueTarget");
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(__thisNode__, PROPS.value$ZaAF);
  }
  ...
  /*package*/ InteractorValueTarget__BehaviorDescriptor() {
  }
