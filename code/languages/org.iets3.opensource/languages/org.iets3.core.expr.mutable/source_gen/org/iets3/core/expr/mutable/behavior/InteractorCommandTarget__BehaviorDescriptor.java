...
public final class InteractorCommandTarget__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfbba51185fc649ffL, 0x9c3b0b4469830440L, 0x7f2b47dbd5e22e64L, "org.iets3.core.expr.mutable.structure.InteractorCommandTarget");
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(__thisNode__, PROPS.command$ndav) + ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.args$KTc5)).select((it) -> (String) Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(it));
  }
  ...
  /*package*/ InteractorCommandTarget__BehaviorDescriptor() {
  }
