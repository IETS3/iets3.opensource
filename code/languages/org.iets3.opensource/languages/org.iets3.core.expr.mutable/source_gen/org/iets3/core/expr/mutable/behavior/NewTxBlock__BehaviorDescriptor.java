...
public final class NewTxBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfbba51185fc649ffL, 0x9c3b0b4469830440L, 0x3b0d68f3e822d910L, "org.iets3.core.expr.mutable.structure.NewTxBlock");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "newtx" + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.body$lrCm));
  }
  ...
  /*package*/ NewTxBlock__BehaviorDescriptor() {
  }
