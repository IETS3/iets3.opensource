...
public final class InTxBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfbba51185fc649ffL, 0x9c3b0b4469830440L, 0x1de35533f43fa62dL, "org.iets3.core.expr.mutable.structure.InTxBlock");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(effectDescriptor_id6GySMNjjWfO, renderReadable_id4Y0vh0cfqjE);
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "intx" + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.body$OzSD));
  }

  /*package*/ InTxBlock__BehaviorDescriptor() {
  }
