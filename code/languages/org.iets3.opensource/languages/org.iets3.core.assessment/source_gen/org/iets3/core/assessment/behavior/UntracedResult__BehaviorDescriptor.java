...
public final class UntracedResult__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbe5191a9347647caL, 0xb2a7a426623add55L, 0x31c871243d0fe67aL, "org.iets3.core.assessment.structure.UntracedResult");
  ...
  /*package*/ static String uniqueIdentifier_idK292flwHwe(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.element$tflb).getNodeId().toString();
  }
  /*package*/ static void updateValues_id5L$H31Kf5$y(@NotNull SNode __thisNode__, SNode updatedResult) {
  }

  /*package*/ UntracedResult__BehaviorDescriptor() {
  }
