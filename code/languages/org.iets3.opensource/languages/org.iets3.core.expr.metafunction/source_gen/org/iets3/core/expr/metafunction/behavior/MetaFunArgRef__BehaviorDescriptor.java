...
public final class MetaFunArgRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x711a16d799e84e1dL, 0xb20c99c0b7309cd8L, 0x53300f6d0cb1bb6dL, "org.iets3.core.expr.metafunction.structure.MetaFunArgRef");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.arg$XHAH), PROPS.name$MnvL);
  }

  /*package*/ MetaFunArgRef__BehaviorDescriptor() {
  }
