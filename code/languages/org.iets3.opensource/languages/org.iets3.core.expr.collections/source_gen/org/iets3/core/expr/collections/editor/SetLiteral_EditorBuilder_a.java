...
/*package*/ class SetLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_v21z3z_a0");
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> cell).invoke();
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_Expression_cellMenu_v21z3z_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_Expression_cellMenu_v21z3z_a0a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Expression_cellMenu_v21z3z_a0a0a0() {
    }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_v21z3z_a1a0();
  ...
  private boolean nodeCondition_v21z3z_a1a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.typeConstraint$aeKT)).isNotEmpty();
  }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          caretPosition.save();
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.typeConstraint$aeKT));
  ...
  private EditorCell createCustomFactory_6(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      final SNode childNode = SLinkOperations.getTarget(myNode, LINKS.typeConstraint$aeKT);
      new Object() {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeConstraintSingleRoleHandler_v21z3z_a0a1a0(myNode, LINKS.typeConstraint$aeKT, getEditorContext());
    return provider.createCell();
  }
  private static class typeConstraintSingleRoleHandler_v21z3z_a0a1a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeConstraintSingleRoleHandler_v21z3z_a0a1a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.typeConstraint$aeKT, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.typeConstraint$aeKT, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.typeConstraint$aeKT);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.typeConstraint$aeKT));
      try {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for SetLiteral.typeConstraint") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_v21z3z_a1a0");
    return editorCell;
  }
          ...
          return new Object() {
            public Iterable<String> query(SNode node) {
              return new StringOrSequenceQuery() {
                public Object queryStringOrSequence() {
                  String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellTransformationText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.SetLiteral$Js, LINKS.typeConstraint$aeKT), node, editorContext);
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.SetLiteral$Js), LINKS.typeConstraint$aeKT, null);
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.SetLiteral$Js, LINKS.typeConstraint$aeKT), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.SetLiteral$Js, LINKS.typeConstraint$aeKT), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add a type constraint for the set literal");
          }
        });
      }
      return result;
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_v21z3z_c0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new elementsListHandler_v21z3z_d0a(myNode, getEditorContext());
  ...
  private static class elementsListHandler_v21z3z_d0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public elementsListHandler_v21z3z_d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(elementsListHandler_v21z3z_d0a.this.getNode(), LINKS.elements$psbq));
      try {
    ...
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_v21z3z_a3a0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_v21z3z_e0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
