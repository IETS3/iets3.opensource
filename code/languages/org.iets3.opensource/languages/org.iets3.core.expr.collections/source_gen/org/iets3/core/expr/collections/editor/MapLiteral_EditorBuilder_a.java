...
/*package*/ class MapLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> cell).invoke();
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_Expression_cellMenu_1yskak_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_Expression_cellMenu_1yskak_a0a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Expression_cellMenu_1yskak_a0a0a0() {
    }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_1yskak_a1a0();
  ...
  private boolean nodeCondition_1yskak_a1a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.typeConstraint$V$xj)).isNotEmpty();
  }
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.BACKSPACE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          ...
          caretPosition.save();
          SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.typeConstraint$V$xj));
  ...
  private EditorCell createCustomFactory_6(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      final SNode childNode = SLinkOperations.getTarget(myNode, LINKS.typeConstraint$V$xj);
      new Object() {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeConstraintSingleRoleHandler_1yskak_a0a1a0(myNode, LINKS.typeConstraint$V$xj, getEditorContext());
    return provider.createCell();
  }
  private static class typeConstraintSingleRoleHandler_1yskak_a0a1a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeConstraintSingleRoleHandler_1yskak_a0a1a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.typeConstraint$V$xj, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.typeConstraint$V$xj, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.typeConstraint$V$xj);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.typeConstraint$V$xj));
      try {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for MapLiteral.typeConstraint") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_1yskak_a1a0");
    return editorCell;
  }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_1yskak_c0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new elementsListHandler_1yskak_d0a(myNode, getEditorContext());
  ...
  private static class elementsListHandler_1yskak_d0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public elementsListHandler_1yskak_d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(elementsListHandler_1yskak_d0a.this.getNode(), LINKS.elements$7Qes));
      try {
    ...
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_1yskak_a3a0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
      editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_1yskak_e0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
