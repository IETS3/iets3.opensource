...
public final class MaxOp__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getVariableName_id7BxfuU7QrrQ(@NotNull SNode __thisNode__) {
    return "maxOp_" + __thisNode__.getNodeId();
  }
  ...
  /*package*/ static Iterable<SNode> getVariableConstraints_id7BxfuU7Qruw(@NotNull SNode __thisNode__) {
    ...
    SNode lambdaArg = createLambdaArg_4j0djq_a0b0e(SLinkOperations.getTarget(SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(IDotTarget__BehaviorDescriptor.contextExpression_id6zmBjqUivyF.invoke(__thisNode__)), CONCEPTS.CollectionType$kS), LINKS.baseType$5NOJ));

    return Sequence.<SNode>singleton(createLogicalAndExpression_4j0djq_a0a3a4(IDotTarget__BehaviorDescriptor.contextExpression_id6zmBjqUivyF.invoke(__thisNode__), IDotTarget__BehaviorDescriptor.contextExpression_id6zmBjqUivyF.invoke(__thisNode__), lambdaArg, lambdaArg));
  }
  ...
  private static SNode createLambdaArg_4j0djq_a0b0e(SNode p0) {
  ...
  private static SNode createLogicalAndExpression_4j0djq_a0a3a4(SNode p0, SNode p1, SNode p2, SNode p3) {
    ...
    }
    {
      ...
      n4.forChild(LINKS.expr$CW3E).initNode(p1, CONCEPTS.Expression$D_, true);
      {
        SNodeBuilder n5 = n4.forChild(LINKS.target$u23F).init(CONCEPTS.AllOp$W2);
        {
          ...
          {
            SNodeBuilder n8 = n6.forChild(LINKS.expression$T2aj).init(CONCEPTS.GreaterEqualsExpression$TY);
            {
