...
public class CollectionSizeSpecMinValue extends TransformationMenuBase {
  public CollectionSizeSpecMinValue() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "CollectionSizeSpecMinValue", new SNodePointer("r:7785963d-85cb-4509-b1db-0610e781c465(org.iets3.core.expr.collections.editor)", "7324964097855800846")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
