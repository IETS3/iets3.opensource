...
/*package*/ class CollectionType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_tyseve_a0");
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_Type_cellMenu_tyseve_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_Type_cellMenu_tyseve_a0a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Type_cellMenu_tyseve_a0a0a0() {
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_tyseve_b0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new baseTypeSingleRoleHandler_tyseve_c0a(myNode, LINKS.baseType$5NOJ, getEditorContext());
    return provider.createCell();
  }
  private static class baseTypeSingleRoleHandler_tyseve_c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public baseTypeSingleRoleHandler_tyseve_c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_tyseve_d0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_tyseve_a4a0();
  ...
  private boolean nodeCondition_tyseve_a4a0() {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new sizeConstraintSingleRoleHandler_tyseve_a0a4a0(myNode, LINKS.sizeConstraint$C3Ch, getEditorContext());
    return provider.createCell();
  }
  private static class sizeConstraintSingleRoleHandler_tyseve_a0a4a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public sizeConstraintSingleRoleHandler_tyseve_a0a4a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for CollectionType.sizeConstraint") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_tyseve_a4a0");
    return editorCell;
  }
