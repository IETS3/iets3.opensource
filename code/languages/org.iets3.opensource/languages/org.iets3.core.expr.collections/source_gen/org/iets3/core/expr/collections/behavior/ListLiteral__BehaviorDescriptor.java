...
public final class ListLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x2f7e2e356e744c43L, 0x9fa52465d68f5996L, 0x68d69d36ba497ed7L, "org.iets3.core.expr.collections.structure.ListLiteral");
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id4Y0vh0cfqjE, getChildrenForCoverage_id5IKJrJHNCE8, effectDescriptor_id6GySMNjjWfO);


  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "list(" + Expression__BehaviorDescriptor.commaSeparatedRR_idHywGhj7zY_.invoke(__thisNode__, SLinkOperations.getChildren(__thisNode__, LINKS.elements$_r5J)) + ")";
  }
  /*package*/ static Iterable<SNode> getChildrenForCoverage_id5IKJrJHNCE8(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, LINKS.elements$_r5J);
  }
  /*package*/ static EffectDescriptor effectDescriptor_id6GySMNjjWfO(@NotNull SNode __thisNode__) {
    return EffectDescriptor.forNodes(SLinkOperations.getChildren(__thisNode__, LINKS.elements$_r5J));
  }
