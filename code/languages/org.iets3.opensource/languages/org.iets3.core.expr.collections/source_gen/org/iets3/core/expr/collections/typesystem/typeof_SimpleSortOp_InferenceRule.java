...
public class typeof_SimpleSortOp_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  public typeof_SimpleSortOp_InferenceRule() {
  }
  public void applyRule(final SNode sso, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      final SNode ctxType = typeCheckingContext.typeOf(IDotTarget__BehaviorDescriptor.contextExpression_id6zmBjqUivyF.invoke(sso), "r:1fd78142-d7d8-42c9-9cbb-0609b1bc5311(org.iets3.core.expr.collections.typesystem)", "7556050311757634847", true);
  ...
  private static SNode createListType_rrwusq_a1a0c0a0a0b0a1a0a1(SNode p0) {
