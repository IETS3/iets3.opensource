...
public class CollectionSizeSpecMaxValue extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("named transformation menu " + "CollectionSizeSpecMaxValue", new SNodePointer("r:7785963d-85cb-4509-b1db-0610e781c465(org.iets3.core.expr.collections.editor)", "7324964097855662817")));
    try {
