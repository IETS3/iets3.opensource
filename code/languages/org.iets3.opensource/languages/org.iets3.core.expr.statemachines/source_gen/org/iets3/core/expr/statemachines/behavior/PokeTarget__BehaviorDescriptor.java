...
public final class PokeTarget__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcd87ddab6434448eL, 0xa0111e1c898de18eL, 0x552c6248b18d642dL, "org.iets3.core.expr.statemachines.structure.PokeTarget");
  ...
  /*package*/ static EffectDescriptor effectDescriptor_id6GySMNjjWfO(@NotNull SNode __thisNode__) {
    return EffectDescriptor.modifiesAndReads();
  }

  /*package*/ PokeTarget__BehaviorDescriptor() {
  }
