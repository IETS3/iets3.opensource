...
/*package*/ class StatemachineVar_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_n2tsot_a0a0a();
  ...
  private boolean nodeCondition_n2tsot_a0a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_n2tsot_a0a0a");
    return editorCell;
  }
      ...
      final boolean isApplicable = new Object() {
        public boolean query() {
          ...
          applicable &= new Object() {
            public boolean query() {
              return EditorCustomizationConfigHelper.getConfig().isFlagCellSideTransformationActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.StatemachineVar$Qb, PROPS.observable$wgmr), subconcept, node, editorContext);
            }
          }.query();
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            ...
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.StatemachineVar$Qb, LINKS.type$EhVN), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            String originalText = super.getShortDescriptionText(pattern);
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.StatemachineVar$Qb, LINKS.type$EhVN), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add a type for the state machine variable");
          }
        });
      }
      return result;
