...
/*package*/ class Event_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_ymj9mh_a3a0()) {
      editorCell.addEditorCell(createCustomFactory_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_ymj9mh_a3a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.args$aKQV)).isNotEmpty();
  }
  private EditorCell createConstant_0() {
    ...
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_ISMContent_cellMenu_ymj9mh_a0a0a(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  public static class ReplaceWith_ISMContent_cellMenu_ymj9mh_a0a0a extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_ISMContent_cellMenu_ymj9mh_a0a0a() {
    }
    ...
    protected EditorMenuDescriptor createEditorMenuDescriptor(CellContext cellContext, EditorContext editorContext) {
      return new EditorMenuDescriptorBase("replace node (custom node concept: " + "ISMContent" + ")", new SNodePointer("r:3ff9f818-daab-4449-aa16-e1231523d3a3(org.iets3.core.expr.statemachines.editor)", "1790111001742446995"));
    }
  }
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_ymj9mh_c0a");
    return editorCell;
  }
  private class GenericMenuPart_a0c0a implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    public List<TransformationMenuItem> createItems(final TransformationMenuContext ctx) {
      ...
      final boolean isApplicable = ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(ctx.getNode(), CONCEPTS.Event$Q3), LINKS.args$aKQV)).isEmpty();
  ...
  private EditorCell createCustomFactory_0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      EditorCell_Collection collection = as_9o0aut_a0a0a0a0a0e0q(cell, EditorCell_Collection.class);
      if (collection != null) {
        ...
        for (EditorCell child : Sequence.fromIterable(GrammarCellsUtil.getUnwrappedChildren(collection))) {
          if (Objects.equals(child.getSNode().getContainmentLink(), LINKS.args$aKQV)) {
  ...
  private EditorCell createCollection_1() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_ymj9mh_a3a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_ymj9mh_a0d0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new argsListHandler_ymj9mh_b0d0a(myNode, getEditorContext());
  ...
  private static class argsListHandler_ymj9mh_b0d0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public argsListHandler_ymj9mh_b0d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argsListHandler_ymj9mh_b0d0a.this.getNode(), LINKS.args$aKQV));
      try {
    ...
    private EditorCell createConstant_2() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_ymj9mh_a1a3a0");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_ymj9mh_c0d0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private static <T> T as_9o0aut_a0a0a0a0a0e0q(Object o, Class<T> type) {
