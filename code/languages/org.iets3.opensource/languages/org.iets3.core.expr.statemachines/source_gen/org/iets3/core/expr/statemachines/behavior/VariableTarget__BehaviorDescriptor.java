...
public final class VariableTarget__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcd87ddab6434448eL, 0xa0111e1c898de18eL, 0x2b547b5bd00b22fL, "org.iets3.core.expr.statemachines.structure.VariableTarget");
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.var$N0wy), PROPS.name$MnvL);
  }
  ...
  /*package*/ VariableTarget__BehaviorDescriptor() {
  }
