...
/*package*/ class FeatureIncludeToolTip_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_xnqczs_b0(getEditorContext(), getNode(), true);
  ...
  private EditorCell createQueryList_1() {
    ...
    QueryListHandler handler = new QueryListHandler_xnqczs_d0(getEditorContext(), getNode(), true);
