...
/*package*/ class Feature_tooltipHint_8lh0g7_a0a5a_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Feature_tooltipHint_8lh0g7_a0a5a_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_8hqsn5_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.variability.featuremodel.base.editor.GeneratedHints.tooltipHint_8lh0g7_a0a5a"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_8hqsn5_a0(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_8hqsn5_a0");
  ...
  private static class QueryListHandler_8hqsn5_a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_8hqsn5_a0(EditorContext context, SNode ownerNode, boolean readOnly) {
