...
/*package*/ class ModelRootConstraints_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ModelRootConstraints_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_8y44ph_a");
  ...
  private EditorCell createCollapsible_0(EditorContext editorContext, SNode node) {
    EditorCell expanded = createQueryList_0();
    ...
    editorCell.setCellId("Collapsible_8y44ph_a0");
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_8y44ph_a0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_8y44ph_a0a");
    Style style = new StyleImpl();
  ...
  private static class QueryListHandler_8y44ph_a0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_8y44ph_a0a(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    public void installElementCellActions(SNode listOwner, SNode elementNode, EditorCell elementCell, EditorContext editorContext) {
      if (elementCell.getUserObject(AbstractCellListHandler.ELEMENT_CELL_ACTIONS_SET) == null) {
        ...
        if (elementNode != null) {
          ...
          FeatureModelConstraintsReadOnly.setCellActions(elementCell, elementNode, editorContext);
        }
    ...
    private Object executeQuery(final SNode node, final EditorContext editorContext) {
      return (Iterable<SNode>) FeatureTreeNode__BehaviorDescriptor.remoteConstraints_id2DztzAMudDA.invoke(myNode);
    }
    @Override
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist1535309995583299876")));
      } finally {
  ...
  private EditorCell createTooltip_0() {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(getEditorContext(), myNode, "org.iets3.variability.featuremodel.base.editor.GeneratedHints.tooltipHint_8y44ph_a0a", true);
    ...
    editorCell.setCellId("Tooltip_8y44ph_a0a");
    return editorCell;
  }
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        int size = Sequence.fromIterable((FeatureTreeNode__BehaviorDescriptor.remoteConstraints_id2DztzAMudDA.invoke(myNode))).count();
        return size + " Constraint" + ((size > 1 ? "s" : ""));
      }
    }, myNode);
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_8y44ph_a0a0");
    Style style = new StyleImpl();
    new iets3MuchSmallerStyleClass(this).apply(style, editorCell);
