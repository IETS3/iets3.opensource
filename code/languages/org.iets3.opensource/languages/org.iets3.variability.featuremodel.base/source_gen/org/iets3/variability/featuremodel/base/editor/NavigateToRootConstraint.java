...
public class NavigateToRootConstraint {
  ...
  /*package*/ static AbstractCellAction createAction_CLICK(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        EditorCell foundCell = editorContext.getEditorComponent().findNodeCell(node, false);
        if (foundCell != null) {
          editorContext.selectWRTFocusPolicy(foundCell);
        }
      }
