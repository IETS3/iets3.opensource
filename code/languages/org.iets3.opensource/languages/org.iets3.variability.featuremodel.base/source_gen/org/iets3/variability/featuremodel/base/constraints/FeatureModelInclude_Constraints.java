...
public class FeatureModelInclude_Constraints extends BaseConstraintsDescriptor {
  /*package*/ FeatureModelInclude_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.FeatureModelInclude$Iq, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.fm$EY24, container, true, false);
    }
    @Nullable
    @Override
