...
/*package*/ class Feature_tooltipHint_f5vgr_a0a3a0a0a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Feature_tooltipHint_f5vgr_a0a3a0a0a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_i8vuux_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.variability.featuremodel.base.editor.GeneratedHints.tooltipHint_f5vgr_a0a3a0a0a0"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_i8vuux_a0(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_i8vuux_a0");
  ...
  private static class QueryListHandler_i8vuux_a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_i8vuux_a0(EditorContext context, SNode ownerNode, boolean readOnly) {
