package org.iets3.variability.featuremodel.base.documentation;
...
public class DocumentationDescriptor implements IDocumentationAspectDescriptor {
  ...
  public SNode getDocumentation(final SAbstractConcept concept, final SProperty property) {
    ...
    final Language currentLanguage = repositoryFacade.getModule(PersistenceFacade.getInstance().createModuleReference("165f1d05-2506-4544-895e-1424f54166ec(org.iets3.variability.featuremodel.base)"), Language.class);
