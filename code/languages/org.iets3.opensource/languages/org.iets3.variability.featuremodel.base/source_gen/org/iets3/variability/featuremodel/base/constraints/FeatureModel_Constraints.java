...
public class FeatureModel_Constraints extends BaseConstraintsDescriptor {
  /*package*/ FeatureModel_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.FeatureModel$X0, initContext);
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.rootConstraintGrouping$Ir9P, container, false, true);
    }
    @Override
