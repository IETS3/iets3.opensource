...
/*package*/ class FeatureModelInclude_explorer_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FeatureModelInclude_explorer_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createTooltip_0() {
    LazyTooltipCellEvaluator tooltip = new LazyTooltipCellEvaluator(getEditorContext(), myNode, "org.iets3.variability.featuremodel.base.editor.GeneratedHints.tooltipHint_9425hd_a", true);
    ...
    editorCell.setCellId("Tooltip_9425hd_a");
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9425hd_a0");
  ...
  private EditorCell createCollapsible_0(EditorContext editorContext, SNode node) {
    EditorCell expanded = createCustomFactory_1();
    EditorCell collapsed = createCustomFactory_7();
    ...
    editorCell.setCellId("Collapsible_9425hd_a0a");
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_9425hd_a0a0a");
    editorCell.addEditorCell(createSideTransformationHolderProcessor_0());
    if (nodeCondition_9425hd_a1a0a0a()) {
      editorCell.addEditorCell(createCollection_4());
    }
    return editorCell;
  }
  private boolean nodeCondition_9425hd_a1a0a0a() {
  ...
  private EditorCell createCollection_2() {
    ...
    editorCell.setCellId("Collection_9425hd_a0a0a0a");
    editorCell.addKeyMap(new Feature_explorer_Keymap());
    editorCell.addEditorCell(createProperty_0());
    editorCell.addEditorCell(createAlternation_0());
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createRefCell_0());
    if (nodeCondition_9425hd_a4a0a0a0a()) {
      editorCell.addEditorCell(createCollection_3());
    }
    return editorCell;
  }
  private boolean nodeCondition_9425hd_a4a0a0a0a() {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_9425hd_a1a0a0a0a();
  ...
  private boolean nodeCondition_9425hd_a1a0a0a0a() {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new cardinalitySingleRoleHandler_9425hd_a0a1a0a0a0a(myNode, LINKS.cardinality$EsDt, getEditorContext());
    return provider.createCell();
  }
  private static class cardinalitySingleRoleHandler_9425hd_a0a1a0a0a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public cardinalitySingleRoleHandler_9425hd_a0a1a0a0a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for FeatureModelInclude.cardinality") {
      ...
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a1a0a0a0a());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_9425hd_a1a0a0a0a");
    return editorCell;
  }
  private class GenericMenuPart_a0a1a0a0a0a implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_9425hd_c0a0a0a0");
  ...
  private EditorCell createCollection_3() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_9425hd_e0a0a0a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_9425hd_a4a0a0a0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createCollection_4() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_9425hd_b0a0a0");
    editorCell.addEditorCell(createCollection_5());
    return editorCell;
  }
  private EditorCell createCollection_5() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_9425hd_a1a0a0a");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_9425hd_a0b0a0a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new actualParamsListHandler_9425hd_b0b0a0a0(myNode, getEditorContext());
  ...
  private static class actualParamsListHandler_9425hd_b0b0a0a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public actualParamsListHandler_9425hd_b0b0a0a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualParamsListHandler_9425hd_b0b0a0a0.this.getNode(), LINKS.actualParams$nrMf));
      try {
  ...
  private EditorCell createCollection_6() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_9425hd_a0a0a_0");
    editorCell.addEditorCell(createSideTransformationHolderProcessor_1());
    if (nodeCondition_9425hd_a1a0a0a_0()) {
      editorCell.addEditorCell(createCollection_9());
    }
    return editorCell;
  }
  private boolean nodeCondition_9425hd_a1a0a0a_0() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.actualParams$nrMf)).isNotEmpty() || Sequence.fromIterable(IUsingParamContext__BehaviorDescriptor.usingParams_idMYWxk17YoO.invoke(SLinkOperations.getTarget(myNode, LINKS.fm$EY24))).isNotEmpty();
  }
  private EditorCell createSideTransformationHolderProcessor_1() {
    final EditorCell editorCell = createCollection_7();
    if (editorCell instanceof jetbrains.mps.openapi.editor.cells.EditorCell_Collection) {
      SideTransformationHolderCell.processParentCollection((jetbrains.mps.openapi.editor.cells.EditorCell_Collection) editorCell);
    }
    return editorCell;
  ...
  private EditorCell createCollection_7() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_9425hd_a0a0a0a_0");
    editorCell.addKeyMap(new Feature_explorer_Keymap());
    ...
    if (nodeCondition_9425hd_a4a0a0a0a_0()) {
      editorCell.addEditorCell(createCollection_8());
    }
    return editorCell;
  }
  private boolean nodeCondition_9425hd_a4a0a0a0a_0() {
    return (boolean) FeatureTreeNode__BehaviorDescriptor.canBeOptional_id7g4qZxmpWtp.invoke(myNode) && !(SEnumOperations.isMember(SPropertyOperations.getEnum(myNode, PROPS.defaultState$z3_z), 0x74046bf8564f89faL));
  }
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_9425hd_a1a0a0a0a_0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_9425hd_a1a0a0a0a_0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.cardinality$EsDt)).isNotEmpty();
  }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new cardinalitySingleRoleHandler_9425hd_a0a1a0a0a0a_0(myNode, LINKS.cardinality$EsDt, getEditorContext());
    return provider.createCell();
  }
  private static class cardinalitySingleRoleHandler_9425hd_a0a1a0a0a0a_0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public cardinalitySingleRoleHandler_9425hd_a0a1a0a0a0a_0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for FeatureModelInclude.cardinality") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0a1a0a0a0a_0());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_9425hd_a1a0a0a0a_0");
    return editorCell;
  }
  private class GenericMenuPart_a0a1a0a0a0a_0 implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_9425hd_c0a0a0a0_0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.fm$EY24);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_notnull_smartReference(cell);
        return cell;
  ...
  private EditorCell createCollection_8() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_9425hd_e0a0a0a0_0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.HORIZONTAL_ALIGN, CellAlign.CENTER);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "initially");
    editorCell.setCellId("Constant_9425hd_a4a0a0a0a_0");
    Style style = new StyleImpl();
    new iets3MuchSmallerStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.PLAIN);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createCollection_9() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_9425hd_b0a0a0_0");
    editorCell.addEditorCell(createCollection_10());
    return editorCell;
  }
  private EditorCell createCollection_10() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_9425hd_a1a0a0a_0");
  ...
  private EditorCell createConstant_5() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "with");
    editorCell.setCellId("Constant_9425hd_a0b0a0a0_0");
    Style style = new StyleImpl();
    new iets3SmallerStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new actualParamsListHandler_9425hd_b0b0a0a0_0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_actualParams1");
    Style style = new StyleImpl();
    new iets3SmallerStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setSRole(handler.getElementSRole());
  ...
  private static class actualParamsListHandler_9425hd_b0b0a0a0_0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public actualParamsListHandler_9425hd_b0b0a0a0_0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actualParamsListHandler_9425hd_b0b0a0a0_0.this.getNode(), LINKS.actualParams$nrMf));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
