...
/*package*/ class Attribute_Editor_Inspector_ComponentBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Attribute_Editor_Inspector_ComponentBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private static class QueryListHandler_hhmbyc_a0 extends QueryListHandler {
     ...
     */
    private SNode myNode;
    public QueryListHandler_hhmbyc_a0(EditorContext context, SNode ownerNode, boolean readOnly) {
