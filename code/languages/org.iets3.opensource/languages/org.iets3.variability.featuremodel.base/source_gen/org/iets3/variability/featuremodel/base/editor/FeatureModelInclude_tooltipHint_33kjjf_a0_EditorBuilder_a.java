...
/*package*/ class FeatureModelInclude_tooltipHint_33kjjf_a0_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    QueryListHandler handler = new QueryListHandler_sx58cs_b0a0(editorContext, node, true);
  ...
  private EditorCell createQueryList_2(final EditorContext editorContext, final SNode node) {
    ...
    QueryListHandler handler = new QueryListHandler_sx58cs_d0a0(editorContext, node, true);
