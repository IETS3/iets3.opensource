...
/*package*/ class FeatureModelInclude_tooltipHint_33kjjf_a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FeatureModelInclude_tooltipHint_33kjjf_a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_sx58cs_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.variability.featuremodel.base.editor.GeneratedHints.tooltipHint_33kjjf_a0"});
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_sx58cs_a0a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_sx58cs_a0a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createQueryList_0() {

    QueryListHandler handler = new QueryListHandler_sx58cs_b0a0(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_sx58cs_b0a0");
  ...
  private static class QueryListHandler_sx58cs_b0a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_sx58cs_b0a0(EditorContext context, SNode ownerNode, boolean readOnly) {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_sx58cs_c0a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createQueryList_1() {

    QueryListHandler handler = new QueryListHandler_sx58cs_d0a0(getEditorContext(), getNode(), true);
    ...
    editorCell.setOwner(SNodeOperations.getConcept(getNode()));
    editorCell.setCellId("QueryList_sx58cs_d0a0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.READ_ONLY, true);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private static class QueryListHandler_sx58cs_d0a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_sx58cs_d0a0(EditorContext context, SNode ownerNode, boolean readOnly) {
      super(context, ownerNode, readOnly);
      myNode = ownerNode;
    }
    @NotNull
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_sx58cs_e0a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
