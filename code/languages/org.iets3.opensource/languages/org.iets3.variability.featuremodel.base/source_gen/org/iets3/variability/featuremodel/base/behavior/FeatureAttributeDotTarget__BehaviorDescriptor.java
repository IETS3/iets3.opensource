...
public final class FeatureAttributeDotTarget__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x165f1d0525064544L, 0x895e1424f54166ecL, 0x7cde27c7fd968aaaL, "org.iets3.variability.featuremodel.base.structure.FeatureAttributeDotTarget");
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.attribute$Av14), PROPS.name$MnvL);
  }

  /*package*/ FeatureAttributeDotTarget__BehaviorDescriptor() {
  }
