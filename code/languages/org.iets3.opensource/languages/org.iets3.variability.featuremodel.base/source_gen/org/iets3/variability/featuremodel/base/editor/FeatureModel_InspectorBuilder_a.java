...
/*package*/ class FeatureModel_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FeatureModel_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_1lfgks_0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_1lfgks_1");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_1lfgks_0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.visualization$7Wge;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no visualization>");
      editorCell.setCellId("property_visualization");
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_1lfgks_2");
    editorCell.addEditorCell(createConstant_1());
    editorCell.addEditorCell(createRefCell_0());
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Grouping:");
    editorCell.setCellId("Constant_1lfgks_1");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    ...
    provider.setNoTargetText("grouping");
  ...
  private EditorCell createHorizontalLineCell_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("HorizontalLineCell_1lfgks_0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_1lfgks_2");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new constraintsListHandler_1lfgks_e0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_constraints");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class constraintsListHandler_1lfgks_e0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public constraintsListHandler_1lfgks_e0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(constraintsListHandler_1lfgks_e0.this.getNode(), LINKS.constraints$SJXp));
      try {
