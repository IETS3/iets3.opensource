              ...
              for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(outputConcept, _context.getModel(), FeatureModelConfiguration_old_Editor.class, _context.getEditorContext())) {
                ...
                applicable &= new Object() {
                  public boolean query() {
                    return EditorCustomizationConfigHelper.getConfig().isFlagCellSubstitutionActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FeatureModelConfiguration_old$Nr, PROPS.abstract_old$lwwH), subconcept, substitutedNode, parentNode, editorContext);
                  }
                }.query();
                if (applicable) {
