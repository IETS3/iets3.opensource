...
public final class FeatureModel__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> getIncludedFeatureModels_id4$KkN8iCYUq = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getIncludedFeatureModels").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5273806638177054362L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
  ...
  public static final SMethod<Iterable<SNode>> usingParams_idMYWxk17YoO = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("usingParams").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(918437546057262644L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
  public static final SMethod<Iterable<SNode>> enumDeclarations_id4eA6KATu5ZO = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("enumDeclarations").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4874613375255470068L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
  public static final SMethod<Iterable<SNode>> defaultRelationChildren_id4eA6KATXKnM = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("defaultRelationChildren").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4874613375263770098L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
  public static final SMethod<Iterable<SNode>> orRelationChildren_id4eA6KAU38cU = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("orRelationChildren").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4874613375265178426L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
  public static final SMethod<Iterable<SNode>> xorRelationChildren_id4eA6KAU36NL = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("xorRelationChildren").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4874613375265172721L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
  /*package*/ static final SMethod<Iterable<SNode>> relationChildren_id4eA6KAU3cXl = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("relationChildren").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4874613375265197909L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2(SMethodBuilder.createJavaParameter(SEnumerationLiteral.class, "relationship"));
  ...
  public static final SMethod<Iterable<SNode>> featureAttributesInConstraints_idZsB2gDAfu$ = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("featureAttributesInConstraints").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1142960084575909796L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
  ...
  public static final SMethod<Boolean> containsCycle_id3eg222GEqlF = new SMethodBuilder<>(Boolean.TYPE).name("containsCycle").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3715478629009433963L).languageId(0x895e1424f54166ecL, 0x165f1d0525064544L).build2();
