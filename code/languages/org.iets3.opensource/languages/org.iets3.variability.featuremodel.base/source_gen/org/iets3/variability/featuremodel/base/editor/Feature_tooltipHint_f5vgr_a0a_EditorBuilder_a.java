...
/*package*/ class Feature_tooltipHint_f5vgr_a0a_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Feature_tooltipHint_f5vgr_a0a_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ozvyoy_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.variability.featuremodel.base.editor.GeneratedHints.tooltipHint_f5vgr_a0a"});
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_ozvyoy_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ozvyoy_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createQueryList_0() {

    QueryListHandler handler = new QueryListHandler_ozvyoy_b0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_ozvyoy_b0a");
  ...
  private static class QueryListHandler_ozvyoy_b0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_ozvyoy_b0a(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    private Object executeQuery(final SNode node, final EditorContext editorContext) {
      ...
      ListSequence.fromList(doc).addElement(SLinkOperations.getTarget(myNode, LINKS.doc$BpQs));
      return doc;
    }
    @Override
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist6003766691774449696")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_ozvyoy_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createQueryList_1() {

    QueryListHandler handler = new QueryListHandler_ozvyoy_d0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setOwner(SNodeOperations.getConcept(getNode()));
    editorCell.setCellId("QueryList_ozvyoy_d0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.READ_ONLY, true);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private static class QueryListHandler_ozvyoy_d0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_ozvyoy_d0a(EditorContext context, SNode ownerNode, boolean readOnly) {
      super(context, ownerNode, readOnly);
      myNode = ownerNode;
    }
    @NotNull
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        getCellFactory().setNodeLocation(new SNodeLocation.FromNode(node));
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist6003766691711910941")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
