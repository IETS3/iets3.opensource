...
/*package*/ class FeatureTreeNode_tooltipHint_8y44ph_a0a_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FeatureTreeNode_tooltipHint_8y44ph_a0a_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_vsfcwx_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.variability.featuremodel.base.editor.GeneratedHints.tooltipHint_8y44ph_a0a"});
  ...
  private EditorCell createQueryList_0() {
    ...
    QueryListHandler handler = new QueryListHandler_vsfcwx_a0(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_vsfcwx_a0");
  ...
  private static class QueryListHandler_vsfcwx_a0 extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_vsfcwx_a0(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist1535309995583299900")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
