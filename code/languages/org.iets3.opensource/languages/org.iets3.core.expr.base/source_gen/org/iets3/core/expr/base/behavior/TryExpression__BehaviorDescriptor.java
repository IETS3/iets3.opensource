...
public final class TryExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> effectiveType_id5BNZGjBvVRi = new SMethodBuilder<>(SNode.class).name("effectiveType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6481804410367229394L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  ...
  public static final SMethod<Boolean> hasGenericErrorClause_id69zaTr22NDs = new SMethodBuilder<>(Boolean.TYPE).name("hasGenericErrorClause").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7089558164911897180L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  public static final SMethod<SNode> genericErrorClause_id12WRc298GBx = new SMethodBuilder<>(SNode.class).name("genericErrorClause").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1206081519721040353L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  public static final SMethod<SNode> errorClauseForLiteral_id12WRc298JBm = new SMethodBuilder<>(SNode.class).name("errorClauseForLiteral").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1206081519721052630L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2(SMethodBuilder.createJavaParameter(String.class, "literal"));
  public static final SMethod<Iterable<SNode>> missingErrorClauses_id12WRc293Um2 = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("missingErrorClauses").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1206081519719785858L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(effectiveType_id5BNZGjBvVRi, getAutomaticName_idcJpacq408C, renderReadable_id4Y0vh0cfqjE, hasGenericErrorClause_id69zaTr22NDs, genericErrorClause_id12WRc298GBx, errorClauseForLiteral_id12WRc298JBm, missingErrorClauses_id12WRc293Um2, addChildToMainSlot_id91pmpwTPqy, effectDescriptor_id6GySMNjjWfO);
