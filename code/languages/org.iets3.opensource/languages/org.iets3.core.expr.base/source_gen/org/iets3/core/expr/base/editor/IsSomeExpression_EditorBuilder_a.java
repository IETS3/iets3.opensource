...
/*package*/ class IsSomeExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9nwpez_a0");
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    editorCell.getStyle().putAll(style);
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_Expression_cellMenu_9nwpez_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_Expression_cellMenu_9nwpez_a0a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Expression_cellMenu_9nwpez_a0a0a0() {
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_9nwpez_b0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_9nwpez_c0a(myNode, LINKS.expr$CW3E, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_9nwpez_c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_9nwpez_c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_9nwpez_d0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_9nwpez_a4a0();
  ...
  private boolean nodeCondition_9nwpez_a4a0() {
  ...
  private EditorCell createCollection_1() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_9nwpez_a0a4a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_9nwpez_a0a0e0a");
    Style style = new StyleImpl();
    new iets3KeywordStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new optionalNameSingleRoleHandler_9nwpez_b0a0e0a(myNode, LINKS.optionalName$AhFr, getEditorContext());
    return provider.createCell();
  }
  private static class optionalNameSingleRoleHandler_9nwpez_b0a0e0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public optionalNameSingleRoleHandler_9nwpez_b0a0e0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for IsSomeExpression.optionalName") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_9nwpez_a4a0");
    return editorCell;
  }
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.IsSomeExpression$Ae), LINKS.optionalName$AhFr, null);
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.IsSomeExpression$Ae, LINKS.optionalName$AhFr), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.IsSomeExpression$Ae, LINKS.optionalName$AhFr), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add an optional name for the isSome expression");
          }
        });
      }
      return result;
