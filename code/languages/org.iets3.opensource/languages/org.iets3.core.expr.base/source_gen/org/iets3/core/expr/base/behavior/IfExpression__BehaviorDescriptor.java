...
public final class IfExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> requiresMultiline_id6NJfo6_sQuA = new SMethodBuilder<>(Boolean.TYPE).name("requiresMultiline").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7849560302565943206L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(requiresMultiline_id6NJfo6_sQuA, renderReadable_id4Y0vh0cfqjE, invalidUseErrorMessage_id5ye9uPrgjJa, findTheSomeQueries_id5ye9uPrkFwU, isValExpressionUsedLegally_id5ye9uPrkHVH, constructCustomFrame_id2kg0xI3thT2, addChildToMainSlot_id91pmpwTPqy, getMultiSlotNames_id91pmpx1Rgq, effectDescriptor_id6GySMNjjWfO, allowsEffectForNode_idORfz$DS6Ap, getPathConstraintsTo_id3QFQUsNJoMc);
