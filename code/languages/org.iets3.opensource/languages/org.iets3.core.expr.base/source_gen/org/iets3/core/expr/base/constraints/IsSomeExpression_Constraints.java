...
public class IsSomeExpression_Constraints extends BaseConstraintsDescriptor {
  /*package*/ IsSomeExpression_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.IsSomeExpression$Ae, initContext);
  ...
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:9750d418-880f-460d-9880-d67dd111722d(org.iets3.core.expr.base.constraints)", "2605776245652488137");
