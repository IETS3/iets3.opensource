...
/*package*/ class AltOption_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new whenSingleRoleHandler_6z9ubr_a0a0(myNode, LINKS.when$ywD6, getEditorContext());
    return provider.createCell();
  }
  private static class whenSingleRoleHandler_6z9ubr_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public whenSingleRoleHandler_6z9ubr_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
