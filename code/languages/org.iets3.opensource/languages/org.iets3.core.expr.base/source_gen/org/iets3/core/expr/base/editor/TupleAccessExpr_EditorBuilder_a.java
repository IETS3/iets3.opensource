...
/*package*/ class TupleAccessExpr_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new tupleSingleRoleHandler_lltm3p_a0a0(myNode, LINKS.tuple$Aujp, getEditorContext());
    return provider.createCell();
  }
  private static class tupleSingleRoleHandler_lltm3p_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public tupleSingleRoleHandler_lltm3p_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
