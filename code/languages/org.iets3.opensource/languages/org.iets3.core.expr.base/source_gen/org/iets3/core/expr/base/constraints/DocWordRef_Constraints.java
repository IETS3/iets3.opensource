...
public class DocWordRef_Constraints extends BaseConstraintsDescriptor {
  /*package*/ DocWordRef_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.DocWordRef$7D, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.node$xsqG, container, true, false);
    }
    @Nullable
    @Override
