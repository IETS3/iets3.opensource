...
public final class SomeValExpr__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> originalRefTarget_id3kzwyUO_6g1 = new SMethodBuilder<>(SNode.class).name("originalRefTarget").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3829047245304783873L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id4Y0vh0cfqjE, originalRefTarget_id3kzwyUO_6g1);
