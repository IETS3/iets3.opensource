...
public final class AlternativesExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> hasOtherwise_id1OStjV1GoQ0 = new SMethodBuilder<>(Boolean.TYPE).name("hasOtherwise").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2105561738193767808L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  ...
  public static final SMethod<List<SNode>> getPathConstraintsTo_id3QFQUsNJoMc = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getPathConstraintsTo").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4443886968505207948L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2(SMethodBuilder.createJavaParameter(SNode.class, "descendant"));
  ...
  public static final SMethod<String> invalidUseErrorMessage_id5ye9uPrgjJa = new SMethodBuilder<>(String.class).name("invalidUseErrorMessage").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6381079423399050186L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2(SMethodBuilder.createJavaParameter(SNode.class, "some"));
  public static final SMethod<Iterable<SNode>> findTheSomeQueries_id5ye9uPrkFwU = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("findTheSomeQueries").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6381079423400196154L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  public static final SMethod<Boolean> isValExpressionUsedLegally_id5ye9uPrkHVH = new SMethodBuilder<>(Boolean.TYPE).name("isValExpressionUsedLegally").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6381079423400206061L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2(SMethodBuilder.createJavaParameter(SNode.class, "someVal"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(hasOtherwise_id1OStjV1GoQ0, solvedInTypeSystem_id1LoQHJHiiZd, createReducedExpression_id71dSyJVoY1g, renderReadable_id4Y0vh0cfqjE, asString_id6iqfHNBPkjP, createSolverTask_id4pkidg67Lgb, getChildrenForCoverage_id5IKJrJHNCE8, effectDescriptor_id6GySMNjjWfO, constructCustomFrame_id2kg0xI3thT2, getPathConstraintsTo_id3QFQUsNJoMc, getAllOtherwiseSiblings_id53cOfDpcBbK, invalidUseErrorMessage_id5ye9uPrgjJa, findTheSomeQueries_id5ye9uPrkFwU, isValExpressionUsedLegally_id5ye9uPrkHVH);
