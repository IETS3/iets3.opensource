...
/*package*/ class NoneLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_91g5sa_a0");
  ...
  private EditorCell createCustomFactory_2(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> cell).invoke();
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_Expression_cellMenu_91g5sa_a0a0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  ...
  public static class ReplaceWith_Expression_cellMenu_91g5sa_a0a0a0 extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_Expression_cellMenu_91g5sa_a0a0a0() {
    }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_91g5sa_a1a0();
  ...
  private boolean nodeCondition_91g5sa_a1a0() {
  ...
  private EditorCell createCollection_1() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_91g5sa_a0a1a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_91g5sa_a0a0b0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new optionalBaseTypeSingleRoleHandler_91g5sa_b0a0b0a(myNode, LINKS.optionalBaseType$UUMR, getEditorContext());
    return provider.createCell();
  }
  private static class optionalBaseTypeSingleRoleHandler_91g5sa_b0a0b0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public optionalBaseTypeSingleRoleHandler_91g5sa_b0a0b0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_91g5sa_c0a0b0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for NoneLiteral.optionalBaseType") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_91g5sa_a1a0");
    return editorCell;
  }
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.NoneLiteral$$J), LINKS.optionalBaseType$UUMR, null);
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.NoneLiteral$$J, LINKS.optionalBaseType$UUMR), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.NoneLiteral$$J, LINKS.optionalBaseType$UUMR), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add a base type for the none literal");
          }
        });
      }
      return result;
