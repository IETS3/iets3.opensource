...
/*package*/ class Invariant_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Invariant_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d0hy86_a0");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "inv");
    editorCell.setCellId("Constant_d0hy86_a0a");
    Style style = new StyleImpl();
    new iets3KeywordStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new BasicCellContext(myNode), new SubstituteInfoPartExt[]{new ReplaceWith_ContractItem_cellMenu_d0hy86_a0a0a(), new SChildSubstituteInfoPartEx(editorCell)}));
    return editorCell;
  }
  public static class ReplaceWith_ContractItem_cellMenu_d0hy86_a0a0a extends AbstractCellMenuPart_ReplaceNode_CustomNodeConcept {
    public ReplaceWith_ContractItem_cellMenu_d0hy86_a0a0a() {
    }
    ...
    protected EditorMenuDescriptor createEditorMenuDescriptor(CellContext cellContext, EditorContext editorContext) {
      return new EditorMenuDescriptorBase("replace node (custom node concept: " + "ContractItem" + ")", new SNodePointer("r:8405f486-53b5-4fe6-af3e-7f68358bd631(org.iets3.core.expr.base.editor)", "1790111001739863570"));
    }
  }
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_d0hy86_a0b0a();
  ...
  private boolean nodeCondition_d0hy86_a0b0a() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_d0hy86_a0b0a");
    return editorCell;
  }
      ...
      final boolean isApplicable = new Object() {
        public boolean query() {
          ...
          applicable &= new Object() {
            public boolean query() {
              return EditorCustomizationConfigHelper.getConfig().isFlagCellSideTransformationActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Invariant$I1, PROPS.warning$kIYM), subconcept, node, editorContext);
            }
          }.query();
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public String getShortDescriptionText(String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String descriptiontext = EditorCustomizationConfigHelper.getConfig().getFlagCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Invariant$I1, PROPS.warning$kIYM), originalText, editorContext);
            return ((descriptiontext != null && descriptiontext.length() > 0) ? descriptiontext : "an invariant that shows a warning instead of an error");
          }
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.Invariant$I1);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.warning$kIYM);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_d0hy86_c0a(myNode, LINKS.expr$CW3E, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_d0hy86_c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_d0hy86_c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_d0hy86_a3a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_d0hy86_a3a0() {
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_d0hy86_a0a3a0");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_d0hy86_a0a0d0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new errSingleRoleHandler_d0hy86_b0a0d0a(myNode, LINKS.err$phDR, getEditorContext());
    return provider.createCell();
  }
  private static class errSingleRoleHandler_d0hy86_b0a0d0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public errSingleRoleHandler_d0hy86_b0a0d0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for Invariant.err") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_d0hy86_a3a0");
    return editorCell;
  }
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.Invariant$I1), LINKS.err$phDR, null);
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Invariant$I1, LINKS.err$phDR), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            String originalText = super.getShortDescriptionText(pattern);
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Invariant$I1, LINKS.err$phDR), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add an error expression for the invariant");
          }
        });
      }
      return result;
