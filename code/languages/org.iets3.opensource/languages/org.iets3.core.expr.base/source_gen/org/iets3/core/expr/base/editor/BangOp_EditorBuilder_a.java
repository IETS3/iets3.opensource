...
/*package*/ class BangOp_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exprSingleRoleHandler_z0oeft_a0a0(myNode, LINKS.expr$CW3E, getEditorContext());
    return provider.createCell();
  }
  private static class exprSingleRoleHandler_z0oeft_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exprSingleRoleHandler_z0oeft_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
