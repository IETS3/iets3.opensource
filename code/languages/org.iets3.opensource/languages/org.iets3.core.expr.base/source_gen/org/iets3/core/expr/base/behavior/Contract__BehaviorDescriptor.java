...
public final class Contract__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> reanderReadable_idHywGhj8hkx = new SMethodBuilder<>(String.class).name("reanderReadable").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(820361861854729505L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(reanderReadable_idHywGhj8hkx, allowsEffectForNode_idORfz$DS6Ap);
