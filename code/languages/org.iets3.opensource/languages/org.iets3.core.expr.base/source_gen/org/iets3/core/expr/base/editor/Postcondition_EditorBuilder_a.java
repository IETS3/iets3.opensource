      ...
      final boolean isApplicable = new Object() {
        public boolean query() {
          ...
          applicable &= new Object() {
            public boolean query() {
              return EditorCustomizationConfigHelper.getConfig().isFlagCellSideTransformationActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Postcondition$Hy, PROPS.warning$kIYM), subconcept, node, editorContext);
            }
          }.query();
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public String getShortDescriptionText(String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String descriptiontext = EditorCustomizationConfigHelper.getConfig().getFlagCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Postcondition$Hy, PROPS.warning$kIYM), originalText, editorContext);
            return ((descriptiontext != null && descriptiontext.length() > 0) ? descriptiontext : "a postcondition that shows a warning instead of an error");
          }
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            ...
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Postcondition$Hy, LINKS.err$phDR), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            String originalText = super.getShortDescriptionText(pattern);
            EditorContext editorContext = ctx.getEditorContext();
            String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.Postcondition$Hy, LINKS.err$phDR), node, originalText, editorContext);
            return ((description != null && description.length() > 0) ? description : "add an error expression for the postcondition");
          }
        });
      }
      return result;
