...
public final class OptionType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> guaranteedToBeSome_id7jlPi2BQ7aR = new SMethodBuilder<>(Boolean.TYPE).name("guaranteedToBeSome").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8418869414670660279L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(guaranteedToBeSome_id7jlPi2BQ7aR, getPresentation_idhEwIMiw, wrappedType_id6bG6MAFRDvi, reWrap_id6bG6MAG4Mv3, isSameAs_idfIXgjlt4VE, createDefaultVarExpr_id60Qa1k_nI2O, canBeSorted_id7k6A8Wfp3IU);
