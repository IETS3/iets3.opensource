...
public final class AbstractMinMaxExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xcfaa4966b7d54b69L, 0xb66a309a6e1a7290L, 0x1de0d7a4e3414022L, "org.iets3.core.expr.base.structure.AbstractMinMaxExpression");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    String joinedVals = IterableUtils.join(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.values$W8VE)).select((it) -> (String) Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(it)), ", ");
    return SConceptOperations.conceptAlias(SNodeOperations.getConcept(__thisNode__)) + "(" + joinedVals + ")";
  }

  /*package*/ AbstractMinMaxExpression__BehaviorDescriptor() {
  }
