...
public final class IsSomeExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> invalidContextErrorMessage_id5ye9uPrghTl = new SMethodBuilder<>(String.class).name("invalidContextErrorMessage").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6381079423399042645L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  public static final SMethod<Boolean> isInDerefContext_id5ye9uPrikT6 = new SMethodBuilder<>(Boolean.TYPE).name("isInDerefContext").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6381079423399579206L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id4Y0vh0cfqjE, invalidContextErrorMessage_id5ye9uPrghTl, isInDerefContext_id5ye9uPrikT6, getAutomaticName_idcJpacq408C, effectDescriptor_id6GySMNjjWfO, allowsEffectForNode_idORfz$DS6Ap);
