...
public class ErrorExpression_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ErrorExpression_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ErrorExpression$aj, initContext);
  ...
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:9750d418-880f-460d-9880-d67dd111722d(org.iets3.core.expr.base.constraints)", "2605776245652472483");
