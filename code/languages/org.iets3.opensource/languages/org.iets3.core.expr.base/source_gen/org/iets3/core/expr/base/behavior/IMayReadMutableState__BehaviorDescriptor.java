...
public final class IMayReadMutableState__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> readsMutableState_id3ni3WidV6v8 = new SMethodBuilder<>(Boolean.TYPE).name("readsMutableState").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3878179565988505544L).languageId(0xb66a309a6e1a7290L, 0xcfaa4966b7d54b69L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(readsMutableState_id3ni3WidV6v8);
