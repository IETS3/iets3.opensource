...
public class MakeRefTarget_Constraints extends BaseConstraintsDescriptor {
  /*package*/ MakeRefTarget_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.MakeRefTarget$Fv, initContext);
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return (boolean) DotExpression__BehaviorDescriptor.expectType_id5WNmJ7DokMG.invoke(SNodeOperations.cast(parentNode, CONCEPTS.DotExpression$jp), CONCEPTS.IReferenceableType$st, ((boolean) true));
  }
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:9750d418-880f-460d-9880-d67dd111722d(org.iets3.core.expr.base.constraints)", "7782108600709141144");
