...
public final class MoreThanRS__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x8bb1251eeae547abL, 0x984333adfae8edaaL, 0x17752c05dc5cb1d1L, "org.iets3.core.expr.util.structure.MoreThanRS");
  ...
  /*package*/ static SNode createExpression_id1tPb0nsnb6P(@NotNull SNode __thisNode__, SNode subject) {
    return createGreaterExpression_7iekgt_a0a0(SNodeOperations.copyNode(subject), SNodeOperations.copyNode(SLinkOperations.getTarget(__thisNode__, LINKS.bound$dvCq)));
  }

  /*package*/ MoreThanRS__BehaviorDescriptor() {
  }
  ...
  private static SNode createGreaterExpression_7iekgt_a0a0(SNode p0, SNode p1) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.GreaterExpression$82);
