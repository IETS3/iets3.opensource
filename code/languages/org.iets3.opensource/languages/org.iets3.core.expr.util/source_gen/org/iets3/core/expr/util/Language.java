package org.iets3.core.expr.util;
...
import org.iets3.core.expr.util.actions.ActionAspectDescriptorImpl;
import jetbrains.mps.smodel.runtime.BehaviorAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConstraintsAspectDescriptor;
import jetbrains.mps.openapi.editor.descriptor.EditorAspectDescriptor;
import org.iets3.core.expr.util.editor.EditorAspectDescriptorImpl;
import jetbrains.mps.openapi.intentions.IntentionAspectDescriptor;
import org.iets3.core.expr.util.intentions.IntentionsDescriptor;
import jetbrains.mps.lang.migration.runtime.base.MigrationAspectDescriptor;
import org.iets3.core.expr.util.migration.MigrationDescriptor;
import jetbrains.mps.lang.typesystem.runtime.IHelginsDescriptor;
import org.iets3.core.expr.util.typesystem.TypesystemDescriptor;
import jetbrains.mps.smodel.runtime.StructureAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConceptPresentationAspect;
import org.iets3.core.expr.util.structure.ConceptPresentationAspectImpl;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("8bb1251e-eae5-47ab-9843-33adfae8edaa");
  }

  @Override
  public String getNamespace() {
    return "org.iets3.core.expr.util";
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == BehaviorAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.core.expr.util.behavior.BehaviorAspectDescriptor());
    }
    if (aspectClass == ConstraintsAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.core.expr.util.constraints.ConstraintsAspectDescriptor());
    }
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.core.expr.util.structure.StructureAspectDescriptor());
    }
