...
public final class ExceptRS__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> createExpression_id1tPb0nsnb6P = new SMethodBuilder<>(SNode.class).name("createExpression").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1690305638831010229L).languageId(0x984333adfae8edaaL, 0x8bb1251eeae547abL).build2(SMethodBuilder.createJavaParameter(SNode.class, "subject"));
