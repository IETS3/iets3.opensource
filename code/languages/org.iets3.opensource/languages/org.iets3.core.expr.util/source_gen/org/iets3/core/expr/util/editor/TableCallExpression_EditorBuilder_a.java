...
/*package*/ class TableCallExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new targetSingleRoleHandler_c3r1k4_a0a0(myNode, LINKS.target$SW0k, getEditorContext());
    return provider.createCell();
  }
  private static class targetSingleRoleHandler_c3r1k4_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public targetSingleRoleHandler_c3r1k4_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
