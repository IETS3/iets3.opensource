...
/*package*/ class DecTabExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new expressionsListHandler_v8lgg0_a0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_expressions");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class expressionsListHandler_v8lgg0_a0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public expressionsListHandler_v8lgg0_a0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(expressionsListHandler_v8lgg0_a0a.this.getNode(), LINKS.expressions$2RXU));
      try {
