...
public final class MoreOrEqualThanRS__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x8bb1251eeae547abL, 0x984333adfae8edaaL, 0x17752c05dc5cb1d2L, "org.iets3.core.expr.util.structure.MoreOrEqualThanRS");
  ...
  /*package*/ static SNode createExpression_id1tPb0nsnb6P(@NotNull SNode __thisNode__, SNode subject) {
    return createGreaterEqualsExpression_grc8s9_a0a0(SNodeOperations.copyNode(subject), SNodeOperations.copyNode(SLinkOperations.getTarget(__thisNode__, LINKS.bound$dvCq)));
  }

  /*package*/ MoreOrEqualThanRS__BehaviorDescriptor() {
  }
  ...
  private static SNode createGreaterEqualsExpression_grc8s9_a0a0(SNode p0, SNode p1) {
