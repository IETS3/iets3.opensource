...
public final class MultiDecTab__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> queryColDefs_id8XWEteuHOl = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("queryColDefs").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(161551962045340949L).languageId(0x984333adfae8edaaL, 0x8bb1251eeae547abL).build2();
  ...
  public static final SMethod<Iterable<SNode>> allContentsInCol_id38udS81rpZg = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allContentsInCol").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3611384982706954192L).languageId(0x984333adfae8edaaL, 0x8bb1251eeae547abL).build2(SMethodBuilder.createJavaParameter(SNode.class, "d"));
  public static final SMethod<Iterable<SNode>> allExpressionsInCol_id38udS81rDhO = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("allExpressionsInCol").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3611384982707016820L).languageId(0x984333adfae8edaaL, 0x8bb1251eeae547abL).build2(SMethodBuilder.createJavaParameter(SNode.class, "d"));
  ...
  public static final SMethod<SNode> findContent_id7dKu$V$1JsR = new SMethodBuilder<>(SNode.class).name("findContent").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8318282991005005623L).languageId(0x984333adfae8edaaL, 0x8bb1251eeae547abL).build2(SMethodBuilder.createJavaParameter(SNode.class, "col"), SMethodBuilder.createJavaParameter(Integer.TYPE, "row"));
  public static final SMethod<SNode> findContentExpression_id7dKu$V$1Jtl = new SMethodBuilder<>(SNode.class).name("findContentExpression").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8318282991005005653L).languageId(0x984333adfae8edaaL, 0x8bb1251eeae547abL).build2(SMethodBuilder.createJavaParameter(SNode.class, "col"), SMethodBuilder.createJavaParameter(Integer.TYPE, "row"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id4Y0vh0cfqjE, queryColDefs_id8XWEteuHOl, inputColDefs_id7FuUjk_dUMU, getUniquelyNamedElements_id4qSf1u1TRfj, createSolverTask_id4pkidg67Lgb, allowsEffectForNode_idORfz$DS6Ap, effectDescriptor_id6GySMNjjWfO, allContentsInCol_id38udS81rpZg, allExpressionsInCol_id38udS81rDhO, getMembers_id5r47dOfJ8UL, findContent_id7dKu$V$1JsR, findContentExpression_id7dKu$V$1Jtl);
