...
public class NewUnitLanguageMigrationHelper {
  ...
  public void initializeLibraryModels() {
    if (oldSIModel == null || newSIModel == null) {
      ...
      ListSequence.fromList(SModelOperations.nodes(oldSIModel, CONCEPTS.Unit$fR)).visitAll((final SNode oldUnit) -> {
        ...
        if (SPropertyOperations.getString(oldUnit, PROPS.name$MnvL).substring(0, 1).equalsIgnoreCase("\u00b5") || SPropertyOperations.getString(oldUnit, PROPS.name$MnvL).substring(0, 1).equalsIgnoreCase("\u03bc")) {
          prefix.value = "\u00b5";
        }
        ...
        MapSequence.fromMap(unitMap).put(SNodeOperations.getPointer(oldUnit), createUnitReference_gk4fhs_a0i0a0a11a0a32(newUnit, prefix.value));
      });
  ...
  private static SNode createUnitReference_gk4fhs_a0i0a0a11a0a32(SNode p0, String p1) {
