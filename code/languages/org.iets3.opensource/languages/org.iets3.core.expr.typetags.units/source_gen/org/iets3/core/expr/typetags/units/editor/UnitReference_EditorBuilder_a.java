...
/*package*/ class UnitReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.unit$3rM9;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.unit$3rM9);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.unit$3rM9);
    }
    deleteUnit.setCellActions(editorCell, myNode, getEditorContext());
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new UnitReference_unit_cellMenu_tapd9e_a0a0a(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class UnitReference_unit_cellMenu_tapd9e_a0a0a extends PrimaryReferentMenuCellMenuPart {
    public UnitReference_unit_cellMenu_tapd9e_a0a0a() {
    }
    @NotNull
    @Override
    protected IReferentPresentationProvider getMatchingTextProvider() {
      return PresentationProviders.PRESENTATION_tapd9e_a0a0a0;
    }
    @NotNull
    @Override
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_tapd9e_a1a");
    editorCell.addEditorCell(createRefNode_0());
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new exponentSingleRoleHandler_tapd9e_a0b0(myNode, LINKS.exponent$3sgb, getEditorContext());
    return provider.createCell();
  }
  private static class exponentSingleRoleHandler_tapd9e_a0b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public exponentSingleRoleHandler_tapd9e_a0b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.exponent$3sgb, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.exponent$3sgb, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.exponent$3sgb);
      }
      Style style = new StyleImpl();
      new UnitTagStyleClass(this).apply(style, editorCell);
      style.set(StyleAttributes.FONT_SIZE, _StyleParameter_QueryFunction_tapd9e_a0a0b0());
      editorCell.getStyle().putAll(style);
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.exponent$3sgb));
      try {
    ...
    private EditorCell createCollection_1() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_tapd9e_a0a1a");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
      return editorCell;
    }
    private int _StyleParameter_QueryFunction_tapd9e_a0a0b0() {
