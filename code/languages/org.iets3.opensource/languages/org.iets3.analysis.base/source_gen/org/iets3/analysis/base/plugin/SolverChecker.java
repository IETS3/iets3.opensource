...
public class SolverChecker extends BaseEditorChecker {
  ...
  public UpdateResult update(EditorComponent component, boolean b, boolean b1, Cancellable cancellable) {
    ...
    {
      Tuples._2<Long, Collection<MessageUI>> _tmp_e3btoh_g0g = AsyncSolverTaskExecutor.nodesMessages(castedNode);
      changeCount = _tmp_e3btoh_g0g._0();
      messages = _tmp_e3btoh_g0g._1();
    }
