...
public final class ErrorSolverTask__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    ...
    text.append("Errors during task creation:");
    text.appendVertically(SLinkOperations.getChildren(__thisNode__, LINKS.errors$rx2e));
    return text.toString();
  }
  /*package*/ static IResult run_id7rOSrvnGeUQ(@NotNull SNode __thisNode__) {
    return new ErrorResult(ErrorSolverTask__BehaviorDescriptor.allErrorsAsString_idXhdFKw2OsE.invoke(__thisNode__));
  }
  ...
  /*package*/ static String getWarning_id7rOSrvnH60y(@NotNull SNode __thisNode__) {
    return "failed with errors: " + ErrorSolverTask__BehaviorDescriptor.allErrorsAsString_idXhdFKw2OsE.invoke(__thisNode__);
  }
  /*package*/ static void setCreationTime_id4u26ju1JEr$(@NotNull SNode __thisNode__, long t) {
  }
  /*package*/ static String allErrorsAsString_idXhdFKw2OsE(@NotNull SNode __thisNode__) {
    return ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.errors$rx2e)).select((it) -> SPropertyOperations.getString(it, PROPS.msg$2JDK)) + "";
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 4:
        ...
        return null;
      case 5:
        return (T) ((String) allErrorsAsString_idXhdFKw2OsE(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
