...
<model ref="r:869bd722-28a7-4801-b74a-5fa5040db1ec(org.iets3.core.expr.typetags.physunits.listeners)">
  ...
  <node concept="jA7cl" id="28ZCOKUtn1o">
    <ref role="1M2myG" to="i3ya:7eOyx9r3k4t" resolve="UnitSpecification" />
    <node concept="j_NIE" id="28ZCOKUtn1p" role="j$A37">
      <ref role="j_u2Y" to="i3ya:7eOyx9r3qG3" resolve="expr" />
      <node concept="3clFbS" id="28ZCOKUtn1q" role="2VODD2">
        <node concept="3clFbF" id="28ZCOKUtn1Y" role="3cqZAp">
          <node concept="2OqwBi" id="28ZCOKUtneI" role="3clFbG">
            <node concept="j_vvf" id="28ZCOKUtn1X" role="2Oq$k0" />
            <node concept="3YRAZt" id="28ZCOKUtnty" role="2OqNvi" />
          </node>
        </node>
      </node>
    </node>
