...
/*package*/ class QuantityExponent_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new baseSingleRoleHandler_9lzlh5_a0b0a0(myNode, LINKS.base$4f1J, getEditorContext());
    return provider.createCell();
  }
  private static class baseSingleRoleHandler_9lzlh5_a0b0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public baseSingleRoleHandler_9lzlh5_a0b0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
