...
public class check_PowExpressionUnits_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode powerExpression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (UnitConversionUtil.hasSpecification(TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(powerExpression, LINKS.expr$CW3E)))) {
      ...
      if (!(SNodeOperations.isInstanceOf(exponentType, CONCEPTS.NumberType$n) && MathExpressionsOpRulesHelper.rangeIsValue(SNodeOperations.cast(exponentType, CONCEPTS.NumberType$n)) && MathExpressionsOpRulesHelper.isIntValue((long) NumberType__BehaviorDescriptor.intRange_id3p6$WoEzHkL.invoke(SNodeOperations.cast(exponentType, CONCEPTS.NumberType$n))._0()))) {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(SLinkOperations.getTarget(powerExpression, LINKS.exponent$uVP8), "units can only be used if the exponent is a number type in the range of int", "r:d4f1532d-fc5c-419f-84ee-daef42867c8e(org.iets3.core.expr.typetags.physunits.typesystem)", "7396263120840438290", null, errorTarget);
      }
