...
public final class DimensionExponent__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7ee265bd59864709L, 0x86ed2c6daa33cd8cL, 0x4dee5a62d2096abaL, "org.iets3.core.expr.typetags.physunits.structure.DimensionExponent");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getExp_id1JynhuWslGU, setExp_id1JynhuWsqnp, getBase_id1JynhuWs9Jp);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static Fraction getExp_id1JynhuWslGU(@NotNull SNode __thisNode__) {
    return new Fraction((int) Exponent__BehaviorDescriptor.getNumerator_id3j3yk3guAC3.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.exponent$xLNL)), (int) Exponent__BehaviorDescriptor.getDenominator_id3j3yk3guABz.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.exponent$xLNL)));
  }
  /*package*/ static void setExp_id1JynhuWsqnp(@NotNull SNode __thisNode__, Fraction exp) {
    if (exp.denominator != 1) {
      SLinkOperations.setTarget(__thisNode__, LINKS.exponent$xLNL, createFractionalExponent_oh7nou_a0a0a0b(String.valueOf(exp.numerator), String.valueOf(exp.denominator)));
    } else {
      SLinkOperations.setTarget(__thisNode__, LINKS.exponent$xLNL, createIntegerExponent_oh7nou_a0a0a0a1(exp.numerator));
    }
  }
  /*package*/ static SNode getBase_id1JynhuWs9Jp(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.base$xM2M);
  }

  /*package*/ DimensionExponent__BehaviorDescriptor() {
  }
  ...
  private static SNode createFractionalExponent_oh7nou_a0a0a0b(String p0, String p1) {
  ...
  private static SNode createIntegerExponent_oh7nou_a0a0a0a1(int p0) {
