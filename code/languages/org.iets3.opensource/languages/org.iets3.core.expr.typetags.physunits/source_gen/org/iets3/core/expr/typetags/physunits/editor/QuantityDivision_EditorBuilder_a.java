...
/*package*/ class QuantityDivision_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public QuantityDivision_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createMathBase_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("MathBase_y9a4yi_a");
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          {
            ...
            SNode child = SLinkOperations.getTarget(node, LINKS.numerator$clxk);
            SAbstractConcept childConcept = SNodeOperations.getConcept(child);
            if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.QuantityExpression$D7))) {
              SNodeFactoryOperations.setNewChild(node, LINKS.numerator$clxk, null);
              return;
            }
          }

          SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.denominator$F8jm));
        ...
        public boolean canExecute_inReadAction(EditorContext editorContext) {
          ...
          SNode replacement = SLinkOperations.getTarget(node, LINKS.denominator$F8jm);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new numeratorSingleRoleHandler_y9a4yi_a0a0a0(myNode, LINKS.numerator$clxk, getEditorContext());
    return provider.createCell();
  }
  private static class numeratorSingleRoleHandler_y9a4yi_a0a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public numeratorSingleRoleHandler_y9a4yi_a0a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.numerator$clxk, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.numerator$clxk, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.numerator$clxk);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.numerator$clxk));
      try {
    ...
    EditorCell editorCell = ((_FunctionTypes._return_P0_E0<EditorCell>) () -> {
      cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
        public void execute(EditorContext editorContext) {
          {
            // replace with placeholder
            SNode child = SLinkOperations.getTarget(node, LINKS.denominator$F8jm);
            SAbstractConcept childConcept = SNodeOperations.getConcept(child);
            if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.QuantityExpression$D7))) {
              SNodeFactoryOperations.setNewChild(node, LINKS.denominator$F8jm, null);
              return;
            }
          }

          SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.numerator$clxk));
          boolean caretLeft = false;
          if (caretLeft) {
            SelectionUtil.selectLabelCellAnSetCaret(editorContext, unwrapped, SelectionManager.FIRST_CELL, 0);
          } else {
        ...
        public boolean canExecute_inReadAction(EditorContext editorContext) {
          ...
          SNode replacement = SLinkOperations.getTarget(node, LINKS.numerator$clxk);
          SContainmentLink containmentLink = node.getContainmentLink();
          if (containmentLink == null) {
            return true;
          }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new denominatorSingleRoleHandler_y9a4yi_a0a0b0(myNode, LINKS.denominator$F8jm, getEditorContext());
    return provider.createCell();
  }
  private static class denominatorSingleRoleHandler_y9a4yi_a0a0b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public denominatorSingleRoleHandler_y9a4yi_a0a0b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.denominator$F8jm, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.denominator$F8jm, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.denominator$F8jm);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.denominator$F8jm));
      try {
        EditorCell editorCell = super.createEmptyCell();
