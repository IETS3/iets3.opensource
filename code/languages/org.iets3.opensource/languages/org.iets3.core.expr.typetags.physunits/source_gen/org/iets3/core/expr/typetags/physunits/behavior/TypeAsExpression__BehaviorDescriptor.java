...
public final class TypeAsExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7ee265bd59864709L, 0x86ed2c6daa33cd8cL, 0x6e5865d462644237L, "org.iets3.core.expr.typetags.physunits.structure.TypeAsExpression");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return "'" + SNodeOperations.present(SLinkOperations.getTarget(__thisNode__, LINKS.wrappedType$MbSk)) + "'";
  }

  /*package*/ TypeAsExpression__BehaviorDescriptor() {
  }
