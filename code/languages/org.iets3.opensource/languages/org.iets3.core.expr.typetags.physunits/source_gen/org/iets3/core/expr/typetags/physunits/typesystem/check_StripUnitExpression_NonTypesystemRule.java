...
public class check_StripUnitExpression_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode expression, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SNodeOperations.isInstanceOf(type, CONCEPTS.TaggedType$O4)) {
      ...
      if (tagMap.containsKey(CONCEPTS.UnitSpecification$6j)) {
        invalid = false;
      }
    }
    ...
    if (invalid) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(expression, "there is no unit to strip", "r:d4f1532d-fc5c-419f-84ee-daef42867c8e(org.iets3.core.expr.typetags.physunits.typesystem)", "6866407013262391936", null, errorTarget);
      }
    }
  }
