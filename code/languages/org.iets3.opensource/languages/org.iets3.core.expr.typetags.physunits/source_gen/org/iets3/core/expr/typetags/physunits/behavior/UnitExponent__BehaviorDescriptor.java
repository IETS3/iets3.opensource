...
public final class UnitExponent__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7ee265bd59864709L, 0x86ed2c6daa33cd8cL, 0x74818abc54714f3eL, "org.iets3.core.expr.typetags.physunits.structure.UnitExponent");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getExp_id1JynhuWslGU, setExp_id1JynhuWsqnp, getBase_id1JynhuWs9Jp, getReducedExpr_id7Mca05npOsl);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static Fraction getExp_id1JynhuWslGU(@NotNull SNode __thisNode__) {
    return new Fraction((int) Exponent__BehaviorDescriptor.getNumerator_id3j3yk3guAC3.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.exponent$z83d)), (int) Exponent__BehaviorDescriptor.getDenominator_id3j3yk3guABz.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.exponent$z83d)));
  }
  /*package*/ static void setExp_id1JynhuWsqnp(@NotNull SNode __thisNode__, Fraction exp) {
    if (exp.denominator != 1) {
      SLinkOperations.setTarget(__thisNode__, LINKS.exponent$z83d, createFractionalExponent_fnq3q7_a0a0a0b(String.valueOf(exp.numerator), String.valueOf(exp.denominator)));
    } else {
      SLinkOperations.setTarget(__thisNode__, LINKS.exponent$z83d, createIntegerExponent_fnq3q7_a0a0a0a1(exp.numerator));
    }
  }
  /*package*/ static SNode getBase_id1JynhuWs9Jp(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.base$z8ie);
  }
  /*package*/ static SNode getReducedExpr_id7Mca05npOsl(@NotNull SNode __thisNode__) {
    return createUnitExponent_fnq3q7_a0a3(UnitExpression__BehaviorDescriptor.getReducedExpr_id7Mca05npOsl.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.base$z8ie)), SNodeOperations.copyNode(SLinkOperations.getTarget(__thisNode__, LINKS.exponent$z83d)));
  }

  /*package*/ UnitExponent__BehaviorDescriptor() {
  }
  ...
  private static SNode createFractionalExponent_fnq3q7_a0a0a0b(String p0, String p1) {
  ...
  private static SNode createIntegerExponent_fnq3q7_a0a0a0a1(int p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.IntegerExponent$a2);
    n0.setProperty(PROPS.value$NUak, "" + (p0));
    return n0.getResult();
  }
  private static SNode createUnitExponent_fnq3q7_a0a3(SNode p0, SNode p1) {
