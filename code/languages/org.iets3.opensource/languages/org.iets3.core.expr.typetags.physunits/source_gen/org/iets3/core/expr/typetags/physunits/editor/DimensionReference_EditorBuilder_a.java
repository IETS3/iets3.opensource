...
/*package*/ class DimensionReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_7tbc4z_a0();
  ...
  private boolean nodeCondition_7tbc4z_a0() {
    return (SLinkOperations.getTarget(myNode, LINKS.dimension$YEak) != null);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.dimension$YEak;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.dimension$YEak);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.dimension$YEak);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_7tbc4z_a0");
