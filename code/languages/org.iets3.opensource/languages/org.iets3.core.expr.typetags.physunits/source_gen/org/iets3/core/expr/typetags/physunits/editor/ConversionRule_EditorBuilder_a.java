...
/*package*/ class ConversionRule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_1() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_oskuq5_a0b0a0();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_oskuq5_a0b0a0() {
  ...
  private EditorCell createSideTransformationSectionCell_1() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_oskuq5_a0b0a0");
    return editorCell;
  }
