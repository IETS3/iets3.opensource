...
public class UnitCombinators {
  ...
  public static SNode combine(SNode left, SNode right, SNode operation) {
    UnitMap leftSpec = UnitConversionUtil.getMapForGroup(IUnitSpecification__BehaviorDescriptor.getExpression_id6q45UTytEvW.invoke(SNodeOperations.as(left, CONCEPTS.IUnitSpecification$yp)));
    UnitMap rightSpec = UnitConversionUtil.getMapForGroup(IUnitSpecification__BehaviorDescriptor.getExpression_id6q45UTytEvW.invoke(SNodeOperations.as(right, CONCEPTS.IUnitSpecification$yp)));
    ...
    if (SNodeOperations.isInstanceOf(operation, CONCEPTS.PlusExpression$mx) || SNodeOperations.isInstanceOf(operation, CONCEPTS.MinusExpression$6z) || SNodeOperations.isInstanceOf(operation, CONCEPTS.BinaryComparisonExpression$7z)) {
      Tuples._3<Boolean, List<SNode>, List<SNode>> matchingUnits = UnitMap.computeMatch(leftSpec, rightSpec);
      if ((boolean) matchingUnits._0()) {
        ...
        if (ListSequence.fromList(unmatchedUnitsMessages).isNotEmpty()) {
          return createErrorTag_fjxz21_a0a7a0b0d0b(IterableUtils.join(ListSequence.fromList(unmatchedUnitsMessages), "\n"));
        }
      }
    }
    ...
    if (SNodeOperations.isInstanceOf(operation, CONCEPTS.MulExpression$iC)) {
      ...
      return UnitConversionUtil.createUnitSpec(unified);
    }
  ...
  private static SNode createErrorTag_fjxz21_a0a7a0b0d0b(String p0) {
