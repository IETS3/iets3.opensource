...
public class UnitConversionUtil {
    ...
    SNode sourceSpecification = UnitConversionUtil.getSpecification(sourceType);
    {
      ...
      if (SNodeOperations.isInstanceOf(sourceExpression, CONCEPTS.UnitReference$Zo)) {
        ...
        if ((boolean) UnitConversionUtil.matchingMappings(sourceUnitMapCopy, targetUnitMapCopy)._0()) {
          ...
          SNode powerExpr = _quotation_createNode_5ohk72_a0j0g0i0lc(createNumberLiteral_5ohk72_a0a0a0a9a6a8a36(String.valueOf(sourceFactor) + ".0"), createNumberLiteral_5ohk72_a0a0a0a9a6a8a36_0(String.valueOf(targetFactor) + ".0"), createNumberLiteral_5ohk72_a0a0a0j0g0i0lc(String.valueOf(GlobalUnitPrefixManager.getManager(SLinkOperations.getTarget(sourceExpression, LINKS.unit$nTeG), SLinkOperations.getTarget(targetUnitReference, LINKS.unit$nTeG)).getBase())));
          return createConversionSpecifier_5ohk72_a01a6a8a36(powerExpr);
        }
      }
    }
    return null;
  ...
  private static SNode _quotation_createNode_5ohk72_a0j0g0i0lc(Object parameter_1, Object parameter_2, Object parameter_3) {
  ...
  private static SNode createNumberLiteral_5ohk72_a0a0a0a9a6a8a36(String p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.NumberLiteral$wE);
    n0.setProperty(PROPS.value$iWTK, p0);
    return n0.getResult();
  }
  private static SNode createNumberLiteral_5ohk72_a0a0a0a9a6a8a36_0(String p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.NumberLiteral$wE);
    n0.setProperty(PROPS.value$iWTK, p0);
    return n0.getResult();
  }
  private static SNode createNumberLiteral_5ohk72_a0a0a0j0g0i0lc(String p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.NumberLiteral$wE);
    n0.setProperty(PROPS.value$iWTK, p0);
    return n0.getResult();
  }
  private static SNode createConversionSpecifier_5ohk72_a01a6a8a36(SNode p0) {
