...
public class AbstractLiteral_AddUnit extends TransformationMenuBase {
  public AbstractLiteral_AddUnit() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "PrimitiveLiteral", new SNodePointer("r:92b6235a-90ab-4d1e-908d-c04e8b6357fd(org.iets3.core.expr.typetags.physunits.editor)", "3691316882320236799")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
