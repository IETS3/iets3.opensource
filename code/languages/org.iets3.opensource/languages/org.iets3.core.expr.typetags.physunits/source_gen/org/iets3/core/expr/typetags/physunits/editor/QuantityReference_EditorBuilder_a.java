...
import org.iets3.core.expr.typetags.physunits.editor.Units_StyleSheet_StyleSheet.QuantityTagStyleClass;
...
/*package*/ class QuantityReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_w9n8iu_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.quantity$A_Kl;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.quantity$A_Kl);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.quantity$A_Kl);
    }
    Style style = new StyleImpl();
    new QuantityTagStyleClass(this).apply(style, editorCell);
