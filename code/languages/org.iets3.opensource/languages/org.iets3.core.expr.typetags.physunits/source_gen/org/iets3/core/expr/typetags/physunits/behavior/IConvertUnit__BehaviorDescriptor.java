...
public final class IConvertUnit__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getExpression_id7SygLIkQnGn = new SMethodBuilder<>(SNode.class).name("getExpression").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9088900783727541015L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2();
  public static final SMethod<SNode> getTargetUnit_id7SygLIkQpOA = new SMethodBuilder<>(SNode.class).name("getTargetUnit").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9088900783727549734L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2();
  public static final SMethod<SNode> getTargetUnitReference_id1BdB9zGarhv = new SMethodBuilder<>(SNode.class).name("getTargetUnitReference").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1859314401785001055L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2();
  ...
  public static final SMethod<SNode> getConversionSpecifier_id7SygLIkR36w = new SMethodBuilder<>(SNode.class).name("getConversionSpecifier").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9088900783727718816L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2();
  public static final SMethod<SNode> getContext_id7NHcideTk7h = new SMethodBuilder<>(SNode.class).name("getContext").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9001905257900753361L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2();
  public static final SMethod<Void> setFallbackVisibleElementProvider_idTizm$fGBF2 = new SMethodBuilder<>(Void.TYPE).name("setFallbackVisibleElementProvider").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1032042746995702466L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2(SMethodBuilder.createJavaParameter(SNode.class, "fallback"));
  public static final SMethod<List<SNode>> getApplicableConversionSpecifiers_id3_TFq$0_vSx = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getApplicableConversionSpecifiers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4141532273714789921L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2(SMethodBuilder.createJavaParameter(SNode.class, "scope"));
  public static final SMethod<SNode> getImplicitConversionSpecifier_id2x0M_l2hX_w = new SMethodBuilder<>(SNode.class).name("getImplicitConversionSpecifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2900540627559635296L).languageId(0x86ed2c6daa33cd8cL, 0x7ee265bd59864709L).build2(SMethodBuilder.createJavaParameter(SNode.class, "scope"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getExpression_id7SygLIkQnGn, getTargetUnit_id7SygLIkQpOA, getTargetUnitReference_id1BdB9zGarhv, setConversionSpecifier_id7SygLIkQzuc, getConversionSpecifier_id7SygLIkR36w, getContext_id7NHcideTk7h, setFallbackVisibleElementProvider_idTizm$fGBF2, getApplicableConversionSpecifiers_id3_TFq$0_vSx, getImplicitConversionSpecifier_id2x0M_l2hX_w);


  /*package*/ static SNode getContext_id7NHcideTk7h(@NotNull SNode __thisNode__) {
    SNode vep = SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.IVisibleElementProvider$$O, false, false);
    if ((vep != null)) {
      return vep;
    }

    Object obj = __thisNode__.getUserObject("FALLBACK_VEP");
    if (obj != null && obj instanceof SNode) {
      SNode fallback = (SNode) obj;
      return SNodeOperations.as(fallback, CONCEPTS.IVisibleElementProvider$$O);
    }
    return null;
  }
  /*package*/ static void setFallbackVisibleElementProvider_idTizm$fGBF2(@NotNull SNode __thisNode__, SNode fallback) {
    __thisNode__.putUserObject("FALLBACK_VEP", fallback);
  }
  /*package*/ static List<SNode> getApplicableConversionSpecifiers_id3_TFq$0_vSx(@NotNull SNode __thisNode__, SNode scope) {
    ...
    if (expression != null && IConvertUnit__BehaviorDescriptor.getTargetUnit_id7SygLIkQpOA.invoke(__thisNode__) != null) {
      SNode sourceType = TypeHelper.computeType(expression);
  ...
  /*package*/ static SNode getImplicitConversionSpecifier_id2x0M_l2hX_w(@NotNull SNode __thisNode__, SNode scope) {
    ...
    List<SNode> allApplicableConversionSpecifiers = IConvertUnit__BehaviorDescriptor.getApplicableConversionSpecifiers_id3_TFq$0_vSx.invoke(__thisNode__, scope);
    List<SNode> implicitMarkedSpecifiers = ListSequence.fromList(allApplicableConversionSpecifiers).where((it) -> SNodeOperations.getModel(it) != null && (int) ConversionRule__BehaviorDescriptor.getPriority_id3wrpJuqIhSQ.invoke(ConversionSpecifier__BehaviorDescriptor.getConversionRule_id1wGuEUvYk55.invoke(it)) > -1).toList();
    if (ListSequence.fromList(implicitMarkedSpecifiers).isNotEmpty()) {
      ...
      return ListSequence.fromList(allApplicableConversionSpecifiers).findFirst((it) -> SNodeOperations.getModel(it) == null);
    }
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 6:
        setFallbackVisibleElementProvider_idTizm$fGBF2(node, (SNode) parameters[0]);
        return null;
      case 7:
