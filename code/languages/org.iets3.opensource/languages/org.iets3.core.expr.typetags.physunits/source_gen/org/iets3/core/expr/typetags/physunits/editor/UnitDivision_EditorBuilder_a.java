...
/*package*/ class UnitDivision_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new numeratorSingleRoleHandler_radaq5_a0a0a0(myNode, LINKS.numerator$qo9G, getEditorContext());
    return provider.createCell();
  }
  private static class numeratorSingleRoleHandler_radaq5_a0a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public numeratorSingleRoleHandler_radaq5_a0a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new denominatorSingleRoleHandler_radaq5_a0a0b0(myNode, LINKS.denominator$4xz7, getEditorContext());
    return provider.createCell();
  }
  private static class denominatorSingleRoleHandler_radaq5_a0a0b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public denominatorSingleRoleHandler_radaq5_a0a0b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
