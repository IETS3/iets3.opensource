...
public class ExprPhysUnitInterpreter_extension extends Extension.Default<IInterpreter> {
  public ExprPhysUnitInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterExprPhysUnitInterpreter();
  }
}
