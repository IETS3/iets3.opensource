...
public final class LambdaExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> visibleLambdaArgs_idTUBgQ0R0F5 = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("visibleLambdaArgs").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1043318945011731141L).languageId(0x927464ab29588457L, 0x9464fa065ab9409bL).build2();
  ...
  public static final SMethod<Map<SNode, SNode>> getNodeMapping_id3u8VfJfplfS = new SMethodBuilder<>((Class<Map<SNode, SNode>>) ((Class) Object.class)).name("getNodeMapping").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4001708835179156472L).languageId(0x927464ab29588457L, 0x9464fa065ab9409bL).build2();
  public static final SMethod<Void> putNodeMapping_id1ZCJf$ej28Z = new SMethodBuilder<>(Void.TYPE).name("putNodeMapping").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2299295387645387327L).languageId(0x927464ab29588457L, 0x9464fa065ab9409bL).build2(SMethodBuilder.createJavaParameter((Class<Map<SNode, SNode>>) ((Class) Object.class), "map"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id4Y0vh0cfqjE, getUniquelyNamedElements_id4qSf1u1TRfj, visibleLambdaArgs_idTUBgQ0R0F5, getChildrenForCoverage_id5IKJrJHNCE8, delayedEffectDescriptor_id6NpHfQ5A3Wb, allowsEffectForNode_idORfz$DS6Ap, getNodeMapping_id3u8VfJfplfS, putNodeMapping_id1ZCJf$ej28Z);
