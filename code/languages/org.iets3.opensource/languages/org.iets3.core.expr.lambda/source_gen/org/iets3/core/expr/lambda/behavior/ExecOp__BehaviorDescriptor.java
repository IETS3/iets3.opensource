...
public final class ExecOp__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9464fa065ab9409bL, 0x927464ab29588457L, 0x68d69d36ba557186L, "org.iets3.core.expr.lambda.structure.ExecOp");
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return "exec" + ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.args$vwEf)).select((it) -> (String) Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(it));
  }
  /*package*/ static EffectDescriptor effectDescriptor_id6GySMNjjWfO(@NotNull SNode __thisNode__) {
    return (EffectDescriptor) FunctionType__BehaviorDescriptor.effectDescriptor_id6GySMNjYLtT.invoke(SNodeOperations.cast(TypecheckingFacade.getFromContext().getTypeOf(SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), CONCEPTS.DotExpression$jp), LINKS.expr$CW3E)), CONCEPTS.FunctionType$RQ));
  }

  /*package*/ ExecOp__BehaviorDescriptor() {
  }
