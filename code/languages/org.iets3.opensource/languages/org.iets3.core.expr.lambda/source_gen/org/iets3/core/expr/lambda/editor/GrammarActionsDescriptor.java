...
public class GrammarActionsDescriptor extends AbstractGrammarActionDescriptor implements IGrammarActionsDescriptor {
  ...
  public List<SubstituteMenuItem> getActions(final SubstituteMenuContext _context, final SAbstractConcept expectedOutputConceptExactly) {
    ...
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("org.iets3.core.expr.lambda.editor.GrammarActionsDescriptor.getActions", null));
    try {
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          ...
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "LambdaArg", new SNodePointer("r:2261c766-d7b6-49d7-91bd-1207e471af0b(org.iets3.core.expr.lambda.editor)", "4888247757401913766")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.LambdaArg$9W)) {
              ...
              for (SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.LambdaArg$9W, _context.getModel(), LambdaArg_Editor.class, _context.getEditorContext()))) {
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept))) {
                  ...
                  isApplicable &= new Object() {
                    public boolean query(SAbstractConcept expectedConcept) {
                      return EditorCustomizationConfigHelper.getConfig().isWrapperCellSubstitutionActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.LambdaArg$9W, PROPS.name$MnvL), expectedConcept, null, null);
                    }
                  ...
                  if (isApplicable) {
                    ListSequence.fromList(result).addElement(new GrammarCellsSubstituteMenuItem(_context) {
                      ...
                      public String getDescriptionText(@NotNull String pattern) {
                        ...
                        String descriptiontext = EditorCustomizationConfigHelper.getConfig().getWrapperCellSubstitutionDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.LambdaArg$9W, PROPS.name$MnvL), wrappedNode, wrappedConcept, subconcept, originalText, editorContext);
                        return ((descriptiontext != null && descriptiontext.length() > 0) ? descriptiontext : "a lambda argument with name");
                      }
                      @Override
                      ...
                      public SNode createNode(@NotNull String pattern) {
                        ...
                        new Object() {
                          public void postProcess(SNode node, EditorContext editorContext, SNode parentNode) {
                            EditorCustomizationConfigHelper.getConfig().wrapperCellSubstitutionPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.LambdaArg$9W, PROPS.name$MnvL), node, editorContext);
                          }
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "FunctionArgument", new SNodePointer("r:2261c766-d7b6-49d7-91bd-1207e471af0b(org.iets3.core.expr.lambda.editor)", "7740953487931608082")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.FunctionArgument$JZ)) {
              final SAbstractConcept expectedOutputConcept = GrammarCellsUtil.getExpectedOutputConcept(_context, expectedOutputConceptExactly);

              for (SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.FunctionArgument$JZ, _context.getModel(), FunctionArgument_Editor.class, _context.getEditorContext()))) {
                final SConcept outputConcept = ((SConcept) subconcept);
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept))) {
                  ...
                  isApplicable &= new Object() {
                    public boolean query(SAbstractConcept expectedConcept) {
                      return EditorCustomizationConfigHelper.getConfig().isWrapperCellSubstitutionActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionArgument$JZ, PROPS.name$MnvL), expectedConcept, null, null);
                    }
                  }.query(expectedOutputConcept);
                  if (isApplicable) {
                    ListSequence.fromList(result).addElement(new GrammarCellsSubstituteMenuItem(_context) {
                      ...
                      public String getDescriptionText(@NotNull String pattern) {
                        ...
                        SAbstractConcept wrappedConcept = getOutputConcept();
                        EditorContext editorContext = _context.getEditorContext();
                        String descriptiontext = EditorCustomizationConfigHelper.getConfig().getWrapperCellSubstitutionDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionArgument$JZ, PROPS.name$MnvL), wrappedNode, wrappedConcept, subconcept, originalText, editorContext);
                        return ((descriptiontext != null && descriptiontext.length() > 0) ? descriptiontext : "a function argument with name");
                      }
                      @Override
                      public boolean canExecute(@NotNull String pattern) {
                        if ((pattern == null || pattern.length() == 0)) {
                      ...
                      public SNode createNode(@NotNull String pattern) {
                        ...
                        new Object() {
                          public void postProcess(SNode node, EditorContext editorContext, SNode parentNode) {
                            EditorCustomizationConfigHelper.getConfig().wrapperCellSubstitutionPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionArgument$JZ, PROPS.name$MnvL), node, editorContext);
                          }
                        }.postProcess(newNode, _context.getEditorContext(), _context.getParentNode());
                        return newNode;
                      }
      ...
      ListSequence.fromList(result).addSequence(Sequence.fromIterable(new Object() {
        public Iterable<SubstituteMenuItem> query() {
          List<SubstituteMenuItem> result = ListSequence.fromList(new ArrayList<SubstituteMenuItem>());
          _context.getEditorMenuTrace().pushTraceInfo();
          _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("grammar.wrap in " + "FunctionStyleExecOp", new SNodePointer("r:2261c766-d7b6-49d7-91bd-1207e471af0b(org.iets3.core.expr.lambda.editor)", "6100571306011111556")));
          try {
            if (SConceptOperations.isExactly(SNodeOperations.asSConcept(expectedOutputConceptExactly), CONCEPTS.FunctionStyleExecOp$MU)) {
              final SAbstractConcept wrappedConcept = CONCEPTS.Expression$D_;
              for (final SConcept subconcept : ListSequence.fromList(GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.FunctionStyleExecOp$MU, _context.getModel(), FunctionStyleExecOp_Editor.class, _context.getEditorContext()))) {
                final SConcept outputConcept = ((SConcept) subconcept);
                ...
                if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(outputConcept), SNodeOperations.asSConcept(expectedOutputConcept)) && wrapRequired) {
                  ...
                  final SContainmentLink aggregation = LINKS.fun$JJ25;
                  ...
                  if (isApplicable) {
                    ...
                    List<SubstituteMenuItem> actions = _context.withLink(LINKS.fun$JJ25).createItems(new DefaultSubstituteMenuLookup(LanguageRegistry.getInstance(_context.getEditorContext().getRepository()), wrappedConcept));
                    ...
                    List<SubstituteMenuItem> wrappedActions = ListSequence.fromList(actions).where(new _FunctionTypes._return_P1_E0<Boolean, SubstituteMenuItem>() {
                      public Boolean invoke(SubstituteMenuItem it) {
                        ...
                        isApplicable &= new Object() {
                          public boolean query(SAbstractConcept expectedConcept) {
                            return EditorCustomizationConfigHelper.getConfig().isWrapperCellSubstitutionActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionStyleExecOp$MU, LINKS.fun$JJ25), expectedConcept, wrappedConcept, editorContext);
                          }
                        }.query(expectedOutputConcept);
                        return isApplicable;
                      }
                    ...
                    wrappedActions = ListSequence.fromList(wrappedActions).select((final SubstituteMenuItem it) -> {
                      ...
                      SubstituteMenuItem wrapper = new SubstituteMenuItemWrapper(it) {
                        ...
                        public SNode createNode(@NotNull String pattern) {
                          ...
                          SLinkOperations.setTarget(wrapper, LINKS.fun$JJ25, SNodeOperations.cast(nodeToWrap, CONCEPTS.Expression$D_));
                          ...
                          new Object() {
                            public void postprocess(SNode node, EditorContext editorContext, SNode parentNode) {
                              EditorCustomizationConfigHelper.getConfig().wrapperCellSubstitutionPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionStyleExecOp$MU, LINKS.fun$JJ25), node, editorContext);
                            }
                        ...
                        public String getDescriptionText(@NotNull final String pattern) {
                          ...
                          EditorContext editorContext = _context.getEditorContext();
                          String descriptiontext = EditorCustomizationConfigHelper.getConfig().getWrapperCellSubstitutionDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionStyleExecOp$MU, LINKS.fun$JJ25), wrappedNode, wrappedConcept, subconcept, originalText, editorContext);
  ...
  protected List<TransformationMenuItem> doGetSideTransformActions(final TransformationMenuContext _context) {
    ...
    _context.getEditorMenuTrace().pushTraceInfo();
    _context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("org.iets3.core.expr.lambda.editor.GrammarActionsDescriptor.doGetSideTransformActions", null));
    try {
      {
              ...
              try {
                if (_context.getMenuLocation() == MenuLocations.RIGHT_SIDE_TRANSFORM) {
                  ...
                  if (sourceNode != null) {
                    ...
                    for (final SAbstractConcept subconcept : GrammarCellsUtil.getVisibleSubconceptsNonAbstract(CONCEPTS.FunctionStyleExecOp$MU, _context.getModel(), FunctionStyleExecOp_Editor.class, _context.getEditorContext())) {
                        ...
                        if (Sequence.fromIterable(matchingText).isNotEmpty()) {
                          ...
                          sideTransformationEnabled &= new Object() {
                            public boolean enabled(SNode wrappedNode) {
                              boolean condition = EditorCustomizationConfigHelper.getConfig().isWrapperCellSideTransformationActivated(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionStyleExecOp$MU, LINKS.fun$JJ25), wrappedNode, subconcept, editorContext);
                              return condition && SNodeOperations.isInstanceOf(TypecheckingFacade.getFromContext().getTypeOf(wrappedNode), CONCEPTS.FunctionType$RQ);
                            }
                          ...
                          if (sideTransformationEnabled) {
                            ListSequence.fromList(result).addSequence(Sequence.fromIterable(new MultiTextActionItem(matchingText, _context) {
                              ...
                              protected SNode doSubstitute(@Nullable EditorContext editorContext, String pattern) {
                                ...
                                SNode wrapper = SNodeOperations.cast(SNodeFactoryOperations.createNewNode(subconcept, null), CONCEPTS.FunctionStyleExecOp$MU);
                                SNodeOperations.replaceWithAnother(sourceNode, wrapper);
                                SLinkOperations.setTarget(wrapper, LINKS.fun$JJ25, SNodeOperations.cast(sourceNode, CONCEPTS.Expression$D_));

                                new Object() {
                                  public void postprocess(SNode node) {
                                    EditorCustomizationConfigHelper.getConfig().wrapperCellSideTransformationPostProcess(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.FunctionStyleExecOp$MU, LINKS.fun$JJ25), node, editorContext);
                                  }
                                }.postprocess(wrapper);
