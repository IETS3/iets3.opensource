...
public final class ArgRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x9464fa065ab9409bL, 0x927464ab29588457L, 0x427ce523084037adL, "org.iets3.core.expr.lambda.structure.ArgRef");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.arg$Nd6m), PROPS.name$MnvL);
  }
  /*package*/ static SNode target_id6rGLT0TevFd(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.arg$Nd6m);
  }
  /*package*/ static SNode getISSVariable_id5GL30CqMVFo(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.arg$Nd6m);
  }

  /*package*/ ArgRef__BehaviorDescriptor() {
  }
