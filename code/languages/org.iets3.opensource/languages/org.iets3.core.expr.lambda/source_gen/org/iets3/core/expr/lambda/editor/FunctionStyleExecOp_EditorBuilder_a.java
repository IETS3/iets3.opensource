...
/*package*/ class FunctionStyleExecOp_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new funSingleRoleHandler_5u53pc_a0a0(myNode, LINKS.fun$JJ25, getEditorContext());
    return provider.createCell();
  }
  private static class funSingleRoleHandler_5u53pc_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public funSingleRoleHandler_5u53pc_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
