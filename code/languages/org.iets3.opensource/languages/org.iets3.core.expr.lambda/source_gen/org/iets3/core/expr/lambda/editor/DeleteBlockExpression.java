...
public class DeleteBlockExpression {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNodeOperations.replaceWithAnother(node, ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.expressions$2$5d)).first());
      }
      @Override
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.expressions$2$5d)).count() == 1;
      }
