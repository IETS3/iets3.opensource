...
/*package*/ class FunctionType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new effectSingleRoleHandler_bqk3nx_a0e0a(myNode, LINKS.effect$V$Pd, getEditorContext());
    return provider.createCell();
  }
  private static class effectSingleRoleHandler_bqk3nx_a0e0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public effectSingleRoleHandler_bqk3nx_a0e0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
