...
/*package*/ class MultiPlus_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MultiPlus_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_jxr8u4_a0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new elementsListHandler_jxr8u4_b0a(myNode, getEditorContext());
  ...
  private static class elementsListHandler_jxr8u4_b0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public elementsListHandler_jxr8u4_b0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(elementsListHandler_jxr8u4_b0a.this.getNode(), LINKS.elements$_r5J));
      try {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_jxr8u4_c0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_jxr8u4_a3a0();
  ...
  private boolean nodeCondition_jxr8u4_a3a0() {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeConstraintSingleRoleHandler_jxr8u4_a0a3a0(myNode, LINKS.typeConstraint$BQ$W, getEditorContext());
    return provider.createCell();
  }
  private static class typeConstraintSingleRoleHandler_jxr8u4_a0a3a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeConstraintSingleRoleHandler_jxr8u4_a0a3a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for MultiPlus.typeConstraint") {
      @Override
    ...
    editorCell.setCellId("SideTransformationSectionCell_jxr8u4_a3a0");
    return editorCell;
  }
          ...
          return new Object() {
            public Iterable<String> query(SNode node) {
              return new StringOrSequenceQuery() {
                public Object queryStringOrSequence() {
                  String description = EditorCustomizationConfigHelper.getConfig().getOptionalCellTransformationText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.MultiPlus$pR, LINKS.typeConstraint$BQ$W), node, editorContext);
      ...
      if (Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(result).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public void execute(@NotNull String pattern) {
            final SNode sourceNode = ctx.getNode();
            EditorContext editorContext = ctx.getEditorContext();
            SNode newNode = SNodeFactoryOperations.setNewChild(SNodeOperations.cast(sourceNode, CONCEPTS.MultiPlus$pR), LINKS.typeConstraint$BQ$W, null);
            new Object() {
              public void postprocess(SNode node) {
                EditorCustomizationConfigHelper.getConfig().postProcessOptionalCell(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.MultiPlus$pR, LINKS.typeConstraint$BQ$W), node, editorContext);
              }
          ...
          public String getShortDescriptionText(@NotNull String pattern) {
            ...
            EditorContext editorContext = ctx.getEditorContext();
            String descriptiontext = EditorCustomizationConfigHelper.getConfig().getOptionalCellDescriptionText(EditorCustomizationConfigHelper.getIdentifier(CONCEPTS.MultiPlus$pR, LINKS.typeConstraint$BQ$W), node, originalText, editorContext);
