...
public class FeatureSelectionUntouch {
  ...
  /*package*/ static AbstractCellAction createAction_BACKSPACE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        AbstractFeatureConfiguration__BehaviorDescriptor.setTargetFeatureSelectionUntouched_idWXOPPXmy3H.invoke(node);
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return !((boolean) AbstractFeatureConfiguration__BehaviorDescriptor.hasAutoDecison_id2nkP8exm3rI.invoke(node));
      }
