...
/*package*/ class FeatureModelConfiguration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createAlternation_2() {
    boolean alternationCondition = true;
    alternationCondition = nodeCondition_as05hg_a7a0a();
    EditorCell editorCell = null;
    if (alternationCondition) {
  ...
  private boolean nodeCondition_as05hg_a7a0a() {
  ...
  private EditorCell createSideTransformationSectionCell_2() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_as05hg_a7a0a");
    return editorCell;
  }
