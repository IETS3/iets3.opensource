...
public class FeatureConfiguration_Constraints extends BaseConstraintsDescriptor {
  /*package*/ FeatureConfiguration_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.FeatureConfiguration$x2, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.targetFeature$16lA, container, false, true);
    }
    @Override
    ...
    public void onReferenceSet(final SNode referenceNode, final SNode oldReferentNode, final SNode newReferentNode) {
      ...
      // Leave Unspecified if is a reference
      {
        ...
        if (SNodeOperations.isInstanceOf(fmi, CONCEPTS.FeatureModelInclude$Iq)) {
          SLinkOperations.setTarget(referenceNode, LINKS.content$Wdfq, createFeatureModelConfigurationBase_x68u8b_a0a0a2a2c());
          return;
        }
      }
      {
    ...
    private static SNode createFeatureModelConfigurationBase_x68u8b_a0a0a2a2c() {
