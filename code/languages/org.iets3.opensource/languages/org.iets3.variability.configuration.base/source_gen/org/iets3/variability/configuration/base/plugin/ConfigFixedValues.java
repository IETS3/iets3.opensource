...
public class ConfigFixedValues {
  ...
  private final AssignmentValueList expressionForAttributeAssignment;
  private List<Pair<FixedValueCategory, SNode>> fixedValueCategoryForSelectionState = Lists.newLinkedList();

  public ConfigFixedValues(AssignmentValueList valuesForAttributes, Collection<Pair<FixedValueCategory, SNode>> valuesForSelectionState) {
    this(null, valuesForAttributes, valuesForSelectionState);
  }

  private ConfigFixedValues(IResult failResult, AssignmentValueList valuesForAttributes, Collection<Pair<FixedValueCategory, SNode>> valuesForSelectionState) {
    this.failResult = failResult;
    this.expressionForAttributeAssignment = valuesForAttributes;
  ...
  public ConfigFixedValues(IResult failResult) {
    this(failResult, new AssignmentValueList(), Collections.<Pair<FixedValueCategory, SNode>>emptyList());
  }

  public AssignmentValueList expressionForAttributeAssignment() {
    return this.expressionForAttributeAssignment;
  }
  ...
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append(failResult).append(this.expressionForAttributeAssignment).append(this.fixedValueCategoryForSelectionState).toString();
  }
}
