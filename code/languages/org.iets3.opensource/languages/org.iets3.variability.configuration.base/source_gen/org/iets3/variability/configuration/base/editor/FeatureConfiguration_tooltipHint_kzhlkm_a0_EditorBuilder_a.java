...
/*package*/ class FeatureConfiguration_tooltipHint_kzhlkm_a0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FeatureConfiguration_tooltipHint_kzhlkm_a0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ie0dtv_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    try {
      getCellFactory().pushCellContext();
      getCellFactory().removeCellContextHints(new String[]{"org.iets3.variability.configuration.base.editor.GeneratedHints.tooltipHint_kzhlkm_a0"});
      if (nodeCondition_ie0dtv_a0a()) {
  ...
  private boolean nodeCondition_ie0dtv_a0a() {
    if ((SLinkOperations.getTarget(myNode, LINKS.doc$OiA0) != null)) {
      return true;
    }
    {
      final SNode feature = SLinkOperations.getTarget(myNode, LINKS.targetFeature$16lA);
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_ie0dtv_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ie0dtv_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createQueryList_0() {

    QueryListHandler handler = new QueryListHandler_ie0dtv_b0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setCellId("QueryList_ie0dtv_b0a");
  ...
  private static class QueryListHandler_ie0dtv_b0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_ie0dtv_b0a(EditorContext context, SNode ownerNode, boolean readOnly) {
    ...
    private Object executeQuery(final SNode node, final EditorContext editorContext) {
      ...
      ListSequence.fromList(doc).addElement(SLinkOperations.getTarget(myNode, LINKS.doc$OiA0));
      return doc;
    }
    @Override
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_ie0dtv_c0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createQueryList_1() {

    QueryListHandler handler = new QueryListHandler_ie0dtv_d0a(getEditorContext(), getNode(), true);
    ...
    editorCell.setOwner(SNodeOperations.getConcept(getNode()));
    editorCell.setCellId("QueryList_ie0dtv_d0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.READ_ONLY, true);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private static class QueryListHandler_ie0dtv_d0a extends QueryListHandler {
    /**
     * allows node access in the query with ConceptFunctionParameter_node
     */
    private SNode myNode;
    public QueryListHandler_ie0dtv_d0a(EditorContext context, SNode ownerNode, boolean readOnly) {
      super(context, ownerNode, readOnly);
      myNode = ownerNode;
    }
    @NotNull
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_ie0dtv_e0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
