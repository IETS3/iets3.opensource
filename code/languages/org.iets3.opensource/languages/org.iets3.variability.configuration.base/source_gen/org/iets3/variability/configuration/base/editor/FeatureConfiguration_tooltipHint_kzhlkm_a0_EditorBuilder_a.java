...
/*package*/ class FeatureConfiguration_tooltipHint_kzhlkm_a0_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    QueryListHandler handler = new QueryListHandler_ie0dtv_b0a(editorContext, node, true);
  ...
  private EditorCell createQueryList_2(final EditorContext editorContext, final SNode node) {
    ...
    QueryListHandler handler = new QueryListHandler_ie0dtv_d0a(editorContext, node, true);
