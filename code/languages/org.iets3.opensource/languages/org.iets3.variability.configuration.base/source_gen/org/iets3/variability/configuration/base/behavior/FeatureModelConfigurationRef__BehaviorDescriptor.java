...
public final class FeatureModelConfigurationRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x71226ee2bbc445d2L, 0xa41d20b97237156cL, 0x5cf5c0d0479eed6aL, "org.iets3.variability.configuration.base.structure.FeatureModelConfigurationRef");
  ...
  /*package*/ static Iterable<SNode> effectiveChildConfigItems_id6jHrUgdscqV(@NotNull SNode __thisNode__) {
    return (Iterable<SNode>) AbstractFeatureConfigurationContent__BehaviorDescriptor.effectiveChildConfigItems_id6jHrUgdscqV.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.config$VWuN), LINKS.content$Wdfq));
  }
  /*package*/ static Iterable<SNode> descendantConfigItems_id7_2J966PQrp(@NotNull SNode __thisNode__) {
    return (List<SNode>) AbstractFeatureConfiguration__BehaviorDescriptor.descendantConfigItems_id24slSGEQ$MS.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.config$VWuN));
  }
  /*package*/ static Iterable<SNode> descendantConfigItemsWithoutUserSelection_id7_2J96757xl(@NotNull SNode __thisNode__) {
    return (List<SNode>) AbstractFeatureConfiguration__BehaviorDescriptor.descendantConfigItemsWithoutUserSelection_id6SMbav4BSVm.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.config$VWuN));
  }
  /*package*/ static Iterable<SNode> attributeAssignments_id30ECcbtQl70(@NotNull SNode __thisNode__) {
    return (Iterable<SNode>) AbstractFeatureConfiguration__BehaviorDescriptor.attributeAssignments_id30ECcbtQkN2.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.config$VWuN));
  }
  /*package*/ static Iterable<SNode> allAttributeAssignments_id7_2J9673LL1(@NotNull SNode __thisNode__) {
    return (List<SNode>) AbstractFeatureConfiguration__BehaviorDescriptor.allAttributeAssignments_id58DfSnqtfhS.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.config$VWuN));
  }

  /*package*/ FeatureModelConfigurationRef__BehaviorDescriptor() {
  }
