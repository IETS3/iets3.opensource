...
/*package*/ class RequirementsDocSection_presentationMode_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RequirementsDocSection_presentationMode_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new contentsListHandler_lki3za_a0(myNode, getEditorContext());
  ...
  private static class contentsListHandler_lki3za_a0 extends RefNodeListHandler {
    ...
    public contentsListHandler_lki3za_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(contentsListHandler_lki3za_a0.this.getNode(), LINKS.contents$e7kB));
      try {
