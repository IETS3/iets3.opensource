...
/*package*/ class DefaultRequirement_tooltipHint_phoryd_a5c0_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DefaultRequirement_tooltipHint_phoryd_a5c0_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_txx9du_a");
  ...
  private EditorCell createQueryList_0(final EditorContext editorContext, final SNode node) {
    ...
    return QueryListContext.computeWithContext(new QueryListContext(node), () -> {
      QueryListHandler handler = new QueryListHandler_txx9du_a0(editorContext, node);
  ...
  private static class QueryListHandler_txx9du_a0 extends QueryListHandler {
    private SNode myNode;
    public QueryListHandler_txx9du_a0(EditorContext context, SNode ownerNode) {
    ...
    private Object executeQuery(final SNode node, final EditorContext editorContext) {
      return SLinkOperations.getChildren(myNode, LINKS.tags$Ba0n);
    }
    @Override
    ...
    protected EditorCell createNodeCellNotNull(final EditorContext context, @NotNull final SNode node) {
      ...
      try {
        ...
        cell = createCellDuplicatesSafe(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateReferencedNodeCell(() -> context.getEditorComponent().getUpdater().getCurrentUpdateSession().updateChildNodeCell(node), node, new DummyReferenceLink("querylist8479184967782329042")));
      } finally {
        getCellFactory().popCellContext();
      }
      return cell;
