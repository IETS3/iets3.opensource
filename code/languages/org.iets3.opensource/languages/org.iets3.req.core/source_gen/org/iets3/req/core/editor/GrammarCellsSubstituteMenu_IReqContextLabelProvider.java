...
public class GrammarCellsSubstituteMenu_IReqContextLabelProvider extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IReqContextLabelProvider() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IReqContextLabelProvider", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_ysinz7_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_ysinz7_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IReqContextLabelProvider$x$;
    }
  }
