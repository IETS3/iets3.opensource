...
/*package*/ class ReqRelWord_presentationMode_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class kindSingleRoleHandler_7oxd9m_a0a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public kindSingleRoleHandler_7oxd9m_a0a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
