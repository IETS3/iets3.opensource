...
public class DefaultRequirement_presentationMode_Editor extends DefaultNodeEditor {
  ...
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return new DefaultRequirement_presentationMode_EditorBuilder_a(editorContext, node).createCell();
  }
  public EditorCell createInspectedCell(EditorContext editorContext, SNode node) {
    return new DefaultRequirement_presentationMode_InspectorBuilder_a(editorContext, node).createCell();
  }
}
