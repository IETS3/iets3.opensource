...
/*package*/ class RequirementsChunk_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RequirementsChunk_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_3kaxiv_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_3kaxiv_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_3kaxiv_a0a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_SIZE, _StyleParameter_QueryFunction_3kaxiv_a0a0a());
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private int _StyleParameter_QueryFunction_3kaxiv_a0a0a() {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      Style style = new StyleImpl();
      style.set(StyleAttributes.FONT_SIZE, _StyleParameter_QueryFunction_3kaxiv_a0b0a());
      editorCell.getStyle().putAll(style);
  ...
  private int _StyleParameter_QueryFunction_3kaxiv_a0b0a() {
    return ((int) (EditorSettings.getInstance().getFontSize() * 1.4));
  }
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_3kaxiv_b0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_3kaxiv_a1a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
    editorCell.setCellId("Constant_3kaxiv_b1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createHorizontalLineCell_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("HorizontalLineCell_3kaxiv_c0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
    editorCell.setCellId("Constant_3kaxiv_d0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new requirementsListHandler_3kaxiv_e0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_requirements");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class requirementsListHandler_3kaxiv_e0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public requirementsListHandler_3kaxiv_e0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(requirementsListHandler_3kaxiv_e0.this.getNode(), LINKS.requirements$OjTk));
      try {
