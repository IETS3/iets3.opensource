...
/*package*/ class RequirementsChunk_table_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RequirementsChunk_table_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createConstant_0() {
    ...
    style.set(StyleAttributes.FONT_SIZE, _StyleParameter_QueryFunction_dhemgw_a0a0a());
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  }
  private int _StyleParameter_QueryFunction_dhemgw_a0a0a() {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      ...
      Style style = new StyleImpl();
      style.set(StyleAttributes.FONT_SIZE, _StyleParameter_QueryFunction_dhemgw_a0b0a());
      editorCell.getStyle().putAll(style);
  ...
  private int _StyleParameter_QueryFunction_dhemgw_a0b0a() {
    return ((int) (EditorSettings.getInstance().getFontSize() * 1.4));
  }
  ...
  private EditorCell createHorizontalLineCell_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("HorizontalLineCell_dhemgw_c0");
    Style style = new StyleImpl();
