...
/*package*/ class DefaultRequirement_table_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public DefaultRequirement_table_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new kindSingleRoleHandler_jcypnx_a2a0a(myNode, LINKS.kind$$FaM, getEditorContext());
    return provider.createCell();
  }
  private static class kindSingleRoleHandler_jcypnx_a2a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new stateSingleRoleHandler_jcypnx_a3a0a(myNode, LINKS.state$MusY, getEditorContext());
    return provider.createCell();
  }
  private static class stateSingleRoleHandler_jcypnx_a3a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new tagsListHandler_jcypnx_a4a0a(myNode, getEditorContext());
  ...
  private static class tagsListHandler_jcypnx_a4a0a extends RefNodeListHandler {
    ...
    public tagsListHandler_jcypnx_a4a0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(tagsListHandler_jcypnx_a4a0a.this.getNode(), LINKS.tags$Ba0n));
      try {
