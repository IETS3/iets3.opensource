...
public class GrammarCellsSubstituteMenu_IReqDocContent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IReqDocContent() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IReqDocContent", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_jhmcax_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_jhmcax_a extends GrammarCellsSubstituteMenuPart {
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IReqDocContent$iB;
    }
  }
