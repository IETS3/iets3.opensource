...
public class SkeletonNode implements IInstantiationContext {
  ...
  private boolean originalDeletable = true;
  /**
  ...
  public SkeletonNode(SNode original, SNode varPoint, SkeletonNode parent, ArtifactPath path, boolean isInstance, boolean deleteOriginal) {
    this.original = original;
    this.genId = createIntegerConstant_dahqtj_a0b0y(nextId++);
    this.parent = parent;
    this.path = path;
    this.variationPoint = Optional.ofNullable(varPoint);
    this.isInstance = isInstance;
    this.originalDeletable = deleteOriginal;
  ...
  public SkeletonNode(SNode original, SNode varPoint, SkeletonNode parent, ArtifactPath path, boolean isInstance) {
    this(original, varPoint, parent, path, isInstance, true);
  }
  ...
  public boolean deleteOriginal() {
    return this.originalDeletable;
  }

  @Nullable
  public SNode targetIVAA() {
    return check_dahqtj_a0a511(ListSequence.fromList(this.path.segmentsAsList()).findLast((it) -> (it.getTargetIVAA() != null)), this);
  }

  @Nullable
  public SNode target() {
    return check_dahqtj_a0a711(ListSequence.fromList(this.path.segmentsAsList()).findLast((it) -> (it.getTarget() != null)), this);
  }

  @Override
  public String toString() {
    return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("original", this.original).append("target", this.target()).toString();
  }
  ...
  private static SNode createIntegerConstant_dahqtj_a0b0y(int p0) {
  ...
  private static SNode check_dahqtj_a0a711(Segment checkedDotOperand, SkeletonNode checkedDotThisExpression) {
    if (null != checkedDotOperand) {
