...
public abstract class AbstractSkeletonTreeBuilder implements ISkeletonTreeBuilder {
  ...
  protected SkeletonNode createSkeletonNodeVP(SNode n, SNode target, SNode varPoint, SkeletonNode parent, ArtifactPath path, boolean isInstance, boolean deletePivotNode) {
    return finish(target, path, parent, new SkeletonNode(n, varPoint, parent, path, isInstance, deletePivotNode));
  }
  ...
  protected SkeletonNode createSkeletonNodeVP(SNode n, SNode target, SNode varPoint, SkeletonNode parent, ArtifactPath path, boolean isInstance) {
    return this.createSkeletonNodeVP(n, target, varPoint, parent, path, isInstance, true);
  }

  protected SkeletonNode createSkeletonNodeVP(SNode n, SNode target, SNode varPoint, SkeletonNode parent, ArtifactPath path) {
    return this.createSkeletonNodeVP(n, target, varPoint, parent, path, false);
  }
