...
/*package*/ class FeatureModelGlobalVariable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_ie6yp9_a0a0a(myNode, LINKS.type$Owkt, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_ie6yp9_a0a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_ie6yp9_a0a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
