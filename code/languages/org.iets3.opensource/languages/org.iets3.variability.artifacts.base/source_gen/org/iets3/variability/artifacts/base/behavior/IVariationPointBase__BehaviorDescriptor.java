...
public final class IVariationPointBase__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> nameForSolver_id3q2wVeozeaM = new SMethodBuilder<>(String.class).name("nameForSolver").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3927846632402248370L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<String> shortId_idqnZSGXva9v = new SMethodBuilder<>(String.class).name("shortId").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(475129259207991903L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2(SMethodBuilder.createJavaParameter(SNode.class, "n"));
  public static final SMethod<SNode> artifactNode_id3q2wVepCV0v = new SMethodBuilder<>(SNode.class).name("artifactNode").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3927846632420519967L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  ...
  public static final SMethod<String> getConditionAsString_id7Ca9tj9CeW1 = new SMethodBuilder<>(String.class).name("getConditionAsString").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8793882818240376577L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<Integer> computeHash_id6s5puhjUPSP = new SMethodBuilder<>(Integer.TYPE).name("computeHash").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7423451592125013557L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<Boolean> isImplementedByArtifact_id2CjcCemM5G6 = new SMethodBuilder<>(Boolean.TYPE).name("isImplementedByArtifact").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3031822514902293254L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<SNode> getPreviewConfig_id3nzq23wxllr = new SMethodBuilder<>(SNode.class).name("getPreviewConfig").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3883061794138576219L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<Void> resetPreviewConfig_id2eukZZwNvpm = new SMethodBuilder<>(Void.TYPE).name("resetPreviewConfig").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2566581196101121622L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<SNode> getCurrentPreviewConfig_id2eukZZwN269 = new SMethodBuilder<>(SNode.class).name("getCurrentPreviewConfig").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2566581196101001609L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<SNode> getContextIVAA_id2eukZZwMmyR = new SMethodBuilder<>(SNode.class).name("getContextIVAA").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2566581196100823223L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<Void> setState_id7pGmjNvKNSS = new SMethodBuilder<>(Void.TYPE).name("setState").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8533293511947271736L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2(SMethodBuilder.createJavaParameter(ArtifactPath.class, "ap"), SMethodBuilder.createJavaParameter(Boolean.class, "ternaryState"));
  public static final SMethod<Void> resetState_id7pGmjNvL6KZ = new SMethodBuilder<>(Void.TYPE).name("resetState").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8533293511947349055L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<PresenceConditionValue> getState_id4I8sp9GPxJX = new SMethodBuilder<>(PresenceConditionValue.class).name("getState").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5442725023382379517L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2(SMethodBuilder.createJavaParameter(ArtifactPath.class, "ap"));
  public static final SMethod<Boolean> hasState_id4I8sp9GPztQ = new SMethodBuilder<>(Boolean.TYPE).name("hasState").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5442725023382386550L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2(SMethodBuilder.createJavaParameter(ArtifactPath.class, "ap"));
  public static final SMethod<Boolean> isStateFiltered_id6s5puhkagqN = new SMethodBuilder<>(Boolean.TYPE).name("isStateFiltered").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7423451592129054387L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2(SMethodBuilder.createJavaParameter(ArtifactPath.class, "ap"));
  public static final SMethod<PresenceConditionValue> getState_id7pGmjNvL72C = new SMethodBuilder<>(PresenceConditionValue.class).name("getState").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8533293511947350184L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<String> getStateTag_id1R5hpWYiZjW = new SMethodBuilder<>(String.class).name("getStateTag").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2145197347759191292L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<Boolean> hasState_id1R5hpWYiTOZ = new SMethodBuilder<>(Boolean.TYPE).name("hasState").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2145197347759168831L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();
  public static final SMethod<ArtifactPath> getArtifactPathFromCurrentContext_id4I8sp9GPu1J = new SMethodBuilder<>(ArtifactPath.class).name("getArtifactPathFromCurrentContext").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5442725023382364271L).languageId(0x8846eb63220ab1ddL, 0xf08835038eaa4bc8L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(nameForSolver_id3q2wVeozeaM, shortId_idqnZSGXva9v, artifactNode_id3q2wVepCV0v, artifactNodeData_id3PRltoWVL10, getConditionAsString_id7Ca9tj9CeW1, computeHash_id6s5puhjUPSP, isImplementedByArtifact_id2CjcCemM5G6, getPreviewConfig_id3nzq23wxllr, resetPreviewConfig_id2eukZZwNvpm, getCurrentPreviewConfig_id2eukZZwN269, getContextIVAA_id2eukZZwMmyR, setState_id7pGmjNvKNSS, resetState_id7pGmjNvL6KZ, getState_id4I8sp9GPxJX, hasState_id4I8sp9GPztQ, isStateFiltered_id6s5puhkagqN, getState_id7pGmjNvL72C, getStateTag_id1R5hpWYiZjW, hasState_id1R5hpWYiTOZ, getArtifactPathFromCurrentContext_id4I8sp9GPu1J);
