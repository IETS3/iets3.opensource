...
public class Pivot {
  ...
  private boolean deletePivot = true;

  public Pivot(SNode pivotNode, SNode targetNode, SNode fmInclude, SNode targetIVAA) {
    this(pivotNode, targetNode, fmInclude, targetIVAA, true);
  }

  public Pivot(SNode pivotNode, SNode targetNode, SNode fmInclude, SNode targetIVAA, boolean deletePivot) {
  ...
  public boolean deletePivotNode() {
    return this.deletePivot;
  }

  @Deprecated(since = "11.2.2026")
