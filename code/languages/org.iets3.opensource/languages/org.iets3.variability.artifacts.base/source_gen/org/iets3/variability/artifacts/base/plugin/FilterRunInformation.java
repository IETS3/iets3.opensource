...
public class FilterRunInformation {
   ...
   */
  private final Set<SNode> detachments = Sets.newHashSet();
  ...
  public void addDetachments(Iterable<SNode> nodes) {
    SetSequence.fromSet(this.detachments).addSequence(Sequence.fromIterable(nodes));
  }

  public void clearDetachments() {
    SetSequence.fromSet(this.detachments).clear();
  }
