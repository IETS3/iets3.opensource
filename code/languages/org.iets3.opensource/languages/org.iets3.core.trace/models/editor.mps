...
<model ref="r:b4f2bd5b-f54a-40d8-9b3f-ab38cd7bcf97(org.iets3.core.trace.editor)">
  ...
  <node concept="24kQdi" id="1PzuxQOTQDq">
    ...
    <node concept="3EZMnI" id="1PzuxQOVQNI" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="1PzuxQOVQOq" role="3EZMnx">
        <property role="3F0ifm" value="traces" />
      </node>
      <node concept="3F0ifn" id="1PzuxQOVQOM" role="3EZMnx">
        <property role="3F0ifm" value="{" />
        <node concept="11LMrY" id="1PzuxQOVTuW" role="3F10Kt">
      ...
      <node concept="3F0ifn" id="1PzuxQOVQPV" role="3EZMnx">
        <property role="3F0ifm" value="}" />
        <node concept="11L4FC" id="1PzuxQOVTzd" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
      </node>
    </node>
