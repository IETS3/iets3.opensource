...
public class DataTableType_Constraints extends BaseConstraintsDescriptor {
  /*package*/ DataTableType_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.DataTableType$eA, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.table$tErP, container, true, false);
    }
    @Nullable
    @Override
