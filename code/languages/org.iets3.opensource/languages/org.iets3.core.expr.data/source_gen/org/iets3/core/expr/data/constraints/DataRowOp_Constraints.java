...
public class DataRowOp_Constraints extends BaseConstraintsDescriptor {
  public DataRowOp_Constraints() {
    super(CONCEPTS.DataRowOp$U1);
  }
  ...
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.row$H2K_, this, true, false) {
      @Nullable
      @Override
