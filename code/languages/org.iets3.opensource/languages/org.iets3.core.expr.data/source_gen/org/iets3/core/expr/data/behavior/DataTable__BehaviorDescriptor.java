...
public final class DataTable__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getValue_id5LghDpmkwQU = new SMethodBuilder<>(SNode.class).name("getValue").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6651894261133479354L).languageId(0x8c7872091b39fddaL, 0xb25b8ad14d3d4e45L).build2(SMethodBuilder.createJavaParameter(SNode.class, "row"), SMethodBuilder.createJavaParameter(SNode.class, "column"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getUniquelyNamedElements_id4qSf1u1TRfj, getScope_id52_Geb4QDV$, getValue_id5LghDpmkwQU);
