...
public class DataSelector_Constraints extends BaseConstraintsDescriptor {
  public DataSelector_Constraints() {
    super(CONCEPTS.DataSelector$93);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.table$WyyI, this, true, false) {
      @Nullable
      @Override
