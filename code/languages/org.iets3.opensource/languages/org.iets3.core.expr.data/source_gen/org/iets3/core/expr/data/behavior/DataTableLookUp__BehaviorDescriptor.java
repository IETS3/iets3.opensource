...
public final class DataTableLookUp__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getColumnDefinition_id7F9023_N_3E = new SMethodBuilder<>(SNode.class).name("getColumnDefinition").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8847603084240507114L).languageId(0x8c7872091b39fddaL, 0xb25b8ad14d3d4e45L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id6kR0qIbI2yi, getColumnDefinition_id7F9023_N_3E, getScope_id52_Geb4QDV$);
