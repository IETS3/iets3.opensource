...
public final class RecordMemberRefInConstraint__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x71934284d7d145eeL, 0xa0548c072591085fL, 0xe377da7335bc308L, "org.iets3.core.expr.toplevel.structure.RecordMemberRefInConstraint");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.member$C$x_), PROPS.name$MnvL);
  }

  /*package*/ RecordMemberRefInConstraint__BehaviorDescriptor() {
  }
