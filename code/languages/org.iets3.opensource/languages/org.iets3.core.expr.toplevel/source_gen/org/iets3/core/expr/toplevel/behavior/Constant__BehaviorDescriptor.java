...
public final class Constant__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> transformToFunction_id2KGel$SrnY1 = new SMethodBuilder<>(SNode.class).name("transformToFunction").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3182982092005670785L).languageId(0xa0548c072591085fL, 0x71934284d7d145eeL).build2();
  ...
  public static final SMethod<String> getErrorMessageForElementInCycle_id2G8yZXxNStd = new SMethodBuilder<>(String.class).name("getErrorMessageForElementInCycle").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3100882272418498381L).languageId(0xa0548c072591085fL, 0x71934284d7d145eeL).build2();
