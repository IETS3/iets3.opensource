...
public class QualifierRef_Constraints extends BaseConstraintsDescriptor {
  /*package*/ QualifierRef_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.QualifierRef$2Q, initContext);
    record(new RD1(this));
    record(new RD2(this));
  }
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.enum$$Z9W, container, true, false);
    }
    @Nullable
    @Override
  ...
  /*package*/ static final class RD2 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD2(ConstraintsDescriptor container) {
      super(LINKS.lit$cjiB, container, true, true);
    }
    @Override
    ...
    public void onReferenceSet(final SNode referenceNode, final SNode oldReferentNode, final SNode newReferentNode) {
      SNodeOperations.replaceWithAnother(referenceNode, createEnumLiteralRef_ke50sg_a0a0a2d(newReferentNode));
    }
    @Nullable
    @Override
    public ReferenceScopeProvider getScopeProvider() {
    ...
    private static SNode createEnumLiteralRef_ke50sg_a0a0a2d(SNode p0) {
