...
public class AbstractEnumSingleInTarget_Constraints extends BaseConstraintsDescriptor {
  /*package*/ AbstractEnumSingleInTarget_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.AbstractEnumSingleInTarget$JO, initContext);
    record(new RD1(this));
  ...
  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.literal$7Jlb, container, true, false);
    }
    @Nullable
    @Override
