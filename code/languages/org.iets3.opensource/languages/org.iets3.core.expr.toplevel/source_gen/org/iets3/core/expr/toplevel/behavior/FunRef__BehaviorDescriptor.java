...
public final class FunRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x71934284d7d145eeL, 0xa0548c072591085fL, 0x427ce52308460f7cL, "org.iets3.core.expr.toplevel.structure.FunRef");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return ":" + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.fun$DJ6H), PROPS.name$MnvL);
  }

  /*package*/ FunRef__BehaviorDescriptor() {
  }
