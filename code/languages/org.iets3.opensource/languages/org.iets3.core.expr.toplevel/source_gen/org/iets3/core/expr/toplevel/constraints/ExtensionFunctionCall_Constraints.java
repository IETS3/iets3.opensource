...
public class ExtensionFunctionCall_Constraints extends BaseConstraintsDescriptor {
  public ExtensionFunctionCall_Constraints() {
    super(CONCEPTS.ExtensionFunctionCall$AX);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.extFun$udGR, this, true, false) {
      @Nullable
      @Override
