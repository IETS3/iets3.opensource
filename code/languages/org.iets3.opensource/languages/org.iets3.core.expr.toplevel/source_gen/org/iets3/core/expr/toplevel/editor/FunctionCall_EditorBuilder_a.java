...
/*package*/ class FunctionCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.function$xJRS;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.function$xJRS);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.function$xJRS);
    }
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    ...
    editorCell.setCellId("ReadOnlyModelAccessor_2b0q7v_b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_2b0q7v_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
    style.set(StyleAttributes.SELECTABLE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new argsListHandler_2b0q7v_d0(myNode, getEditorContext());
    ...
    editorCell.getStyle().putAll(style);
    if (nodeCondition_2b0q7v_a3a()) {
      editorCell.getStyle().set(StyleAttributes.FOCUS_POLICY, FocusPolicy.ATTRACTS_RECURSIVELY);
    }
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class argsListHandler_2b0q7v_d0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public argsListHandler_2b0q7v_d0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argsListHandler_2b0q7v_d0.this.getNode(), LINKS.args$xJpQ));
      try {
  ...
  private boolean nodeCondition_2b0q7v_a3a() {
    return ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(myNode, LINKS.function$xJRS), LINKS.args$XOIh)).isNotEmpty();
  }
  private EditorCell createConstant_2() {
    ...
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    if (nodeCondition_2b0q7v_a4a()) {
      editorCell.getStyle().set(StyleAttributes.FOCUS_POLICY, FocusPolicy.ATTRACTS_RECURSIVELY);
    }
    editorCell.setDefaultText("");
    return editorCell;
  }
  private boolean nodeCondition_2b0q7v_a4a() {
    return ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(myNode, LINKS.function$xJRS), LINKS.args$XOIh)).isEmpty();
  }
