...
public final class NewValueSetter__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String renderReadable_id7S4tmubDuM6(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.member$6757), PROPS.name$MnvL) + "=" + Expression__BehaviorDescriptor.renderReadable_id4Y0vh0cfqjE.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.newValue$67z9));
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 1:
        return (T) ((String) renderReadable_id7S4tmubDuM6(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
