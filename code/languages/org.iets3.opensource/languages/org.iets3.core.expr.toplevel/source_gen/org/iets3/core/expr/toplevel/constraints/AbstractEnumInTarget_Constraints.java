...
public class AbstractEnumInTarget_Constraints extends BaseConstraintsDescriptor {
  /*package*/ AbstractEnumInTarget_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.AbstractEnumInTarget$Vo, initContext);
  ...
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:dfbbc430-47fe-4054-9d32-72c481150c72(org.iets3.core.expr.toplevel.constraints)", "5496041072006680188");
