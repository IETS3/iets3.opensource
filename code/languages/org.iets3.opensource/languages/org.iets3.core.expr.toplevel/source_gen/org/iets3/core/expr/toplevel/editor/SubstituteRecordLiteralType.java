...
public class SubstituteRecordLiteralType extends TransformationMenuBase {
  public SubstituteRecordLiteralType() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "SubstituteRecordLiteralType", new SNodePointer("r:1d6bd88a-7393-4b32-b0e6-2d8b3094776e(org.iets3.core.expr.toplevel.editor)", "3849175852715818516")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
