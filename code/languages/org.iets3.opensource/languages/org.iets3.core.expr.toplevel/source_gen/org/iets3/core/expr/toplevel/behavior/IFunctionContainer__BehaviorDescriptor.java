...
public final class IFunctionContainer__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> visibleFunctions_idmQGcCvDdEN = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("visibleFunctions").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(411710798111759027L).languageId(0xa0548c072591085fL, 0x71934284d7d145eeL).build2();
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(visibleFunctions_idmQGcCvDdEN, visibleContentsOfType_id6clJcrJXo2_, visibleContentsOfType_id79$zShlSHxZ);
