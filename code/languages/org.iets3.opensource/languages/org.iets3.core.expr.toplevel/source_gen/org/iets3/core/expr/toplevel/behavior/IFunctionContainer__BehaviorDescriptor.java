...
public final class IFunctionContainer__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0x71934284d7d145eeL, 0xa0548c072591085fL, 0x5b6b0ca1fa4d6ffL, "org.iets3.core.expr.toplevel.structure.IFunctionContainer");

  public static final SMethod<Iterable<SNode>> visibleFunctions_idmQGcCvDdEN = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("visibleFunctions").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(411710798111759027L).languageId(0xa0548c072591085fL, 0x71934284d7d145eeL).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(visibleFunctions_idmQGcCvDdEN, visibleContentsOfType_id6clJcrJXo2_, visibleContentsOfType_id79$zShlSHxZ);
  ...
  /*package*/ static Scope visibleContentsOfType_id79$zShlSHxZ(@NotNull SNode __thisNode__, SAbstractConcept targetConcept) {
    ...
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(targetConcept), CONCEPTS.IFunctionLike$t6)) {
      CompositeScope compositeScope = new CompositeScope(ListScope.forResolvableElements(IFunctionContainer__BehaviorDescriptor.visibleFunctions_idmQGcCvDdEN.invoke(__thisNode__)), parentScope);
      return compositeScope;
    }
    return parentScope;
  }

  /*package*/ IFunctionContainer__BehaviorDescriptor() {
  }
