...
public final class EnumIsNotInTarget__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String renderReadable_id6kR0qIbI2yi(@NotNull SNode __thisNode__) {
    return SConceptOperations.conceptAlias(SNodeOperations.getConcept(__thisNode__)) + "(" + ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.selectors$qdJC)).select((it) -> BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(it).join(",")) + ")";
  }
  ...
  /*package*/ static List<SNode> enumSelectors_id4L5R3LmDye0(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, LINKS.selectors$qdJC);
  }
  /*package*/ static SNode singleOp_id3wraVjnnC5i(@NotNull SNode __thisNode__, SNode literal) {
    return createEnumIsNotTarget_zcp21_a0a3(literal);
  }

  /*package*/ EnumIsNotInTarget__BehaviorDescriptor() {
  }
  ...
  private static SNode createLogicalAndExpression_zcp21_a0a1(SNode p0, SNode p1) {
  ...
  private static SNode createEnumIsNotTarget_zcp21_a0a3(SNode p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.EnumIsNotTarget$32);
    n0.setReferenceTarget(LINKS.literal$KvuX, p0);
    return n0.getResult();
  }
