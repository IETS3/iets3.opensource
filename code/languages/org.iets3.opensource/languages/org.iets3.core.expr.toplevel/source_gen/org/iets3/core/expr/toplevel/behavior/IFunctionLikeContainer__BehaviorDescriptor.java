...
public final class IFunctionLikeContainer__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0x71934284d7d145eeL, 0xa0548c072591085fL, 0x4aa68aac0c23aa0L, "org.iets3.core.expr.toplevel.structure.IFunctionLikeContainer");

  public static final SMethod<Iterable<SNode>> visibleFunctionLikes_idiEqaF0K$jQ = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("visibleFunctionLikes").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(336196204780209398L).languageId(0xa0548c072591085fL, 0x71934284d7d145eeL).build2();
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(visibleFunctionLikes_idiEqaF0K$jQ, visibleContentsOfType_id6clJcrJXo2_, visibleContentsOfType_id79$zShlSHxZ);
  ...
  /*package*/ static Scope visibleContentsOfType_id79$zShlSHxZ(@NotNull SNode __thisNode__, SAbstractConcept targetConcept) {
    ...
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(targetConcept), CONCEPTS.IFunctionLike$t6)) {
      CompositeScope compositeScope = new CompositeScope(ListScope.forResolvableElements(IFunctionLikeContainer__BehaviorDescriptor.visibleFunctionLikes_idiEqaF0K$jQ.invoke(__thisNode__)), parentScope);
  ...
  /*package*/ IFunctionLikeContainer__BehaviorDescriptor() {
  }
