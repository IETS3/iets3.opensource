...
/*package*/ class SectionMarker_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SectionMarker_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9odmwm_a");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.label$Htqj;
  ...
  private EditorCell createHorizontalLineCell_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("HorizontalLineCell_9odmwm_b0");
    Style style = new StyleImpl();
