package org.iets3.core.expr.toplevel;
...
import org.iets3.core.expr.toplevel.actions.ActionAspectDescriptorImpl;
import jetbrains.mps.smodel.runtime.BehaviorAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConstraintsAspectDescriptor;
import jetbrains.mps.openapi.editor.descriptor.EditorAspectDescriptor;
import org.iets3.core.expr.toplevel.editor.EditorAspectDescriptorImpl;
import jetbrains.mps.openapi.intentions.IntentionAspectDescriptor;
import org.iets3.core.expr.toplevel.intentions.IntentionsDescriptor;
import jetbrains.mps.lang.migration.runtime.base.MigrationAspectDescriptor;
import org.iets3.core.expr.toplevel.migration.MigrationDescriptor;
import jetbrains.mps.lang.typesystem.runtime.IHelginsDescriptor;
import org.iets3.core.expr.toplevel.typesystem.TypesystemDescriptor;
import jetbrains.mps.smodel.runtime.StructureAspectDescriptor;
import jetbrains.mps.smodel.runtime.ConceptPresentationAspect;
import org.iets3.core.expr.toplevel.structure.ConceptPresentationAspectImpl;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("71934284-d7d1-45ee-a054-8c072591085f");
  }

  @Override
  public String getNamespace() {
    return "org.iets3.core.expr.toplevel";
  }
  ...
  protected void fillExtendedLanguages(Collection<SLanguage> extendedLanguages) {
    ...
    extendedLanguages.add(MetaAdapterFactory.getLanguage(SLanguageId.deserialize("f3eafff0-30d2-46d6-9150-f0f3b880ce27"), "org.iets3.core.expr.path"));
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == BehaviorAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.core.expr.toplevel.behavior.BehaviorAspectDescriptor());
    }
    if (aspectClass == ConstraintsAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.core.expr.toplevel.constraints.ConstraintsAspectDescriptor());
    }
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new org.iets3.core.expr.toplevel.structure.StructureAspectDescriptor());
    }
