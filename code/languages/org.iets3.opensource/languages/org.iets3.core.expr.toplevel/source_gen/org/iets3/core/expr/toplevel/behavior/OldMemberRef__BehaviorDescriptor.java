...
public final class OldMemberRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x71934284d7d145eeL, 0xa0548c072591085fL, 0xb6282c45313f471L, "org.iets3.core.expr.toplevel.structure.OldMemberRef");
  ...
  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.member$jDO1), PROPS.name$MnvL);
  }

  /*package*/ OldMemberRef__BehaviorDescriptor() {
  }
