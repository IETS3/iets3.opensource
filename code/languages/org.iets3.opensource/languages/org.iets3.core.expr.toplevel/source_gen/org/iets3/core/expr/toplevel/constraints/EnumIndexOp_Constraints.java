...
public class EnumIndexOp_Constraints extends BaseConstraintsDescriptor {
  /*package*/ EnumIndexOp_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.EnumIndexOp$jD, initContext);
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return (boolean) DotExpression__BehaviorDescriptor.expectType_id5WNmJ7DokMG.invoke(SNodeOperations.cast(parentNode, CONCEPTS.DotExpression$jp), CONCEPTS.EnumType$z, ((boolean) false));
  }
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:dfbbc430-47fe-4054-9d32-72c481150c72(org.iets3.core.expr.toplevel.constraints)", "217046401489004425");
