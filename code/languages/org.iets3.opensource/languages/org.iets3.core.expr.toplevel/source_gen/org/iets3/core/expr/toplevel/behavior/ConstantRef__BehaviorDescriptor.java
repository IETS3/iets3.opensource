...
public final class ConstantRef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x71934284d7d145eeL, 0xa0548c072591085fL, 0x78b257522b24f39L, "org.iets3.core.expr.toplevel.structure.ConstantRef");
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(renderReadable_id4Y0vh0cfqjE, getISSVariable_id5GL30CqMVFo, target_id6rGLT0TevFd);

  private static void ___init___(@NotNull SNode __thisNode__) {
  }

  /*package*/ static String renderReadable_id4Y0vh0cfqjE(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.constant$YVF7), PROPS.name$MnvL);
  }
  /*package*/ static SNode getISSVariable_id5GL30CqMVFo(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.constant$YVF7);
  }
  /*package*/ static SNode target_id6rGLT0TevFd(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.constant$YVF7);
  }

  /*package*/ ConstantRef__BehaviorDescriptor() {
  }
