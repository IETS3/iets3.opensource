...
<model ref="r:42a3bc53-29b1-44d6-9767-7c921cef7ba0(org.iets3.core.expr.flavor.typesystem)">
  ...
  <node concept="312cEu" id="4HxogODQfRC">
    ...
    <node concept="2YIFZL" id="6KxoTHgIUJv" role="jymVt">
      ...
      <node concept="3clFbS" id="6KxoTHgIUJw" role="3clF47">
        ...
        <node concept="3cpWs8" id="6KxoTHgIUJO" role="3cqZAp">
          <node concept="3cpWsn" id="6KxoTHgIUJP" role="3cpWs9">
            <property role="TrG5h" value="result" />
            <node concept="3Tqbb2" id="6KxoTHgIUJQ" role="1tU5fm">
              <ref role="ehGHo" to="w1hl:1xEzHAktP2Q" resolve="TaggedType" />
            </node>
            <node concept="10Nm6u" id="6KxoTHgIUJR" role="33vP2m" />
          </node>
          <node concept="15s5l7" id="6KxoTHgIUJS" role="lGtFl" />
        </node>
        <node concept="3clFbJ" id="6KxoTHgIUJT" role="3cqZAp">
          <node concept="3clFbS" id="6KxoTHgIUJU" role="3clFbx">
            <node concept="3clFbF" id="6KxoTHgIUJV" role="3cqZAp">
              <node concept="37vLTI" id="6KxoTHgIUJW" role="3clFbG">
                <node concept="2OqwBi" id="6KxoTHgIUJX" role="37vLTx">
                  <node concept="1PxgMI" id="6KxoTHgIUJY" role="2Oq$k0">
                    <ref role="1PxNhF" to="w1hl:1xEzHAktP2Q" resolve="TaggedType" />
                    <node concept="37vLTw" id="6KxoTHgIVrK" role="1PxMeX">
                      <ref role="3cqZAo" node="6KxoTHgIUKw" resolve="baseType" />
                    </node>
                  </node>
                  <node concept="2qgKlT" id="6KxoTHgIUK0" role="2OqNvi">
                    <ref role="37wK5l" to="qlm2:4HxogODPWH$" resolve="addTag" />
                    <node concept="37vLTw" id="6KxoTHgIUK1" role="37wK5m">
                      <ref role="3cqZAo" node="6KxoTHgIUJy" resolve="_tags" />
                    </node>
                  </node>
                </node>
                <node concept="37vLTw" id="6KxoTHgIUK2" role="37vLTJ">
                  <ref role="3cqZAo" node="6KxoTHgIUJP" resolve="result" />
                </node>
              </node>
            </node>
          </node>
          <node concept="2OqwBi" id="6KxoTHgIUK3" role="3clFbw">
            <node concept="37vLTw" id="6KxoTHgIVpT" role="2Oq$k0">
              <ref role="3cqZAo" node="6KxoTHgIUKw" resolve="baseType" />
            </node>
            <node concept="1mIQ4w" id="6KxoTHgIUK5" role="2OqNvi">
              <node concept="chp4Y" id="6KxoTHgIUK6" role="cj9EA">
                <ref role="cht4Q" to="w1hl:1xEzHAktP2Q" resolve="TaggedType" />
              </node>
            </node>
          </node>
          <node concept="9aQIb" id="6KxoTHgIUK7" role="9aQIa">
            <node concept="3clFbS" id="6KxoTHgIUK8" role="9aQI4">
              <node concept="3clFbF" id="6KxoTHgIUK9" role="3cqZAp">
                <node concept="37vLTI" id="6KxoTHgIUKa" role="3clFbG">
                  <node concept="37vLTw" id="6KxoTHgIUKb" role="37vLTJ">
                    <ref role="3cqZAo" node="6KxoTHgIUJP" resolve="result" />
                  </node>
                  <node concept="2OqwBi" id="6KxoTHgIUKc" role="37vLTx">
                    <node concept="35c_gC" id="6KxoTHgIUKd" role="2Oq$k0">
                      <ref role="35c_gD" to="w1hl:1xEzHAktP2Q" resolve="TaggedType" />
                    </node>
                    <node concept="2qgKlT" id="6KxoTHgIUKe" role="2OqNvi">
                      <ref role="37wK5l" to="qlm2:4HxogODQaID" resolve="create" />
                      <node concept="1PxgMI" id="6KxoTHgIUKf" role="37wK5m">
                        <ref role="1PxNhF" to="hm2y:6sdnDbSlaok" resolve="Type" />
                        <node concept="37vLTw" id="6KxoTHgIVuM" role="1PxMeX">
                          <ref role="3cqZAo" node="6KxoTHgIUKw" resolve="baseType" />
                        </node>
                      </node>
                      <node concept="37vLTw" id="6KxoTHgIUKh" role="37wK5m">
                        <ref role="3cqZAo" node="6KxoTHgIUJy" resolve="_tags" />
                      </node>
                    </node>
                  </node>
        ...
        <node concept="1Z5TYs" id="6KxoTHgIUKi" role="3cqZAp">
          <node concept="mw_s8" id="6KxoTHgIUKj" role="1ZfhKB">
            <node concept="37vLTw" id="6KxoTHgIUKk" role="mwGJk">
              <ref role="3cqZAo" node="6KxoTHgIUJP" resolve="result" />
            </node>
          </node>
          <node concept="mw_s8" id="6KxoTHgIUKl" role="1ZfhK$">
            <node concept="1Z2H0r" id="6KxoTHgIUKm" role="mwGJk">
              <node concept="37vLTw" id="6KxoTHgIUKn" role="1Z2MuG">
  ...
  <node concept="18kY7G" id="6KxoTHgKlzj">
          ...
          <node concept="2OqwBi" id="6KxoTHgKlOS" role="3fr31v">
            <node concept="2OqwBi" id="6KxoTHgKlOT" role="2Oq$k0">
              <node concept="1YBJjd" id="6KxoTHgKlOU" role="2Oq$k0">
                <ref role="1YBMHb" node="6KxoTHgKlzm" resolve="nt" />
              </node>
              <node concept="3TrEf2" id="6KxoTHgKlOV" role="2OqNvi">
                <ref role="3Tt5mk" to="w1hl:1RcasK0U_W5" />
              </node>
            </node>
            <node concept="2qgKlT" id="6KxoTHgKlOW" role="2OqNvi">
    ...
    <node concept="1YaCAy" id="6KxoTHgKlzm" role="1YuTPh">
      ...
      <ref role="1YaFvo" to="w1hl:1RcasK0U_W1" resolve="NegatedTag" />
    </node>
  </node>
</model>
